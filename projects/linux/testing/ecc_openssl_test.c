...
static const char *SUITE = "ecc_openssl";
...
CuSuite* get_ecc_openssl_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, ecc_openssl_test_init);
	SUITE_ADD_TEST (suite, ecc_openssl_test_init_null);
	SUITE_ADD_TEST (suite, ecc_openssl_test_release_null);
	SUITE_ADD_TEST (suite, ecc_openssl_test_public_key_init_key_pair_and_verify);
	SUITE_ADD_TEST (suite, ecc_openssl_test_public_key_init_key_pair_and_verify_bad_sig);
	SUITE_ADD_TEST (suite, ecc_openssl_test_private_key_init_key_pair_and_sign);
	SUITE_ADD_TEST (suite, ecc_openssl_test_public_key_init_key_pair_and_sign);
	SUITE_ADD_TEST (suite, ecc_openssl_test_init_key_pair_and_sign_and_verify);
	SUITE_ADD_TEST (suite, ecc_openssl_test_init_key_pair_and_sign_with_public_key);
	SUITE_ADD_TEST (suite, ecc_openssl_test_init_key_pair_no_keys);
	SUITE_ADD_TEST (suite, ecc_openssl_test_init_key_pair_null);
	SUITE_ADD_TEST (suite, ecc_openssl_test_init_key_pair_with_public_key);
	SUITE_ADD_TEST (suite, ecc_openssl_test_init_key_pair_with_rsa_key);
	SUITE_ADD_TEST (suite, ecc_openssl_test_init_public_key_and_verify);
	SUITE_ADD_TEST (suite, ecc_openssl_test_init_public_key_and_verify_bad_sig);
	SUITE_ADD_TEST (suite, ecc_openssl_test_init_public_key_null);
	SUITE_ADD_TEST (suite, ecc_openssl_test_init_public_key_with_private_key);
	SUITE_ADD_TEST (suite, ecc_openssl_test_init_public_key_with_rsa_key);
	SUITE_ADD_TEST (suite, ecc_openssl_test_public_key_generate_derived_key_pair_and_verify);
	SUITE_ADD_TEST (suite,
		ecc_openssl_test_public_key_generate_derived_key_pair_and_verify_bad_sig);
	SUITE_ADD_TEST (suite, ecc_openssl_test_private_key_generate_derived_key_pair_and_sign);
	SUITE_ADD_TEST (suite, ecc_openssl_test_public_key_generate_derived_key_pair_and_sign);
	SUITE_ADD_TEST (suite, ecc_openssl_test_generate_derived_key_pair_and_sign_and_verify);
	SUITE_ADD_TEST (suite, ecc_openssl_test_generate_derived_key_pair_and_sign_with_public_key);
	SUITE_ADD_TEST (suite, ecc_openssl_test_generate_derived_key_pair_no_keys);
	SUITE_ADD_TEST (suite, ecc_openssl_test_generate_derived_key_pair_null);
	SUITE_ADD_TEST (suite, ecc_openssl_test_public_key_generate_key_pair);
	SUITE_ADD_TEST (suite, ecc_openssl_test_private_key_generate_key_pair_and_sign);
	SUITE_ADD_TEST (suite, ecc_openssl_test_public_key_generate_key_pair_and_sign);
	SUITE_ADD_TEST (suite, ecc_openssl_test_generate_key_pair_and_sign_and_verify);
	SUITE_ADD_TEST (suite, ecc_openssl_test_generate_key_pair_and_sign_with_public_key);
	SUITE_ADD_TEST (suite, ecc_openssl_test_generate_key_pair_no_keys);
	SUITE_ADD_TEST (suite, ecc_openssl_test_generate_key_pair_null);
	SUITE_ADD_TEST (suite, ecc_openssl_test_sign_null);
	SUITE_ADD_TEST (suite, ecc_openssl_test_sign_small_buffer);
	SUITE_ADD_TEST (suite, ecc_openssl_test_verify_null);
	SUITE_ADD_TEST (suite, ecc_openssl_test_verify_corrupt_signature);
	SUITE_ADD_TEST (suite, ecc_openssl_test_get_signature_max_length);
	SUITE_ADD_TEST (suite, ecc_openssl_test_get_signature_max_length_derived_key);
	SUITE_ADD_TEST (suite, ecc_openssl_test_get_signature_max_length_random_key);
	SUITE_ADD_TEST (suite, ecc_openssl_test_get_signature_max_length_null);
	SUITE_ADD_TEST (suite, ecc_openssl_test_get_shared_secret_max_length);
	SUITE_ADD_TEST (suite, ecc_openssl_test_get_shared_secret_max_length_derived_key);
	SUITE_ADD_TEST (suite, ecc_openssl_test_get_shared_secret_max_length_random_key);
	SUITE_ADD_TEST (suite, ecc_openssl_test_get_shared_secret_max_length_null);
	SUITE_ADD_TEST (suite, ecc_openssl_test_compute_shared_secret);
	SUITE_ADD_TEST (suite, ecc_openssl_test_compute_shared_secret_leading_zero);
	SUITE_ADD_TEST (suite, ecc_openssl_test_compute_shared_secret_derived_key);
	SUITE_ADD_TEST (suite, ecc_openssl_test_compute_shared_secret_different_keys);
	SUITE_ADD_TEST (suite, ecc_openssl_test_compute_shared_secret_null);
	SUITE_ADD_TEST (suite, ecc_openssl_test_compute_shared_secret_small_buffer);
	SUITE_ADD_TEST (suite, ecc_openssl_test_get_private_key_der);
	SUITE_ADD_TEST (suite, ecc_openssl_test_get_private_key_der_derived_key_pair);
	SUITE_ADD_TEST (suite, ecc_openssl_test_get_private_key_der_generated_key_pair);
	SUITE_ADD_TEST (suite, ecc_openssl_test_get_private_key_der_null);
	SUITE_ADD_TEST (suite, ecc_openssl_test_get_private_key_der_public_key_from_private);
	SUITE_ADD_TEST (suite, ecc_openssl_test_get_private_key_der_public_key);
	SUITE_ADD_TEST (suite, ecc_openssl_test_get_public_key_der);
	SUITE_ADD_TEST (suite, ecc_openssl_test_get_public_key_der_derived_key_pair);
	SUITE_ADD_TEST (suite, ecc_openssl_test_get_public_key_der_generated_key_pair);
	SUITE_ADD_TEST (suite, ecc_openssl_test_get_public_key_der_null);
	SUITE_ADD_TEST (suite, ecc_openssl_test_get_public_key_der_private_key);
