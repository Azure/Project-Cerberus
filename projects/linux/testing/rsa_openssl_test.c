...
static const char *SUITE = "rsa_openssl";
...
CuSuite* get_rsa_openssl_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, rsa_openssl_test_init);
	SUITE_ADD_TEST (suite, rsa_openssl_test_init_null);
	SUITE_ADD_TEST (suite, rsa_openssl_test_release_null);
	SUITE_ADD_TEST (suite, rsa_openssl_test_release_no_init);
	SUITE_ADD_TEST (suite, rsa_openssl_test_sig_verify);
	SUITE_ADD_TEST (suite, rsa_openssl_test_sig_verify_null);
	SUITE_ADD_TEST (suite, rsa_openssl_test_sig_verify_no_match);
	SUITE_ADD_TEST (suite, rsa_openssl_test_sig_verify_bad_signature);
	SUITE_ADD_TEST (suite, rsa_openssl_test_init_private_key);
	SUITE_ADD_TEST (suite, rsa_openssl_test_init_private_key_null);
	SUITE_ADD_TEST (suite, rsa_openssl_test_init_private_key_with_public_key);
	SUITE_ADD_TEST (suite, rsa_openssl_test_init_private_key_with_ecc_key);
	SUITE_ADD_TEST (suite, rsa_openssl_test_init_public_key);
#if (RSA_MAX_KEY_LENGTH >= RSA_KEY_LENGTH_4K)
	SUITE_ADD_TEST (suite, rsa_openssl_test_init_public_key_4k);
#endif
	SUITE_ADD_TEST (suite, rsa_openssl_test_init_public_key_null);
	SUITE_ADD_TEST (suite, rsa_openssl_test_init_public_key_with_private_key);
	SUITE_ADD_TEST (suite, rsa_openssl_test_init_public_key_with_ecc_key);
	SUITE_ADD_TEST (suite, rsa_openssl_test_init_public_key_too_large);
	SUITE_ADD_TEST (suite, rsa_openssl_test_get_private_key_der_null);
	SUITE_ADD_TEST (suite, rsa_openssl_test_get_public_key_der_null);
	SUITE_ADD_TEST (suite, rsa_openssl_test_release_key_null);
	SUITE_ADD_TEST (suite, rsa_openssl_test_generate_key);
	SUITE_ADD_TEST (suite, rsa_openssl_test_generate_key_null);
	SUITE_ADD_TEST (suite, rsa_openssl_test_decrypt);
	SUITE_ADD_TEST (suite, rsa_openssl_test_decrypt_with_label);
	SUITE_ADD_TEST (suite, rsa_openssl_test_decrypt_sha256);
	SUITE_ADD_TEST (suite, rsa_openssl_test_decrypt_sha256_with_label);
	SUITE_ADD_TEST (suite, rsa_openssl_test_decrypt_random_key);
	SUITE_ADD_TEST (suite, rsa_openssl_test_decrypt_differest_hashes);
	SUITE_ADD_TEST (suite, rsa_openssl_test_decrypt_null);
	SUITE_ADD_TEST (suite, rsa_openssl_test_decrypt_unknown_hash_type);
	SUITE_ADD_TEST (suite, rsa_openssl_test_decrypt_small_buffer);
	SUITE_ADD_TEST (suite, rsa_openssl_test_decrypt_wrong_key);
	SUITE_ADD_TEST (suite, rsa_openssl_test_decrypt_with_wrong_label);
	SUITE_ADD_TEST (suite, rsa_openssl_test_decrypt_wrong_hash);
