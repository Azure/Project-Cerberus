...
#include "crypto/aes_openssl_static.h"
#include "testing/crypto/aes_testing.h"


TEST_SUITE_LABEL ("aes_openssl");


/**
 * Dependencies for testing.
 */
struct aes_engine_openssl_testing {
	struct aes_engine_openssl test;			/**< An mbedTLS context for AES operations. */
	struct aes_engine_openssl_state state;	/**< The state information for the engine. */
};
...
static void aes_openssl_test_init (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;

	TEST_START;

	status = aes_openssl_init (&engine.test, &engine.state);
	...
	aes_openssl_release (&engine.test);
}

static void aes_openssl_test_init_null (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	...
	status = aes_openssl_init (NULL, &engine.state);
	CuAssertIntEquals (test, AES_ENGINE_INVALID_ARGUMENT, status);

	status = aes_openssl_init (&engine.test, NULL);
	CuAssertIntEquals (test, AES_ENGINE_INVALID_ARGUMENT, status);
}

static void aes_openssl_test_static_init (CuTest *test)
{
	struct aes_engine_openssl_testing engine = {
		.test = aes_openssl_static_init (&engine.state)
	};
	int status;

	TEST_START;

	status = aes_openssl_init_state (&engine.test);
	CuAssertIntEquals (test, 0, status);
...
static void aes_openssl_test_static_init_null (CuTest *test)
{
	struct aes_engine_openssl_testing engine = {
		.test = aes_openssl_static_init (NULL)
	};
	int status;

	TEST_START;

	status = aes_openssl_init_state (NULL);
	CuAssertIntEquals (test, AES_ENGINE_INVALID_ARGUMENT, status);
...
static void aes_openssl_test_release_null (CuTest *test)
{
	TEST_START;

	aes_openssl_release (NULL);
}

static void aes_openssl_test_encrypt_data (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
...
static void aes_openssl_test_encrypt_data_no_tag (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t ciphertext[AES_CIPHERTEXT_LEN * 2];
	...
	status = engine.test.base.encrypt_data (&engine.test.base, AES_PLAINTEXT, AES_PLAINTEXT_LEN,
		AES_IV, AES_IV_LEN, ciphertext, sizeof (ciphertext), NULL, 0);
	CuAssertIntEquals (test, 0, status);
...
static void aes_openssl_test_encrypt_data_same_buffer (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t ciphertext[AES_CIPHERTEXT_LEN * 2];
...
static void aes_openssl_test_encrypt_data_static_init (CuTest *test)
{
	struct aes_engine_openssl_testing engine = {
		.test = aes_openssl_static_init (&engine.state)
	};
...
static void aes_openssl_test_encrypt_data_null (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t ciphertext[AES_CIPHERTEXT_LEN * 2];
...
static void aes_openssl_test_encrypt_data_small_buffer (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t ciphertext[AES_CIPHERTEXT_LEN * 2];
...
static void aes_openssl_test_encrypt_data_small_tag_buffer (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t ciphertext[AES_CIPHERTEXT_LEN * 2];
...
static void aes_openssl_test_encrypt_data_no_key (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t ciphertext[AES_CIPHERTEXT_LEN * 2];
...
static void aes_openssl_test_set_key_null (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
...
static void aes_openssl_test_set_key_bad_length (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
...
static void aes_openssl_test_set_key_unsupported_length (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
...
static void aes_openssl_test_encrypt_with_add_data (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t ciphertext[AES_CIPHERTEXT_LEN * 2];
...
static void aes_openssl_test_encrypt_with_add_data_no_additional_data (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t ciphertext[AES_CIPHERTEXT_LEN * 2];
...
static void aes_openssl_test_encrypt_with_add_data_no_tag (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t ciphertext[AES_CIPHERTEXT_LEN * 2];
	...
	status = engine.test.base.encrypt_with_add_data (&engine.test.base, AES_PLAINTEXT,
		AES_PLAINTEXT_LEN, AES_IV, AES_IV_LEN, NULL, 0, ciphertext, sizeof (ciphertext), NULL, 0);
	CuAssertIntEquals (test, 0, status);
...
static void aes_openssl_test_encrypt_with_add_data_same_buffer (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t ciphertext[AES_CIPHERTEXT_LEN * 2];
...
static void aes_openssl_test_encrypt_with_add_data_additional_data_static_init (CuTest *test)
{
	struct aes_engine_openssl_testing engine = {
		.test = aes_openssl_static_init (&engine.state)
	};
...
static void aes_openssl_test_encrypt_with_add_data_null (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t ciphertext[AES_CIPHERTEXT_LEN * 2];
...
static void aes_openssl_test_encrypt_with_add_data_small_buffer (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t ciphertext[AES_CIPHERTEXT_LEN * 2];
...
static void aes_openssl_test_encrypt_with_add_data_small_tag_buffer (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t ciphertext[AES_CIPHERTEXT_LEN * 2];
...
static void aes_openssl_test_encrypt_with_add_data_no_key (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t ciphertext[AES_CIPHERTEXT_LEN * 2];
...
static void aes_openssl_test_decrypt_data (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
...
static void aes_openssl_test_decrypt_data_no_tag (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t plaintext[AES_PLAINTEXT_LEN * 2];
...
static void aes_openssl_test_decrypt_data_same_buffer (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t plaintext[AES_PLAINTEXT_LEN * 2];
...
static void aes_openssl_test_decrypt_data_static_init (CuTest *test)
{
	struct aes_engine_openssl_testing engine = {
		.test = aes_openssl_static_init (&engine.state)
	};
...
static void aes_openssl_test_decrypt_data_null (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t plaintext[AES_PLAINTEXT_LEN * 2];
...
static void aes_openssl_test_decrypt_data_small_buffer (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t plaintext[AES_PLAINTEXT_LEN * 2];
...
static void aes_openssl_test_decrypt_data_no_key (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t plaintext[AES_PLAINTEXT_LEN * 2];
...
static void aes_openssl_test_decrypt_data_bad_tag (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t plaintext[AES_PLAINTEXT_LEN * 2];
...
static void aes_openssl_test_decrypt_data_bad_data (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t plaintext[AES_PLAINTEXT_LEN * 2];
...
static void aes_openssl_test_decrypt_with_add_data (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t plaintext[AES_PLAINTEXT_LEN * 2];
...
static void aes_openssl_test_decrypt_with_add_data_no_additional_data (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t plaintext[AES_CIPHERTEXT_LEN * 2];
	...
	status = engine.test.base.decrypt_with_add_data (&engine.test.base, AES_CIPHERTEXT,
		AES_CIPHERTEXT_LEN,	AES_GCM_TAG, AES_IV, AES_IV_LEN, NULL, 0, plaintext,
		sizeof (plaintext));
	CuAssertIntEquals (test, 0, status);
...
static void aes_openssl_test_decrypt_with_add_data_no_tag (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t plaintext[AES_PLAINTEXT_LEN * 2];
...
static void aes_openssl_test_decrypt_with_add_data_same_buffer (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t plaintext[AES_PLAINTEXT_LEN * 2];
...
static void aes_openssl_test_decrypt_with_add_data_static_init (CuTest *test)
{
	struct aes_engine_openssl_testing engine = {
		.test = aes_openssl_static_init (&engine.state)
	};
...
static void aes_openssl_test_decrypt_with_add_data_null (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t plaintext[AES_PLAINTEXT_LEN * 2];
...
static void aes_openssl_test_decrypt_with_add_data_small_buffer (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t plaintext[AES_PLAINTEXT_LEN * 2];
...
static void aes_openssl_test_decrypt_with_add_data_no_key (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t plaintext[AES_PLAINTEXT_LEN * 2];
...
static void aes_openssl_test_decrypt_with_add_data_bad_tag (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t plaintext[AES_PLAINTEXT_LEN * 2];
...
static void aes_openssl_test_decrypt_with_add_data_bad_data (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	uint8_t plaintext[AES_PLAINTEXT_LEN * 2];
...
static void aes_openssl_test_encrypt_and_decrypt (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
...
static void aes_openssl_test_encrypt_with_longer_iv (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	const char *message = "Test";
...
static void aes_openssl_test_encrypt_with_shorter_iv (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	const char *message = "Test";
...
static void aes_openssl_test_encrypt_with_different_keys (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	const char *message = "Test";
...
static void aes_openssl_test_encrypt_and_decrypt_with_add_data (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	const char *message = "Test";
...
static void aes_openssl_test_encrypt_with_add_data_with_longer_iv (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	const char *message = "Test";
...
static void aes_openssl_test_encrypt_with_add_data_with_shorter_iv (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	const char *message = "Test";
...
static void aes_openssl_test_encrypt_with_add_data_with_different_keys (CuTest *test)
{
	struct aes_engine_openssl_testing engine;
	int status;
	const char *message = "Test";
...
// *INDENT-OFF*
TEST_SUITE_START (aes_openssl);

TEST (aes_openssl_test_init);
TEST (aes_openssl_test_init_null);
TEST (aes_openssl_test_static_init);
TEST (aes_openssl_test_static_init_null);
TEST (aes_openssl_test_release_null);
TEST (aes_openssl_test_encrypt_data);
TEST (aes_openssl_test_encrypt_data_no_tag);
TEST (aes_openssl_test_encrypt_data_same_buffer);
TEST (aes_openssl_test_encrypt_data_static_init);
TEST (aes_openssl_test_encrypt_data_null);
TEST (aes_openssl_test_encrypt_data_small_buffer);
TEST (aes_openssl_test_encrypt_data_small_tag_buffer);
TEST (aes_openssl_test_encrypt_data_no_key);
TEST (aes_openssl_test_set_key_null);
TEST (aes_openssl_test_set_key_bad_length);
TEST (aes_openssl_test_set_key_unsupported_length);
TEST (aes_openssl_test_encrypt_with_add_data);
TEST (aes_openssl_test_encrypt_with_add_data_no_additional_data);
TEST (aes_openssl_test_encrypt_with_add_data_no_tag);
TEST (aes_openssl_test_encrypt_with_add_data_same_buffer);
TEST (aes_openssl_test_encrypt_with_add_data_additional_data_static_init);
TEST (aes_openssl_test_encrypt_with_add_data_null);
TEST (aes_openssl_test_encrypt_with_add_data_small_buffer);
TEST (aes_openssl_test_encrypt_with_add_data_small_tag_buffer);
TEST (aes_openssl_test_encrypt_with_add_data_no_key);
TEST (aes_openssl_test_decrypt_data);
TEST (aes_openssl_test_decrypt_data_no_tag);
TEST (aes_openssl_test_decrypt_data_same_buffer);
TEST (aes_openssl_test_decrypt_data_static_init);
TEST (aes_openssl_test_decrypt_data_null);
TEST (aes_openssl_test_decrypt_data_small_buffer);
TEST (aes_openssl_test_decrypt_data_no_key);
TEST (aes_openssl_test_decrypt_data_bad_tag);
TEST (aes_openssl_test_decrypt_data_bad_data);
TEST (aes_openssl_test_decrypt_with_add_data);
TEST (aes_openssl_test_decrypt_with_add_data_no_additional_data);
TEST (aes_openssl_test_decrypt_with_add_data_no_tag);
TEST (aes_openssl_test_decrypt_with_add_data_same_buffer);
TEST (aes_openssl_test_decrypt_with_add_data_static_init);
TEST (aes_openssl_test_decrypt_with_add_data_null);
TEST (aes_openssl_test_decrypt_with_add_data_small_buffer);
TEST (aes_openssl_test_decrypt_with_add_data_no_key);
TEST (aes_openssl_test_decrypt_with_add_data_bad_tag);
TEST (aes_openssl_test_decrypt_with_add_data_bad_data);
TEST (aes_openssl_test_encrypt_and_decrypt);
TEST (aes_openssl_test_encrypt_with_longer_iv);
TEST (aes_openssl_test_encrypt_with_shorter_iv);
TEST (aes_openssl_test_encrypt_with_different_keys);
TEST (aes_openssl_test_encrypt_and_decrypt_with_add_data);
TEST (aes_openssl_test_encrypt_with_add_data_with_longer_iv);
TEST (aes_openssl_test_encrypt_with_add_data_with_shorter_iv);
TEST (aes_openssl_test_encrypt_with_add_data_with_different_keys);
