...
static void ecc_openssl_test_public_key_init_key_pair_and_verify_no_pubkey (CuTest *test)
{
	struct ecc_engine_openssl engine;
	struct ecc_public_key pub_key;
	int status;
...
static void ecc_openssl_test_public_key_init_key_pair_and_verify_extra_buffer (CuTest *test)
{
	struct ecc_engine_openssl engine;
	struct ecc_public_key pub_key;
	int status;
...
static void ecc_openssl_test_public_key_init_key_pair_and_verify_p384_no_pubkey (CuTest *test)
{
	struct ecc_engine_openssl engine;
	struct ecc_public_key pub_key;
	int status;
...
static void ecc_openssl_test_public_key_init_key_pair_and_verify_p384_extra_buffer (CuTest *test)
{
	struct ecc_engine_openssl engine;
	struct ecc_public_key pub_key;
	int status;
...
static void ecc_openssl_test_public_key_init_key_pair_and_verify_p521_no_pubkey (CuTest *test)
{
	struct ecc_engine_openssl engine;
	struct ecc_public_key pub_key;
	int status;
...
static void ecc_openssl_test_public_key_init_key_pair_and_verify_p521_extra_buffer (CuTest *test)
{
	struct ecc_engine_openssl engine;
	struct ecc_public_key pub_key;
	int status;
...
static void ecc_openssl_test_init_key_pair_and_sign_and_verify_extra_buffer (CuTest *test)
{
	struct ecc_engine_openssl engine;
	struct ecc_private_key priv_key;
	struct ecc_public_key pub_key;
...
static void ecc_openssl_test_init_key_pair_and_sign_and_verify_p384_no_pubkey (CuTest *test)
{
	struct ecc_engine_openssl engine;
	struct ecc_private_key priv_key;
	struct ecc_public_key pub_key;
...
static void ecc_openssl_test_init_key_pair_and_sign_and_verify_p384_extra_buffer (CuTest *test)
{
	struct ecc_engine_openssl engine;
	struct ecc_private_key priv_key;
	struct ecc_public_key pub_key;
...
static void ecc_openssl_test_init_key_pair_and_sign_and_verify_p521_no_pubkey (CuTest *test)
{
	struct ecc_engine_openssl engine;
	struct ecc_private_key priv_key;
	struct ecc_public_key pub_key;
...
static void ecc_openssl_test_init_key_pair_and_sign_and_verify_p521_no_leading_zero (CuTest *test)
{
	struct ecc_engine_openssl engine;
	struct ecc_private_key priv_key;
	struct ecc_public_key pub_key;
...
static void ecc_openssl_test_init_key_pair_and_sign_and_verify_p521_extra_buffer (CuTest *test)
{
	struct ecc_engine_openssl engine;
	struct ecc_private_key priv_key;
	struct ecc_public_key pub_key;
...
static void ecc_openssl_test_init_public_key_and_verify_extra_buffer (CuTest *test)
{
	struct ecc_engine_openssl engine;
	struct ecc_public_key pub_key;
...
static void ecc_openssl_test_init_public_key_and_verify_p384_extra_buffer (CuTest *test)
{
	struct ecc_engine_openssl engine;
	struct ecc_public_key pub_key;
...
static void ecc_openssl_test_init_public_key_and_verify_p521_extra_buffer (CuTest *test)
{
	struct ecc_engine_openssl engine;
	struct ecc_public_key pub_key;
...
static void ecc_openssl_test_sign_unknown_hash (CuTest *test)
{
	struct ecc_engine_openssl engine;
	struct ecc_private_key priv_key;
	struct ecc_public_key pub_key;
...
static void ecc_openssl_test_get_signature_max_verify_length (CuTest *test)
{
	struct ecc_engine_openssl engine;
	struct ecc_public_key pub_key;
	int status;
...
#if ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_384
static void ecc_openssl_test_get_signature_max_verify_length_p384 (CuTest *test)
{
	struct ecc_engine_openssl engine;
	struct ecc_public_key pub_key;
	int status;
...
#if ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_521
static void ecc_openssl_test_get_signature_max_verify_length_p521 (CuTest *test)
{
	struct ecc_engine_openssl engine;
	struct ecc_public_key pub_key;
	int status;
...
static void ecc_openssl_test_get_signature_max_verify_length_derived_key (CuTest *test)
{
	struct ecc_engine_openssl engine;
	struct ecc_public_key pub_key;
	int status;
...
static void ecc_openssl_test_get_signature_max_verify_length_random_key (CuTest *test)
{
	struct ecc_engine_openssl engine;
	struct ecc_public_key pub_key;
	int status;
...
static void ecc_openssl_test_get_signature_max_verify_length_static_init (CuTest *test)
{
	struct ecc_engine_openssl engine = ecc_openssl_static_init ();
	struct ecc_public_key pub_key;
	int status;
...
static void ecc_openssl_test_get_signature_max_verify_length_null (CuTest *test)
{
	struct ecc_engine_openssl engine;
	struct ecc_public_key pub_key;
	int status;
...
TEST (ecc_openssl_test_public_key_init_key_pair_and_verify_extra_buffer);
#if ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_384
TEST (ecc_openssl_test_public_key_init_key_pair_and_verify_p384);
TEST (ecc_openssl_test_public_key_init_key_pair_and_verify_p384_no_pubkey);
TEST (ecc_openssl_test_public_key_init_key_pair_and_verify_p384_extra_buffer);
#endif
#if ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_521
TEST (ecc_openssl_test_public_key_init_key_pair_and_verify_p521);
TEST (ecc_openssl_test_public_key_init_key_pair_and_verify_p521_no_pubkey);
TEST (ecc_openssl_test_public_key_init_key_pair_and_verify_p521_extra_buffer);
#endif
...
TEST (ecc_openssl_test_init_key_pair_and_sign_and_verify_extra_buffer);
#if ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_384
TEST (ecc_openssl_test_init_key_pair_and_sign_and_verify_p384);
TEST (ecc_openssl_test_init_key_pair_and_sign_and_verify_p384_no_pubkey);
TEST (ecc_openssl_test_init_key_pair_and_sign_and_verify_p384_extra_buffer);
#endif
#if ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_521
TEST (ecc_openssl_test_init_key_pair_and_sign_and_verify_p521);
TEST (ecc_openssl_test_init_key_pair_and_sign_and_verify_p521_no_pubkey);
TEST (ecc_openssl_test_init_key_pair_and_sign_and_verify_p521_no_leading_zero);
TEST (ecc_openssl_test_init_key_pair_and_sign_and_verify_p521_extra_buffer);
#endif
...
TEST (ecc_openssl_test_init_public_key_and_verify_extra_buffer);
#if ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_384
TEST (ecc_openssl_test_init_public_key_and_verify_p384);
TEST (ecc_openssl_test_init_public_key_and_verify_p384_extra_buffer);
#endif
#if ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_521
...
TEST (ecc_openssl_test_get_signature_max_verify_length);
#if ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_384
TEST (ecc_openssl_test_get_signature_max_verify_length_p384);
#endif
#if ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_521
TEST (ecc_openssl_test_get_signature_max_verify_length_p521);
#endif
TEST (ecc_openssl_test_get_signature_max_verify_length_derived_key);
TEST (ecc_openssl_test_get_signature_max_verify_length_random_key);
TEST (ecc_openssl_test_get_signature_max_verify_length_static_init);
TEST (ecc_openssl_test_get_signature_max_verify_length_null);
