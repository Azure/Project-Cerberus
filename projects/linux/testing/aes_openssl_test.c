...
static const char *SUITE = "aes_openssl";
...
{
	struct aes_engine_openssl engine;
	int status;

	TEST_START;

	status = aes_openssl_init (&engine);
...
CuSuite* get_aes_openssl_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, aes_openssl_test_init);
	SUITE_ADD_TEST (suite, aes_openssl_test_init_null);
	SUITE_ADD_TEST (suite, aes_openssl_test_release_null);
	SUITE_ADD_TEST (suite, aes_openssl_test_encrypt_data);
	SUITE_ADD_TEST (suite, aes_openssl_test_encrypt_data_no_tag);
	SUITE_ADD_TEST (suite, aes_openssl_test_encrypt_data_same_buffer);
	SUITE_ADD_TEST (suite, aes_openssl_test_encrypt_data_null);
	SUITE_ADD_TEST (suite, aes_openssl_test_encrypt_data_small_buffer);
	SUITE_ADD_TEST (suite, aes_openssl_test_encrypt_data_small_tag_buffer);
	SUITE_ADD_TEST (suite, aes_openssl_test_encrypt_data_no_key);
	SUITE_ADD_TEST (suite, aes_openssl_test_set_key_null);
	SUITE_ADD_TEST (suite, aes_openssl_test_set_key_bad_length);
	SUITE_ADD_TEST (suite, aes_openssl_test_set_key_unsupported_length);
	SUITE_ADD_TEST (suite, aes_openssl_test_decrypt_data);
	SUITE_ADD_TEST (suite, aes_openssl_test_decrypt_data_no_tag);
	SUITE_ADD_TEST (suite, aes_openssl_test_decrypt_data_same_buffer);
	SUITE_ADD_TEST (suite, aes_openssl_test_decrypt_data_null);
	SUITE_ADD_TEST (suite, aes_openssl_test_decrypt_data_small_buffer);
	SUITE_ADD_TEST (suite, aes_openssl_test_decrypt_data_no_key);
	SUITE_ADD_TEST (suite, aes_openssl_test_decrypt_data_bad_tag);
	SUITE_ADD_TEST (suite, aes_openssl_test_decrypt_data_bad_data);
	SUITE_ADD_TEST (suite, aes_openssl_test_encrypt_and_decrypt);
	SUITE_ADD_TEST (suite, aes_openssl_test_encrypt_with_longer_iv);
	SUITE_ADD_TEST (suite, aes_openssl_test_encrypt_with_shorter_iv);
	SUITE_ADD_TEST (suite, aes_openssl_test_encrypt_with_different_keys);
