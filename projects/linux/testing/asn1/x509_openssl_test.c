...
#include "asn1/x509_openssl_static.h"
...
static void x509_openssl_test_static_init (CuTest *test)
{
	struct x509_engine_openssl engine = x509_openssl_static_init;
...
static void x509_openssl_test_create_csr_ecc384_ca (CuTest *test)
{
	struct x509_engine_openssl engine;
	int status;
	uint8_t *csr = NULL;
...
static void x509_openssl_test_create_csr_ecc384_end_entity (CuTest *test)
{
	struct x509_engine_openssl engine;
	int status;
	uint8_t *csr = NULL;
...
static void x509_openssl_test_create_csr_ecc384_ca_sha256_digest (CuTest *test)
{
	struct x509_engine_openssl engine;
	int status;
	uint8_t *csr = NULL;
...
static void x509_openssl_test_create_csr_ecc384_end_entity_sha256_digest (CuTest *test)
{
	struct x509_engine_openssl engine;
	int status;
	uint8_t *csr = NULL;
...
static void x509_openssl_test_create_csr_ecc521_ca (CuTest *test)
{
	struct x509_engine_openssl engine;
	int status;
	uint8_t *csr = NULL;
...
static void x509_openssl_test_create_csr_ecc521_end_entity (CuTest *test)
{
	struct x509_engine_openssl engine;
	int status;
	uint8_t *csr = NULL;
...
static void x509_openssl_test_create_csr_ca_tcbinfo_and_ueid_extension_sha384 (CuTest *test)
{
	struct x509_engine_openssl engine;
	int status;
	struct x509_extension_builder_mock tcb;
...
static void x509_openssl_test_create_csr_ca_tcbinfo_and_ueid_extension_sha512 (CuTest *test)
{
	struct x509_engine_openssl engine;
	int status;
	struct x509_extension_builder_mock tcb;
...
static void x509_openssl_test_create_csr_ca_tcbinfo_extension_no_ueid (CuTest *test)
{
	struct x509_engine_openssl engine;
	int status;
	struct x509_extension_builder_mock tcb;
...
static void x509_openssl_test_create_csr_end_entity_tcbinfo_extension_no_ueid (CuTest *test)
{
	struct x509_engine_openssl engine;
	int status;
	struct x509_extension_builder_mock tcb;
...
static void x509_openssl_test_create_csr_ca_critical_extension (CuTest *test)
{
	struct x509_engine_openssl engine;
	int status;
	struct x509_extension_builder_mock tcb;
...
static void x509_openssl_test_create_csr_ca_null_extension (CuTest *test)
{
	struct x509_engine_openssl engine;
	int status;
	struct x509_extension_builder_mock tcb;
...
static void x509_openssl_test_create_csr_static_init (CuTest *test)
{
	struct x509_engine_openssl engine = x509_openssl_static_init;
	int status;
	uint8_t *csr = NULL;
...
static void x509_openssl_test_create_csr_eku_null (CuTest *test)
{
	struct x509_engine_openssl engine;
	int status;
	uint8_t *csr = (uint8_t*) &status;
...
static void x509_openssl_test_create_csr_extensions_null (CuTest *test)
{
	struct x509_engine_openssl engine;
	int status;
	uint8_t *csr = (uint8_t*) &status;
...
static void x509_openssl_test_create_csr_sig_unsupported_hash (CuTest *test)
{
	struct x509_engine_openssl engine;
	int status;
	uint8_t *csr = NULL;
...
static void x509_openssl_test_create_csr_tcbinfo_error (CuTest *test)
{
	struct x509_engine_openssl engine;
	int status;
	struct x509_extension_builder_mock tcb;
...
static void x509_openssl_test_create_csr_ueid_error (CuTest *test)
{
	struct x509_engine_openssl engine;
	int status;
	struct x509_extension_builder_mock tcb;
...
#if (ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_384)
#ifdef HASH_ENABLE_SHA384
static void x509_openssl_test_create_self_signed_certificate_ecc384_ca (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate cert;
	int status;
...
static void x509_openssl_test_create_self_signed_certificate_ecc384_end_entity (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate cert;
	int status;
...
static void x509_openssl_test_create_self_signed_certificate_ecc384_ca_sha256_digest (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate cert;
	int status;
...
static void x509_openssl_test_create_self_signed_certificate_ecc384_end_entity_sha256_digest (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate cert;
...
#if (ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_521) && defined HASH_ENABLE_SHA512
static void x509_openssl_test_create_self_signed_certificate_ecc521_ca (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate cert;
	int status;
...
static void x509_openssl_test_create_self_signed_certificate_ecc521_end_entity (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate cert;
	int status;
...
static void x509_openssl_test_create_self_signed_certificate_ecc_ca_tcbinfo_and_ueid_extension_sha384 (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate cert;
...
static void x509_openssl_test_create_self_signed_certificate_ecc_ca_tcbinfo_and_ueid_extension_sha512 (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate cert;
...
static void x509_openssl_test_create_self_signed_certificate_ecc_ca_tcbinfo_extension_no_ueid (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate cert;
...
static void x509_openssl_test_create_self_signed_certificate_ecc_end_entity_tcbinfo_extension_no_ueid (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate cert;
...
static void x509_openssl_test_create_self_signed_certificate_ca_critical_extension (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate cert;
	int status;
...
static void x509_openssl_test_create_self_signed_certificate_ca_null_extension (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate cert;
	int status;
...
static void x509_openssl_test_create_self_signed_certificate_static_init (CuTest *test)
{
	struct x509_engine_openssl engine = x509_openssl_static_init;
	struct x509_certificate cert;
	int status;
...
static void x509_openssl_test_create_self_signed_certificate_extensions_null (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate cert;
	int status;
...
static void x509_openssl_test_create_self_signed_certificate_sig_unsupported_hash (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate cert;
	int status;
...
static void x509_openssl_test_create_self_signed_certificate_tcbinfo_error (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate cert;
	int status;
...
static void x509_openssl_test_create_self_signed_certificate_ueid_error (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate cert;
	int status;
...
static void x509_openssl_test_load_certificate_static_init (CuTest *test)
{
	struct x509_engine_openssl engine = x509_openssl_static_init;
	struct x509_certificate cert;
	int status;
...
static void x509_openssl_test_create_ca_signed_certificate_end_entity_ecc_intermediate_ca_private_key (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
	...
	status = engine.base.load_certificate (&engine.base, &ca_cert, X509_CERTCA_ECC_CA2_DER,
		X509_CERTCA_ECC_CA2_DER_LEN);
	CuAssertIntEquals (test, 0, status);

	status = engine.base.create_ca_signed_certificate (&engine.base, &cert, ECC_PRIVKEY3_DER,
		ECC_PRIVKEY3_DER_LEN, X509_CA3_SERIAL_NUM, X509_CA3_SERIAL_NUM_LEN, X509_CA3_SUBJECT_NAME,
		X509_CERT_CA, ECC_PRIVKEY2_DER, ECC_PRIVKEY2_DER_LEN, HASH_TYPE_SHA256, &ca_cert, NULL, 0);
	CuAssertIntEquals (test, 0, status);
	CuAssertPtrNotNull (test, cert.context);
	...
	x509_testing_verify_cert (test, der);
	x509_testing_verify_sig_algorithm (test, der);
	x509_testing_verify_signature_ecc (test, der, ECC_PUBKEY2, SHA256);
	x509_testing_end_cert_verification;
...
#if (ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_384)
#ifdef HASH_ENABLE_SHA384
static void x509_openssl_test_create_ca_signed_certificate_ecc384_ca_private_key (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
	struct x509_certificate cert;
...
static void x509_openssl_test_create_ca_signed_certificate_intermediate_ca_ecc384_ca_private_key (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
...
static void x509_openssl_test_create_ca_signed_certificate_ecc384_end_entity_private_key (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
...
static void x509_openssl_test_create_ca_signed_certificate_ecc384_end_entity_ecc_intermediate_ca_private_key (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
	...
	status = engine.base.load_certificate (&engine.base, &ca_cert, X509_CERTCA_ECC384_CA2_DER,
		X509_CERTCA_ECC384_CA2_DER_LEN);
	CuAssertIntEquals (test, 0, status);

	status = engine.base.create_ca_signed_certificate (&engine.base, &cert, ECC384_PRIVKEY3_DER,
		ECC384_PRIVKEY3_DER_LEN, X509_CA3_SERIAL_NUM, X509_CA3_SERIAL_NUM_LEN,
		X509_CA3_SUBJECT_NAME, X509_CERT_CA, ECC384_PRIVKEY2_DER, ECC384_PRIVKEY2_DER_LEN,
		HASH_TYPE_SHA384, &ca_cert, NULL, 0);
	CuAssertIntEquals (test, 0, status);
	CuAssertPtrNotNull (test, cert.context);
	...
	x509_testing_verify_cert (test, der);
	x509_testing_verify_sig_algorithm (test, der);
	x509_testing_verify_signature_ecc (test, der, ECC384_PUBKEY2, SHA384);
	x509_testing_end_cert_verification;
...
static void x509_openssl_test_create_ca_signed_certificate_intermediate_ca_ecc384_ca_private_key_sha256_digest (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
...
static void x509_openssl_test_create_ca_signed_certificate_ecc384_end_entity_private_key_sha256_digest (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
...
#if (ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_521) && defined HASH_ENABLE_SHA512
static void x509_openssl_test_create_ca_signed_certificate_ecc521_ca_private_key (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
	struct x509_certificate cert;
...
static void x509_openssl_test_create_ca_signed_certificate_intermediate_ca_ecc521_ca_private_key (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
...
static void x509_openssl_test_create_ca_signed_certificate_ecc521_end_entity_private_key (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
...
static void x509_openssl_test_create_ca_signed_certificate_ecc521_end_entity_ecc_intermediate_ca_private_key (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
	...
	status = engine.base.load_certificate (&engine.base, &ca_cert, X509_CERTCA_ECC521_CA2_DER,
		X509_CERTCA_ECC521_CA2_DER_LEN);
	CuAssertIntEquals (test, 0, status);

	status = engine.base.create_ca_signed_certificate (&engine.base, &cert, ECC521_PRIVKEY3_DER,
		ECC521_PRIVKEY3_DER_LEN, X509_CA3_SERIAL_NUM, X509_CA3_SERIAL_NUM_LEN,
		X509_CA3_SUBJECT_NAME, X509_CERT_CA, ECC521_PRIVKEY2_DER, ECC521_PRIVKEY2_DER_LEN,
		HASH_TYPE_SHA512, &ca_cert, NULL, 0);
	CuAssertIntEquals (test, 0, status);
	CuAssertPtrNotNull (test, cert.context);
	...
	x509_testing_verify_cert (test, der);
	x509_testing_verify_sig_algorithm (test, der);
	x509_testing_verify_signature_ecc (test, der, ECC521_PUBKEY2, SHA512);
	x509_testing_end_cert_verification;
...
static void x509_openssl_test_create_ca_signed_certificate_ecc384_ca_public_key (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
	struct x509_certificate cert;
...
static void x509_openssl_test_create_ca_signed_certificate_ecc384_end_entity_public_key (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
...
#if (ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_521) && defined HASH_ENABLE_SHA512
static void x509_openssl_test_create_ca_signed_certificate_ecc521_ca_public_key (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
	struct x509_certificate cert;
...
static void x509_openssl_test_create_ca_signed_certificate_ecc521_end_entity_public_key (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
...
#if (ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_384) && defined HASH_ENABLE_SHA384
static void x509_openssl_test_create_ca_signed_certificate_ecc384_ca2_public_key (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
	struct x509_certificate cert;
...
static void x509_openssl_test_create_ca_signed_certificate_end_entity_ecc384_ca2_public_key (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
...
#if (ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_521) && defined HASH_ENABLE_SHA512
static void x509_openssl_test_create_ca_signed_certificate_ecc521_ca2_public_key (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
	struct x509_certificate cert;
...
static void x509_openssl_test_create_ca_signed_certificate_end_entity_ecc521_ca2_public_key (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
...
static void x509_openssl_test_create_ca_signed_certificate_ca_tcbinfo_and_ueid_extension_sha384 (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
...
static void x509_openssl_test_create_ca_signed_certificate_ca_tcbinfo_and_ueid_extension_sha512 (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
...
static void x509_openssl_test_create_ca_signed_certificate_ca_tcbinfo_extension_no_ueid (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
...
static void x509_openssl_test_create_ca_signed_certificate_end_entity_tcbinfo_extension_no_ueid (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
...
static void x509_openssl_test_create_ca_signed_certificate_ca_critical_extension (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
	struct x509_certificate cert;
...
static void x509_openssl_test_create_ca_signed_certificate_ca_null_extension (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
	struct x509_certificate cert;
...
static void x509_openssl_test_create_ca_signed_certificate_static_init (CuTest *test)
{
	struct x509_engine_openssl engine = x509_openssl_static_init;
	struct x509_certificate ca_cert;
	struct x509_certificate cert;
...
static void x509_openssl_test_create_ca_signed_certificate_extensions_null (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
	struct x509_certificate cert;
...
static void x509_openssl_test_create_ca_signed_certificate_sig_unsupported_hash (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
	struct x509_certificate cert;
...
static void x509_openssl_test_create_ca_signed_certificate_tcbinfo_error (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
	struct x509_certificate cert;
...
static void x509_openssl_test_create_ca_signed_certificate_ueid_error (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate ca_cert;
	struct x509_certificate cert;
...
static void x509_openssl_test_get_certificate_version_static_init (CuTest *test)
{
	struct x509_engine_openssl engine = x509_openssl_static_init;
	struct x509_certificate cert;
	int status;
...
static void x509_openssl_test_get_serial_number_static_init (CuTest *test)
{
	struct x509_engine_openssl engine = x509_openssl_static_init;
	struct x509_certificate cert;
	int status;
...
static void x509_openssl_test_get_public_key_type_static_init (CuTest *test)
{
	struct x509_engine_openssl engine = x509_openssl_static_init;
	struct x509_certificate cert;
	int status;
...
static void x509_openssl_test_get_public_key_length_static_init (CuTest *test)
{
	struct x509_engine_openssl engine = x509_openssl_static_init;
	struct x509_certificate cert;
	int status;
...
static void x509_openssl_test_get_public_key_static_init (CuTest *test)
{
	struct x509_engine_openssl engine = x509_openssl_static_init;
	struct x509_certificate cert;
	int status;
...
static void x509_openssl_test_init_ca_cert_store_static_init (CuTest *test)
{
	struct x509_engine_openssl engine = x509_openssl_static_init;
	struct x509_ca_certs store;
	int status;
...
static void x509_openssl_test_add_root_ca_static_init (CuTest *test)
{
	struct x509_engine_openssl engine = x509_openssl_static_init;
	struct x509_ca_certs store;
	int status;
...
static void x509_openssl_test_add_trusted_ca_ecc (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_ca_certs store;
	int status;
...
static void x509_openssl_test_add_trusted_ca_ecc_bad_signature (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_ca_certs store;
	int status;
	...
	status = engine.base.add_trusted_ca (&engine.base, &store, bad_cert, sizeof (bad_cert));
	CuAssertIntEquals (test, 0, status);
...
static void x509_openssl_test_add_trusted_ca_ecc_corrupt_signature (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_ca_certs store;
	int status;
...
static void x509_openssl_test_add_trusted_ca_rsa (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_ca_certs store;
	int status;
	...
	status = engine.base.add_trusted_ca (&engine.base, &store, X509_CERTCA_RSA_CA_DER,
...
static void x509_openssl_test_add_trusted_ca_rsa_bad_signature (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_ca_certs store;
	int status;
...
static void x509_openssl_test_add_trusted_ca_rsa_corrupt_signature (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_ca_certs store;
	int status;
...
static void x509_openssl_test_add_trusted_ca_static_init (CuTest *test)
{
	struct x509_engine_openssl engine = x509_openssl_static_init;
	struct x509_ca_certs store;
	int status;
...
static void x509_openssl_test_add_trusted_ca_null (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_ca_certs store;
	int status;
	...
	status = engine.base.add_trusted_ca (&engine.base, NULL, X509_CERTCA_ECC_CA_DER,
		X509_CERTCA_ECC_CA_DER_LEN);
	CuAssertIntEquals (test, X509_ENGINE_INVALID_ARGUMENT, status);
...
static void x509_openssl_test_add_trusted_ca_ecc_bad_cert (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_ca_certs store;
	int status;
...
static void x509_openssl_test_add_trusted_ca_self_signed (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_ca_certs store;
	int status;
	...
	status = engine.base.add_trusted_ca (&engine.base, &store, X509_CERTSS_ECC_CA_DER,
		X509_CERTSS_ECC_CA_DER_LEN);
...
static void x509_openssl_test_add_trusted_ca_end_entity (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_ca_certs store;
	int status;
	...
	status = engine.base.add_trusted_ca (&engine.base, &store, X509_CERTCA_ECC_EE_DER,
...
static void x509_openssl_test_add_intermediate_ca_static_init (CuTest *test)
{
	struct x509_engine_openssl engine = x509_openssl_static_init;
	struct x509_ca_certs store;
	int status;
...
static void x509_openssl_test_authenticate_ca_one_intermediate_cert (CuTest *test)
{
	...
	status = engine.base.create_ca_signed_certificate (&engine.base, &cert, ECC_PRIVKEY2_DER,
		ECC_PRIVKEY2_DER_LEN, ECC_PRIVKEY2_DER, X509_SERIAL_NUM_LEN, "CA2", X509_CERT_CA,
		ECC_PRIVKEY_DER, ECC_PRIVKEY_DER_LEN, HASH_TYPE_SHA256, &ca, NULL, 0);
	CuAssertIntEquals (test, 0, status);
...
static void x509_openssl_test_authenticate_ca_root_pathlen_constraint (CuTest *test)
{
	...
	status = engine.base.create_ca_signed_certificate (&engine.base, &cert, ECC_PRIVKEY2_DER,
		ECC_PRIVKEY2_DER_LEN, ECC_PRIVKEY2_DER, X509_SERIAL_NUM_LEN, "CA", X509_CERT_CA,
		ECC_PRIVKEY_DER, ECC_PRIVKEY_DER_LEN, HASH_TYPE_SHA256, &ca, NULL, 0);
	CuAssertIntEquals (test, 0, status);
...
static void x509_openssl_test_authenticate_end_entity_multiple_intermediate_certs (CuTest *test)
{
	...
	status = engine.base.create_ca_signed_certificate (&engine.base, &ca2, ECC_PRIVKEY2_DER,
		ECC_PRIVKEY2_DER_LEN, ECC_PRIVKEY2_DER, X509_SERIAL_NUM_LEN, "CA2",
		X509_CERT_CA_PATHLEN (1), ECC_PRIVKEY_DER, ECC_PRIVKEY_DER_LEN, HASH_TYPE_SHA256, &ca1,
		NULL, 0);
	CuAssertIntEquals (test, 0, status);
	...
	status = engine.base.create_ca_signed_certificate (&engine.base, &ca3, ECC_PRIVKEY3_DER,
		ECC_PRIVKEY3_DER_LEN, ECC_PRIVKEY3_DER, X509_SERIAL_NUM_LEN, "CA3", X509_CERT_CA,
		ECC_PRIVKEY2_DER, ECC_PRIVKEY2_DER_LEN, HASH_TYPE_SHA256, &ca2, NULL, 0);
	CuAssertIntEquals (test, 0, status);
	...
	status = engine.base.create_ca_signed_certificate (&engine.base, &cert, ECC_PRIVKEY4_DER,
		ECC_PRIVKEY4_DER_LEN, X509_ENTITY_SERIAL_NUM, X509_ENTITY_SERIAL_NUM_LEN,
		X509_ENTITY_SUBJECT_NAME, X509_CERT_END_ENTITY, ECC_PRIVKEY3_DER, ECC_PRIVKEY3_DER_LEN,
		HASH_TYPE_SHA256, &ca3, NULL, 0);
	CuAssertIntEquals (test, 0, status);
...
static void x509_openssl_test_authenticate_ca_multiple_intermediate_certs (CuTest *test)
{
	...
	status = engine.base.create_ca_signed_certificate (&engine.base, &cert, ECC_PRIVKEY4_DER,
		ECC_PRIVKEY4_DER_LEN, ECC_PRIVKEY4_DER, X509_SERIAL_NUM_LEN, "CA4", X509_CERT_CA,
		ECC_PRIVKEY3_DER, ECC_PRIVKEY3_DER_LEN, HASH_TYPE_SHA256, &ca3, NULL, 0);
	CuAssertIntEquals (test, 0, status);
...
static void x509_openssl_test_authenticate_ecc_end_entity_trusted_intermediate_cert_no_untrusted (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate cert;
	...
	status = engine.base.load_certificate (&engine.base, &cert, X509_CERTCA_ECC_EE3_ICA_DER,
		X509_CERTCA_ECC_EE3_ICA_DER_LEN);
	CuAssertIntEquals (test, 0, status);

	status = engine.base.init_ca_cert_store (&engine.base, &store);
	CuAssertIntEquals (test, 0, status);

	status = engine.base.add_trusted_ca (&engine.base, &store, X509_CERTCA_ECC_CA2_DER,
		X509_CERTCA_ECC_CA2_DER_LEN);
	CuAssertIntEquals (test, 0, status);
...
static void x509_openssl_test_authenticate_ecc_ca_trusted_intermediate_cert_no_untrusted (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate cert;
	...
	status = engine.base.load_certificate (&engine.base, &cert, X509_CERTCA_ECC_CA2_ICA_DER,
		X509_CERTCA_ECC_CA2_ICA_DER_LEN);
	CuAssertIntEquals (test, 0, status);
...
static void x509_openssl_test_authenticate_end_entity_trusted_intermediate_multiple_untrusted_certs (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_ca_certs store;
	...
	status = engine.base.add_trusted_ca (&engine.base, &store, X509_CERTCA_ECC_CA_NOPL_DER,
		X509_CERTCA_ECC_CA_NOPL_DER_LEN);
	CuAssertIntEquals (test, 0, status);
...
static void x509_openssl_test_authenticate_ca_trusted_intermediate_multiple_untrusted_certs (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_ca_certs store;
...
static void x509_openssl_test_authenticate_static_init (CuTest *test)
{
	struct x509_engine_openssl engine = x509_openssl_static_init;
	struct x509_certificate cert;
	struct x509_ca_certs store;
...
static void x509_openssl_test_authenticate_no_path_to_trusted (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_ca_certs store;
	struct x509_certificate ca1;
	...
	/* Don't add CA2 to the chain. */

	status = engine.base.create_ca_signed_certificate (&engine.base, &cert, ECC_PRIVKEY3_DER,
		ECC_PRIVKEY3_DER_LEN, X509_ENTITY_SERIAL_NUM, X509_ENTITY_SERIAL_NUM_LEN,
		X509_ENTITY_SUBJECT_NAME, X509_CERT_END_ENTITY, ECC_PRIVKEY2_DER, ECC_PRIVKEY2_DER_LEN,
		HASH_TYPE_SHA256, &ca2, NULL, 0);
	CuAssertIntEquals (test, 0, status);
...
static void x509_openssl_test_authenticate_partial_path_to_trusted (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_ca_certs store;
	struct x509_certificate ca1;
...
static void x509_openssl_test_authenticate_violate_path_length_constraint (CuTest *test)
{
	...
	status = engine.base.create_ca_signed_certificate (&engine.base, &ca2, ECC_PRIVKEY2_DER,
		ECC_PRIVKEY2_DER_LEN, ECC_PRIVKEY2_DER, X509_SERIAL_NUM_LEN, "CA2", X509_CERT_CA,
		ECC_PRIVKEY_DER, ECC_PRIVKEY_DER_LEN, HASH_TYPE_SHA256, &ca1, NULL, 0);
	CuAssertIntEquals (test, 0, status);
...
static void x509_openssl_test_authenticate_violate_path_length_constraint_with_trusted_ca (
	CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_ca_certs store;
...
static void x509_openssl_test_authenticate_bad_signature_with_trusted_ca (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate cert;
	struct x509_ca_certs store;
	...
	memcpy (bad_cert, X509_CERTCA_ECC_EE3_ICA_DER, X509_CERTCA_ECC_EE3_ICA_DER_LEN);
	status = x509_testing_corrupt_serial_number (bad_cert);
	CuAssertIntEquals (test, 0, status);
...
static void x509_openssl_test_authenticate_corrupt_signature_with_trusted_ca (CuTest *test)
{
	struct x509_engine_openssl engine;
	struct x509_certificate cert;
	struct x509_ca_certs store;
...
TEST (x509_openssl_test_static_init);
...
#if (ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_384)
#ifdef HASH_ENABLE_SHA384
TEST (x509_openssl_test_create_csr_ecc384_ca);
TEST (x509_openssl_test_create_csr_ecc384_end_entity);
#endif
TEST (x509_openssl_test_create_csr_ecc384_ca_sha256_digest);
TEST (x509_openssl_test_create_csr_ecc384_end_entity_sha256_digest);
#endif
#if (ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_521) && defined HASH_ENABLE_SHA512
TEST (x509_openssl_test_create_csr_ecc521_ca);
TEST (x509_openssl_test_create_csr_ecc521_end_entity);
#endif
...
TEST (x509_openssl_test_create_csr_ca_tcbinfo_and_ueid_extension_sha384);
TEST (x509_openssl_test_create_csr_ca_tcbinfo_and_ueid_extension_sha512);
TEST (x509_openssl_test_create_csr_ca_tcbinfo_and_ueid_extension_svn_zero);
TEST (x509_openssl_test_create_csr_ca_tcbinfo_extension_no_ueid);
TEST (x509_openssl_test_create_csr_end_entity_tcbinfo_extension_no_ueid);
TEST (x509_openssl_test_create_csr_ca_critical_extension);
TEST (x509_openssl_test_create_csr_ca_null_extension);
TEST (x509_openssl_test_create_csr_static_init);
TEST (x509_openssl_test_create_csr_null);
TEST (x509_openssl_test_create_csr_eku_null);
TEST (x509_openssl_test_create_csr_extensions_null);
TEST (x509_openssl_test_create_csr_with_public_key);
TEST (x509_openssl_test_create_csr_sig_unsupported_hash);
TEST (x509_openssl_test_create_csr_tcbinfo_error);
TEST (x509_openssl_test_create_csr_ueid_error);
...
#if (ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_384)
#ifdef HASH_ENABLE_SHA384
TEST (x509_openssl_test_create_self_signed_certificate_ecc384_ca);
TEST (x509_openssl_test_create_self_signed_certificate_ecc384_end_entity);
#endif
TEST (x509_openssl_test_create_self_signed_certificate_ecc384_ca_sha256_digest);
TEST (x509_openssl_test_create_self_signed_certificate_ecc384_end_entity_sha256_digest);
#endif
#if (ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_521) && defined HASH_ENABLE_SHA512
TEST (x509_openssl_test_create_self_signed_certificate_ecc521_ca);
TEST (x509_openssl_test_create_self_signed_certificate_ecc521_end_entity);
#endif
...
TEST (x509_openssl_test_create_self_signed_certificate_ecc_ca_tcbinfo_and_ueid_extension_sha384);
TEST (x509_openssl_test_create_self_signed_certificate_ecc_ca_tcbinfo_and_ueid_extension_sha512);
TEST (x509_openssl_test_create_self_signed_certificate_ecc_ca_tcbinfo_and_ueid_extension_svn_zero);
TEST (x509_openssl_test_create_self_signed_certificate_ecc_ca_tcbinfo_extension_no_ueid);
TEST (x509_openssl_test_create_self_signed_certificate_ecc_end_entity_tcbinfo_extension_no_ueid);
TEST (x509_openssl_test_create_self_signed_certificate_ca_critical_extension);
TEST (x509_openssl_test_create_self_signed_certificate_ca_null_extension);
TEST (x509_openssl_test_create_self_signed_certificate_static_init);
TEST (x509_openssl_test_create_self_signed_certificate_null);
TEST (x509_openssl_test_create_self_signed_certificate_extensions_null);
TEST (x509_openssl_test_create_self_signed_certificate_with_public_key);
TEST (x509_openssl_test_create_self_signed_certificate_sig_unsupported_hash);
TEST (x509_openssl_test_create_self_signed_certificate_serial_zero);
TEST (x509_openssl_test_create_self_signed_certificate_tcbinfo_error);
TEST (x509_openssl_test_create_self_signed_certificate_ueid_error);
TEST (x509_openssl_test_load_certificate);
TEST (x509_openssl_test_load_certificate_riot);
TEST (x509_openssl_test_load_certificate_static_init);
...
TEST (x509_openssl_test_create_ca_signed_certificate_end_entity_ecc_intermediate_ca_private_key);
#if (ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_384)
#ifdef HASH_ENABLE_SHA384
TEST (x509_openssl_test_create_ca_signed_certificate_ecc384_ca_private_key);
TEST (x509_openssl_test_create_ca_signed_certificate_intermediate_ca_ecc384_ca_private_key);
TEST (x509_openssl_test_create_ca_signed_certificate_ecc384_end_entity_private_key);
TEST (x509_openssl_test_create_ca_signed_certificate_ecc384_end_entity_ecc_intermediate_ca_private_key);
#endif
TEST (x509_openssl_test_create_ca_signed_certificate_intermediate_ca_ecc384_ca_private_key_sha256_digest);
TEST (x509_openssl_test_create_ca_signed_certificate_ecc384_end_entity_private_key_sha256_digest);
#endif
#if (ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_521) && defined HASH_ENABLE_SHA512
TEST (x509_openssl_test_create_ca_signed_certificate_ecc521_ca_private_key);
TEST (x509_openssl_test_create_ca_signed_certificate_intermediate_ca_ecc521_ca_private_key);
TEST (x509_openssl_test_create_ca_signed_certificate_ecc521_end_entity_private_key);
TEST (x509_openssl_test_create_ca_signed_certificate_ecc521_end_entity_ecc_intermediate_ca_private_key);
#endif
...
#if (ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_384) && defined HASH_ENABLE_SHA384
TEST (x509_openssl_test_create_ca_signed_certificate_ecc384_ca_public_key);
TEST (x509_openssl_test_create_ca_signed_certificate_ecc384_end_entity_public_key);
#endif
#if (ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_521) && defined HASH_ENABLE_SHA512
TEST (x509_openssl_test_create_ca_signed_certificate_ecc521_ca_public_key);
TEST (x509_openssl_test_create_ca_signed_certificate_ecc521_end_entity_public_key);
#endif
...
#if (ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_384) && defined HASH_ENABLE_SHA384
TEST (x509_openssl_test_create_ca_signed_certificate_ecc384_ca2_public_key);
TEST (x509_openssl_test_create_ca_signed_certificate_end_entity_ecc384_ca2_public_key);
#endif
#if (ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_521) && defined HASH_ENABLE_SHA512
TEST (x509_openssl_test_create_ca_signed_certificate_ecc521_ca2_public_key);
TEST (x509_openssl_test_create_ca_signed_certificate_end_entity_ecc521_ca2_public_key);
#endif
...
TEST (x509_openssl_test_create_ca_signed_certificate_ca_tcbinfo_and_ueid_extension_sha384);
TEST (x509_openssl_test_create_ca_signed_certificate_ca_tcbinfo_and_ueid_extension_sha512);
TEST (x509_openssl_test_create_ca_signed_certificate_ca_tcbinfo_and_ueid_extension_svn_zero);
TEST (x509_openssl_test_create_ca_signed_certificate_ca_tcbinfo_extension_no_ueid);
TEST (x509_openssl_test_create_ca_signed_certificate_end_entity_tcbinfo_extension_no_ueid);
TEST (x509_openssl_test_create_ca_signed_certificate_ca_critical_extension);
TEST (x509_openssl_test_create_ca_signed_certificate_ca_null_extension);
TEST (x509_openssl_test_create_ca_signed_certificate_static_init);
TEST (x509_openssl_test_create_ca_signed_certificate_null);
TEST (x509_openssl_test_create_ca_signed_certificate_extensions_null);
TEST (x509_openssl_test_create_ca_signed_certificate_ca_public_key);
TEST (x509_openssl_test_create_ca_signed_certificate_sig_unsupported_hash);
TEST (x509_openssl_test_create_ca_signed_certificate_serial_zero);
TEST (x509_openssl_test_create_ca_signed_certificate_tcbinfo_error);
TEST (x509_openssl_test_create_ca_signed_certificate_ueid_error);
...
TEST (x509_openssl_test_get_certificate_version_static_init);
TEST (x509_openssl_test_get_certificate_version_null);
TEST (x509_openssl_test_get_serial_number);
TEST (x509_openssl_test_get_serial_number_static_init);
...
TEST (x509_openssl_test_get_public_key_type_static_init);
...
TEST (x509_openssl_test_get_public_key_length_static_init);
...
TEST (x509_openssl_test_get_public_key_static_init);
TEST (x509_openssl_test_get_public_key_null);
TEST (x509_openssl_test_init_ca_cert_store);
TEST (x509_openssl_test_init_ca_cert_store_static_init);
...
TEST (x509_openssl_test_add_root_ca_static_init);
...
TEST (x509_openssl_test_add_trusted_ca_ecc);
TEST (x509_openssl_test_add_trusted_ca_ecc_bad_signature);
TEST (x509_openssl_test_add_trusted_ca_ecc_corrupt_signature);
TEST (x509_openssl_test_add_trusted_ca_rsa);
TEST (x509_openssl_test_add_trusted_ca_rsa_bad_signature);
TEST (x509_openssl_test_add_trusted_ca_rsa_corrupt_signature);
TEST (x509_openssl_test_add_trusted_ca_static_init);
TEST (x509_openssl_test_add_trusted_ca_null);
TEST (x509_openssl_test_add_trusted_ca_ecc_bad_cert);
TEST (x509_openssl_test_add_trusted_ca_self_signed);
TEST (x509_openssl_test_add_trusted_ca_end_entity);
...
TEST (x509_openssl_test_add_intermediate_ca_static_init);
...
TEST (x509_openssl_test_authenticate_ecc_end_entity_trusted_intermediate_cert_no_untrusted);
TEST (x509_openssl_test_authenticate_ecc_ca_trusted_intermediate_cert_no_untrusted);
TEST (x509_openssl_test_authenticate_end_entity_trusted_intermediate_multiple_untrusted_certs);
TEST (x509_openssl_test_authenticate_ca_trusted_intermediate_multiple_untrusted_certs);
TEST (x509_openssl_test_authenticate_static_init);
TEST (x509_openssl_test_authenticate_null);
TEST (x509_openssl_test_authenticate_no_path_to_root);
TEST (x509_openssl_test_authenticate_no_path_to_trusted);
TEST (x509_openssl_test_authenticate_partial_path_to_root);
TEST (x509_openssl_test_authenticate_partial_path_to_trusted);
TEST (x509_openssl_test_authenticate_violate_path_length_constraint);
TEST (x509_openssl_test_authenticate_violate_path_length_constraint_with_trusted_ca);
TEST (x509_openssl_test_authenticate_intermediate_bad_signature);
TEST (x509_openssl_test_authenticate_bad_signature_with_trusted_ca);
TEST (x509_openssl_test_authenticate_intermediate_corrupt_signature);
TEST (x509_openssl_test_authenticate_corrupt_signature_with_trusted_ca);
