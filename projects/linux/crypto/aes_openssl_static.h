...
#ifndef AES_OPENSSL_STATIC_H_
#define AES_OPENSSL_STATIC_H_
 ...
 */
#define	AES_OPENSSL_API_INIT	{ \
		.set_key = aes_openssl_set_key, \
		.encrypt_data = aes_openssl_encrypt_data, \
		.encrypt_with_add_data = aes_openssl_encrypt_with_add_data, \
		.decrypt_data = aes_openssl_decrypt_data, \
		.decrypt_with_add_data = aes_openssl_decrypt_with_add_data, \
	}
 ...
 */
#define	aes_openssl_static_init(state_ptr)	{ \
		.base = AES_OPENSSL_API_INIT, \
		.state = state_ptr, \
	}


#endif	/* AES_OPENSSL_STATIC_H_ */
