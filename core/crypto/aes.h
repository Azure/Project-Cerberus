...
struct aes_engine {
	 ...
	 */
	int (*set_key) (const struct aes_engine *engine, const uint8_t *key, size_t length);
	 ...
	 */
	int (*encrypt_data) (const struct aes_engine *engine, const uint8_t *plaintext, size_t length,
	 ...
	 * @return 0 if the data was encrypted successfully or an error code.
	 */
	int (*encrypt_with_add_data) (const struct aes_engine *engine, const uint8_t *plaintext,
	 ...
	 */
	int (*decrypt_data) (const struct aes_engine *engine, const uint8_t *ciphertext, size_t length,
	 ...
	 * @return 0 if the data was decrypted successfully or an error code.
	 */
	int (*decrypt_with_add_data) (const struct aes_engine *engine, const uint8_t *ciphertext,
...
enum {
	...
	AES_ENGINE_ENCRYPT_FAILED = AES_ENGINE_ERROR (0x03),			/**< The plaintext was not encrypted. */
	AES_ENGINE_DECRYPT_FAILED = AES_ENGINE_ERROR (0x04),			/**< The ciphertext was not decrypted. */
	...
	AES_ENGINE_ENCRYPT_ADD_DATA_FAILED = AES_ENGINE_ERROR (0x0d),	/**< The plaintext with additional data was not encrypted. */
	AES_ENGINE_DECRYPT_ADD_DATA_FAILED = AES_ENGINE_ERROR (0x0e),	/**< The ciphertext with additional data was not decrypted. */
};
