...
#ifndef AES_CBC_MBEDTLS_STATIC_H_
#define AES_CBC_MBEDTLS_STATIC_H_
...
/**
 * Initialize a static instance for running AES-CBC operations using mbedTLS.
 *
 * There is no validation done on the arguments.
 *
 * @param state_ptr Variable context for AES operations.
 */
#define	aes_cbc_mbedtls_static_init(state_ptr) { \
		.base = AES_CBC_MBEDTLS_API_INIT, \
		.state = state_ptr, \
	}


#endif	/* AES_CBC_MBEDTLS_STATIC_H_ */
