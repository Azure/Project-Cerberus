 ...
 */
enum {
	FLASH_INVALID_ARGUMENT = FLASH_ERROR (0),			/**< Input parameter is null or not valid. */
	FLASH_NO_MEMORY = FLASH_ERROR (1),					/**< Memory allocation failed. */
	FLASH_DEVICE_SIZE_FAILED = FLASH_ERROR (2),			/**< Failed to determine flash device size. */
	FLASH_READ_FAILED = FLASH_ERROR (3),				/**< Failed to read data from flash. */
	FLASH_PAGE_SIZE_FAILED = FLASH_ERROR (4),			/**< Failed to determine page write size. */
	FLASH_WRITE_FAILED = FLASH_ERROR (5),				/**< Failed to write data to flash. */
	FLASH_SECTOR_SIZE_FAILED = FLASH_ERROR (6),			/**< Failed to determine sector erase size. */
	FLASH_SECTOR_ERASE_FAILED = FLASH_ERROR (7),		/**< Failed to erase a flash sector. */
	FLASH_BLOCK_SIZE_FAILED = FLASH_ERROR (8),			/**< Failed to determine block erase size. */
	FLASH_BLOCK_ERASE_FAILED = FLASH_ERROR (9),			/**< Failed to erase a flash block. */
	FLASH_CHIP_ERASE_FAILED = FLASH_ERROR (10),			/**< Failed to erase the entire flash device. */
	FLASH_ADDRESS_OUT_OF_RANGE = FLASH_ERROR (11),		/**< Invalid address provided for the request. */
	FLASH_NOT_BLANK = FLASH_ERROR (12),					/**< The flash is expected to be blank but is not. */
	FLASH_HW_NOT_INIT = FLASH_ERROR (13),				/**< The flash hardware interface was not initialized. */
	FLASH_MINIMUM_WRITE_FAILED = FLASH_ERROR (14),		/**< Failed to determine the minimum write size. */
};
