 ...
 */
enum {
	FLASH_UPDATER_INVALID_ARGUMENT = FLASH_UPDATER_ERROR (0),		/**< Input parameter is null or not valid. */
	FLASH_UPDATER_NO_MEMORY = FLASH_UPDATER_ERROR (1),				/**< Memory allocation failed. */
	FLASH_UPDATER_TOO_LARGE = FLASH_UPDATER_ERROR (2),				/**< The update is too large for the allocated region. */
	FLASH_UPDATER_INCOMPLETE_WRITE = FLASH_UPDATER_ERROR (3),		/**< All update data was not written to flash. */
	FLASH_UPDATER_OUT_OF_SPACE = FLASH_UPDATER_ERROR (4),			/**< Update data would extend beyond region boundaries. */
};
