 ...
 */
enum {
	FLASH_COMMON_INVALID_ARGUMENT = FLASH_COMMON_ERROR (0),		/**< Input parameter is null or not valid. */
	FLASH_COMMON_NO_MEMORY = FLASH_COMMON_ERROR (1),			/**< Memory allocation failed. */
};
