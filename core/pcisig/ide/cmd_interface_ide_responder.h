...
#define	CMD_INTERFACE_IDE_RESPONDER_ERROR(\
	code)	  ROT_ERROR (ROT_MODULE_CMD_INTERFACE_IDE_RESPONDER, code)
...
enum {
	...
	CMD_INTERFACE_IDE_RESPONDER_SECURE_SPDM_REQUIRED = CMD_INTERFACE_IDE_RESPONDER_ERROR (0x09),	/**< The request must be received using Secure SPDM */
};
