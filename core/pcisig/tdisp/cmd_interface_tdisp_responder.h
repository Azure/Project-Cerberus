...
int cmd_interface_tdisp_responder_init (struct cmd_interface_tdisp_responder *tdisp_responder,
	struct tdisp_state *state, struct tdisp_driver *tdisp_driver,
...
#define	CMD_INTERFACE_TDISP_RESPONDER_ERROR(code)		ROT_ERROR (ROT_MODULE_CMD_INTERFACE_TDISP_RESPONDER, code)
...
enum {
	...
	CMD_INTERFACE_TDISP_RESPONDER_PROCESS_REQUEST_FAILED = CMD_INTERFACE_TDISP_RESPONDER_ERROR (0x04),	/**< The request processing failed. */
	...
	CMD_INTERFACE_TDISP_RESPONDER_UNSUPPORTED_OPERATION = CMD_INTERFACE_TDISP_RESPONDER_ERROR (0x07)	/**< The operation is not supported. */
};
