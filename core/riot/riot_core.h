 ...
 */
enum {
	RIOT_CORE_INVALID_ARGUMENT = RIOT_CORE_ERROR (0),		/**< Input parameter is null or not valid. */
	RIOT_CORE_NO_MEMORY = RIOT_CORE_ERROR (1),				/**< Memory allocation failed. */
	RIOT_CORE_NO_DEVICE_ID = RIOT_CORE_ERROR (2),			/**< No Device ID has been generated. */
	RIOT_CORE_NO_ALIAS_KEY = RIOT_CORE_ERROR (3),			/**< No Alias Key has been generated. */
	RIOT_CORE_BAD_FWID_LENGTH = RIOT_CORE_ERROR (4),		/**< The FWID is not the right length. */
};
