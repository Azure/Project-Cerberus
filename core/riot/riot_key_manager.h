 ...
 */
enum {
	RIOT_KEY_MANAGER_INVALID_ARGUMENT = RIOT_KEY_MANAGER_ERROR (0),		/**< Input parameter is null or not valid. */
	RIOT_KEY_MANAGER_NO_MEMORY = RIOT_KEY_MANAGER_ERROR (1),			/**< Memory allocation failed. */
	RIOT_KEY_MANAGER_KEYSTORE_LOCKED = RIOT_KEY_MANAGER_ERROR (2),		/**< The keystore is locked from modification. */
	RIOT_KEY_MANAGER_NO_SIGNED_DEVICE_ID = RIOT_KEY_MANAGER_ERROR (3),	/**< There is no signed device ID stored. */
	RIOT_KEY_MANAGER_NO_ROOT_CA = RIOT_KEY_MANAGER_ERROR (4),			/**< There is no root CA stored. */
};
