...
//
RIOT_STATUS DERDECReadSequence (
	size_t *len, const uint8_t *der_buf, size_t der_len, size_t *position);
...
//         - RIOT_FAILURE otherwise
//
RIOT_STATUS DERDECGetPrivKey (
	uint8_t *private_key, size_t *key_len, const uint8_t *private_key_der,
...
//         - RIOT_FAILURE otherwise
//
RIOT_STATUS DERDECGetPubKey (
	const uint8_t **public_key,	size_t *key_len, const uint8_t *public_key_der,
	const size_t key_der_len);
...
//         - RIOT_FAILURE otherwise
//
RIOT_STATUS DERDECGetPubKeyFromPrivKey (
	const uint8_t **public_key,	size_t *key_len, const uint8_t *private_key_der,
	const size_t key_der_len);
...
//         - RIOT_FAILURE otherwise
//
RIOT_STATUS DERDECGetPubKeyInfo (
	RIOT_X509_PUBLIC_KEY *public_key, const uint8_t *key_der, const size_t key_der_len);
...
//         - RIOT_FAILURE otherwise
//
RIOT_STATUS DERDECGetSubjectName (
	char **name, const uint8_t *der, size_t length);
