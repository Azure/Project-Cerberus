...
static int base64toValue (
	char Base64Character, unsigned char *Val)
{
	int result = 0;
...
static uint32_t base64CharacterCount (
...
static uint32_t Base64DecodedLength (
	const char *EncodedString)
