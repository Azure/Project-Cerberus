 ...
 */
enum {
	I2C_MASTER_INVALID_ARGUMENT = I2C_MASTER_ERROR (0),			/**< Input parameter is null or not valid. */
	I2C_MASTER_NO_MEMORY = I2C_MASTER_ERROR (1),				/**< Memory allocation failed. */
	I2C_MASTER_WRITE_REG_FAILED = I2C_MASTER_ERROR (2),			/**< Could not write to a register. */
	I2C_MASTER_READ_REG_FAILED = I2C_MASTER_ERROR (3),			/**< Could not read from a register. */
	I2C_MASTER_BUSY = I2C_MASTER_ERROR (4),						/**< The I2C master is busy executing a transaction. */
	I2C_MASTER_TIMEOUT = I2C_MASTER_ERROR (5),					/**< The I2C transaction timed out. */
};
