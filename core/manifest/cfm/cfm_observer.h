 ...
 */
enum {
	CFM_OBSERVER_INVALID_ARGUMENT = CFM_OBSERVER_ERROR (0),		/**< Input parameter is null or not valid. */
	CFM_OBSERVER_NO_MEMORY = CFM_OBSERVER_ERROR (1),			/**< Memory allocation failed. */
};
