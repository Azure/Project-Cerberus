...
struct pfm {
	...
	/**
	 * Get the string identifier of the platform for this manifest.
	 *
	 ...
	 */
	int (*get_platform_id) (struct pfm *pfm, char **id);
 ...
 */
enum {
	PFM_INVALID_ARGUMENT = PFM_ERROR (0),			/**< Input parameter is null or not valid. */
	PFM_NO_MEMORY = PFM_ERROR (1),					/**< Memory allocation failed. */
	PFM_GET_VERSIONS_FAILED = PFM_ERROR (2),		/**< The supported firmware version list was not generated. */
	PFM_GET_READ_WRITE_FAILED = PFM_ERROR (3),		/**< The list of read/write regions was not generated. */
	PFM_GET_FW_IMAGES_FAILED = PFM_ERROR (4),		/**< The list of signed firmware was not generated. */
	PFM_UNSUPPORTED_VERSION = PFM_ERROR (5),		/**< The firmware version is not supported by the PFM. */
	PFM_UNKNOWN_KEY_ID = PFM_ERROR (6),				/**< A firmware image is signed with a key not in the PFM. */
};
