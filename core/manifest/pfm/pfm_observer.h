...
struct pfm_observer {
	 ...
	 */
	void (*on_pfm_verified) (const struct pfm_observer *observer, const struct pfm *pending);
	 ...
	 */
	void (*on_pfm_activated) (const struct pfm_observer *observer, const struct pfm *active);
