 ...
 */
enum {
	MANIFEST_VERIFICATION_INVALID_ARGUMENT = MANIFEST_VERIFICATION_ERROR (0),		/**< Input parameter is null or not valid. */
	MANIFEST_VERIFICATION_NO_MEMORY = MANIFEST_VERIFICATION_ERROR (1),				/**< Memory allocation failed. */
};
