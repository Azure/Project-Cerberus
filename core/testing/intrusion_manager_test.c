...
#include "mock/intrusion_state_mock.h"
#include "mock/hash_mock.h"
#include "engines/hash_testing_engine.h"
#include "intrusion_manager_testing.h"


static const char *SUITE = "intrusion_manager";
...
CuSuite* get_intrusion_manager_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, intrusion_manager_test_init);
	SUITE_ADD_TEST (suite, intrusion_manager_test_init_second_measurement);
	SUITE_ADD_TEST (suite, intrusion_manager_test_init_null);
	SUITE_ADD_TEST (suite, intrusion_manager_test_init_invalid_measurement);
	SUITE_ADD_TEST (suite, intrusion_manager_test_init_hash_error);
	SUITE_ADD_TEST (suite, intrusion_manager_test_release_null);
	SUITE_ADD_TEST (suite, intrusion_manager_test_handle_intrusion);
	SUITE_ADD_TEST (suite, intrusion_manager_test_handle_intrusion_null);
	SUITE_ADD_TEST (suite, intrusion_manager_test_handle_intrusion_hash_error);
	SUITE_ADD_TEST (suite, intrusion_manager_test_handle_intrusion_state_error);
	SUITE_ADD_TEST (suite, intrusion_manager_test_handle_intrusion_hash_error_and_state_error);
	SUITE_ADD_TEST (suite, intrusion_manager_test_reset_intrusion);
	SUITE_ADD_TEST (suite, intrusion_manager_test_reset_intrusion_null);
	SUITE_ADD_TEST (suite, intrusion_manager_test_reset_intrusion_state_error);
	SUITE_ADD_TEST (suite, intrusion_manager_test_reset_intrusion_hash_error);
	SUITE_ADD_TEST (suite, intrusion_manager_test_check_state_no_intrusion);
	SUITE_ADD_TEST (suite, intrusion_manager_test_check_state_intrusion);
	SUITE_ADD_TEST (suite, intrusion_manager_test_check_state_check_error);
	SUITE_ADD_TEST (suite, intrusion_manager_test_check_state_check_error_from_intrusion);
	SUITE_ADD_TEST (suite, intrusion_manager_test_check_state_check_error_from_no_intrusion);
	SUITE_ADD_TEST (suite, intrusion_manager_test_check_state_deferred);
	SUITE_ADD_TEST (suite, intrusion_manager_test_check_state_null);
	SUITE_ADD_TEST (suite, intrusion_manager_test_check_state_no_intrusion_hash_error);
	SUITE_ADD_TEST (suite, intrusion_manager_test_check_state_intrusion_hash_error);
	SUITE_ADD_TEST (suite, intrusion_manager_test_check_state_check_error_and_hash_error);
