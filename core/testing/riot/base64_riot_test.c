...
#include "riot/base64_riot_static.h"
...
static void base64_riot_test_static_init (CuTest *test)
{
	struct base64_engine_riot engine = base64_riot_static_init;
...
static void base64_riot_test_encode_static_init (CuTest *test)
{
	struct base64_engine_riot engine = base64_riot_static_init;
	int status;
	uint8_t out[BASE64_ENCODED_BLOCK_LEN * 2];
...
TEST (base64_riot_test_static_init);
...
TEST (base64_riot_test_encode_static_init);
