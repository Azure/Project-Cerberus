...
CuSuite* get_host_processor_single_power_on_reset_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_no_pfm);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_no_pfm_cs1);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_no_pfm_no_observer);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_no_pfm_bypass);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_no_pfm_checked);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_no_pfm_checked_bypass);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_no_pfm_dirty);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_no_pfm_dirty_bypass);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_no_pfm_dirty_checked);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_no_pfm_dirty_checked_bypass);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_active_pfm_not_dirty);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_active_pfm_not_dirty_multiple_fw);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_active_pfm_not_dirty_no_observer);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_active_pfm_not_dirty_bypass);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_active_pfm_not_dirty_checked);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_active_pfm_not_dirty_checked_bypass);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_active_pfm_dirty);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_active_pfm_dirty_multiple_fw);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_active_pfm_dirty_no_observer);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_active_pfm_dirty_bypass);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_active_pfm_dirty_prevalidated_flash);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_active_pfm_dirty_prevalidated_flash_bypass);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_active_pfm_dirty_prevalidated_flash_and_pfm);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_active_pfm_dirty_prevalidated_flash_and_pfm_bypass);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_active_pfm_dirty_checked);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_active_pfm_dirty_checked_bypass);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_active_pfm_dirty_checked_prevalidated_flash);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_not_dirty);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_not_dirty_multiple_fw);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_not_dirty_no_observer);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_not_dirty_empty_manifest);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_not_dirty_bypass);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_not_dirty_bypass_empty_manifest);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_not_dirty_checked);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_not_dirty_checked_empty_manifest);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_not_dirty_checked_bypass);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_not_dirty_checked_bypass_empty_manifest);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_pending_pfm_no_active_dirty);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_dirty_multiple_fw);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_dirty_no_observer);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_dirty_empty_manifest);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_dirty_bypass);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_dirty_bypass_empty_manifest);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_dirty_checked);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_dirty_checked_empty_manifest);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_dirty_checked_bypass);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_dirty_checked_bypass_empty_manifest);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_with_active_not_dirty);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_with_active_not_dirty_multiple_fw);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_with_active_not_dirty_no_observer);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_with_active_not_dirty_empty_manifest);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_with_active_not_dirty_bypass);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_with_active_not_dirty_bypass_empty_manifest);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_with_active_not_dirty_checked);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_pending_pfm_with_active_dirty);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_with_active_dirty_multiple_fw);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_with_active_dirty_no_observer);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_with_active_dirty_empty_manifest);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_with_active_dirty_bypass);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_with_active_dirty_checked);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_with_active_dirty_checked_empty_manifest);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_with_active_dirty_checked_bypass);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_active_pfm_not_dirty_validation_fail);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_active_pfm_not_dirty_hash_validation_fail);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_active_pfm_not_dirty_unknown_version);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_active_pfm_dirty_validation_fail);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_active_pfm_dirty_hash_validation_fail);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_active_pfm_dirty_blank_fail);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_active_pfm_dirty_unknown_version);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_dirty_validation_fail);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_dirty_hash_validation_fail);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_dirty_unknown_version);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_with_active_dirty_validation_fail);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_with_active_dirty_hash_validation_fail);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_with_active_dirty_blank_fail);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_with_active_dirty_unknown_version);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_unsupported_flash);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_null);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_rot_access_error);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_rot_access_unsupported_device);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_rot_access_incompatible_spi_master);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_rot_access_no_device);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_rot_access_no_4byte_addr_commands);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_rot_access_4byte_addr_incompatible);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_rot_access_unknown_quad_enable);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_rot_access_large_device);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_flash_type_error);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_flash_type_unsupported_vendor);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_flash_type_unsupported_device);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_flash_type_mismatched_vendor);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_flash_type_mismatched_devices);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_flash_type_mismatched_sizes);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_flash_type_mismatched_addr_modes);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_host_access_error);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_no_pfm_dirty_clear_error);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_no_pfm_filter_error);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_no_pfm_cs_error);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_active_pfm_not_dirty_validation_error);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_active_pfm_not_dirty_config_error);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_active_pfm_not_dirty_filter_error);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_active_pfm_dirty_validation_error);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_active_pfm_dirty_swap_error);
	SUITE_ADD_TEST (suite, host_processor_single_test_power_on_reset_active_pfm_dirty_filter_error);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_dirty_validation_error);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_dirty_empty_error);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_dirty_init_error);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_dirty_filter_error);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_dirty_filter_bypass_error);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_no_active_dirty_cs_bypass_error);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_with_active_not_dirty_config_error);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_with_active_not_dirty_filter_error);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_with_active_dirty_validation_error);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_with_active_dirty_empty_error);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_with_active_dirty_swap_error);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_power_on_reset_pending_pfm_with_active_dirty_filter_error);
	SUITE_ADD_TEST (suite,
