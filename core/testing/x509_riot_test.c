...
static const char *SUITE = "x509_riot";
...
CuSuite* get_x509_riot_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, x509_riot_test_init);
	SUITE_ADD_TEST (suite, x509_riot_test_init_null);
	SUITE_ADD_TEST (suite, x509_riot_test_release_null);
	SUITE_ADD_TEST (suite, x509_riot_test_create_csr_ecc_ca);
	SUITE_ADD_TEST (suite, x509_riot_test_create_csr_ecc_end_entity);
	SUITE_ADD_TEST (suite, x509_riot_test_create_csr_ca_non_zero_path_length_constraint);
	SUITE_ADD_TEST (suite, x509_riot_test_create_csr_ca_no_path_length_constraint);
	SUITE_ADD_TEST (suite, x509_riot_test_create_csr_ca_with_eku_oid);
	SUITE_ADD_TEST (suite, x509_riot_test_create_csr_end_entity_with_eku_oid);
	SUITE_ADD_TEST (suite, x509_riot_test_create_csr_ca_tcbinfo_and_ueid_extension);
	SUITE_ADD_TEST (suite, x509_riot_test_create_csr_end_entity_tcbinfo_and_ueid_extension);
	SUITE_ADD_TEST (suite, x509_riot_test_create_csr_ca_tcbinfo_and_ueid_extension_sha1);
	SUITE_ADD_TEST (suite, x509_riot_test_create_csr_ca_tcbinfo_and_ueid_extension_svn_zero);
	SUITE_ADD_TEST (suite, x509_riot_test_create_csr_ca_tcbinfo_extension_ueid_null);
	SUITE_ADD_TEST (suite, x509_riot_test_create_csr_end_entity_tcbinfo_extension_ueid_null);
	SUITE_ADD_TEST (suite, x509_riot_test_create_csr_null);
	SUITE_ADD_TEST (suite, x509_riot_test_create_csr_with_public_key);
	SUITE_ADD_TEST (suite, x509_riot_test_create_csr_ca_tcbinfo_unknown_hash);
	SUITE_ADD_TEST (suite, x509_riot_test_create_csr_ca_tcbinfo_fwid_null);
	SUITE_ADD_TEST (suite, x509_riot_test_create_csr_ca_tcbinfo_version_null);
	SUITE_ADD_TEST (suite, x509_riot_test_create_csr_ueid_null);
	SUITE_ADD_TEST (suite, x509_riot_test_create_csr_ueid_zero_length);
	SUITE_ADD_TEST (suite, x509_riot_test_create_self_signed_certificate_ecc_ca);
 	SUITE_ADD_TEST (suite, x509_riot_test_create_self_signed_certificate_ecc_end_entity);
	SUITE_ADD_TEST (suite,
		x509_riot_test_create_self_signed_certificate_ca_non_zero_path_length_constraint);
	SUITE_ADD_TEST (suite,
		x509_riot_test_create_self_signed_certificate_ca_no_path_length_constraint);
	SUITE_ADD_TEST (suite,
		x509_riot_test_create_self_signed_certificate_ecc_ca_tcbinfo_and_ueid_extension);
	SUITE_ADD_TEST (suite,
		x509_riot_test_create_self_signed_certificate_ecc_end_entity_tcbinfo_and_ueid_extension);
	SUITE_ADD_TEST (suite,
		x509_riot_test_create_self_signed_certificate_ecc_ca_tcbinfo_and_ueid_extension_sha1);
	SUITE_ADD_TEST (suite,
		x509_riot_test_create_self_signed_certificate_ecc_ca_tcbinfo_and_ueid_extension_svn_zero);
	SUITE_ADD_TEST (suite,
		x509_riot_test_create_self_signed_certificate_ecc_ca_tcbinfo_extension_ueid_null);
	SUITE_ADD_TEST (suite,
		x509_riot_test_create_self_signed_certificate_ecc_end_entity_tcbinfo_extension_ueid_null);
	SUITE_ADD_TEST (suite, x509_riot_test_create_self_signed_certificate_null);
	SUITE_ADD_TEST (suite, x509_riot_test_create_self_signed_certificate_with_public_key);
	SUITE_ADD_TEST (suite, x509_riot_test_create_self_signed_certificate_with_long_serial_num);
	SUITE_ADD_TEST (suite, x509_riot_test_create_self_signed_certificate_tcbinfo_unknown_hash);
	SUITE_ADD_TEST (suite, x509_riot_test_create_self_signed_certificate_tcbinfo_fwid_null);
	SUITE_ADD_TEST (suite, x509_riot_test_create_self_signed_certificate_tcbinfo_version_null);
	SUITE_ADD_TEST (suite, x509_riot_test_create_self_signed_certificate_ueid_null);
	SUITE_ADD_TEST (suite, x509_riot_test_create_self_signed_certificate_ueid_zero_length);
	SUITE_ADD_TEST (suite, x509_riot_test_create_self_signed_certificate_serial_zero);
	SUITE_ADD_TEST (suite, x509_riot_test_load_certificate);
	SUITE_ADD_TEST (suite, x509_riot_test_load_certificate_riot);
	SUITE_ADD_TEST (suite, x509_riot_test_load_certificate_null);
	...
	SUITE_ADD_TEST (suite, x509_riot_test_create_ca_signed_certificate_ecc_ca_public_key);
	SUITE_ADD_TEST (suite,
		x509_riot_test_create_ca_signed_certificate_ecc_end_entity_public_key);
	SUITE_ADD_TEST (suite, x509_riot_test_create_ca_signed_certificate_rsa_ca_public_key);
	SUITE_ADD_TEST (suite,
		x509_riot_test_create_ca_signed_certificate_rsa_end_entity_public_key);
	SUITE_ADD_TEST (suite, x509_riot_test_create_ca_signed_certificate_ecc_ca2_public_key);
	SUITE_ADD_TEST (suite,
		x509_riot_test_create_ca_signed_certificate_end_entity_ecc_ca2_public_key);
	SUITE_ADD_TEST (suite,
		x509_riot_test_create_ca_signed_certificate_ca_non_zero_path_length_constraint);
	SUITE_ADD_TEST (suite,
		x509_riot_test_create_ca_signed_certificate_ca_no_path_length_constraint);
	SUITE_ADD_TEST (suite,
		x509_riot_test_create_ca_signed_certificate_ca_tcbinfo_and_ueid_extension);
	SUITE_ADD_TEST (suite,
		x509_riot_test_create_ca_signed_certificate_end_entity_tcbinfo_and_ueid_extension);
	SUITE_ADD_TEST (suite,
		x509_riot_test_create_ca_signed_certificate_ca_tcbinfo_and_ueid_extension_sha1);
	SUITE_ADD_TEST (suite,
		x509_riot_test_create_ca_signed_certificate_ca_tcbinfo_and_ueid_extension_svn_zero);
	SUITE_ADD_TEST (suite,
		x509_riot_test_create_ca_signed_certificate_ca_tcbinfo_extension_ueid_null);
	SUITE_ADD_TEST (suite,
		x509_riot_test_create_ca_signed_certificate_end_entity_tcbinfo_extension_ueid_null);
	SUITE_ADD_TEST (suite, x509_riot_test_create_ca_signed_certificate_null);
	SUITE_ADD_TEST (suite, x509_riot_test_create_ca_signed_certificate_ca_public_key);
	SUITE_ADD_TEST (suite,
		x509_riot_test_create_ca_signed_certificate_tcbinfo_extension_unknown_hash);
	SUITE_ADD_TEST (suite, x509_riot_test_create_ca_signed_certificate_tcbinfo_extension_fwid_null);
	SUITE_ADD_TEST (suite,
		x509_riot_test_create_ca_signed_certificate_tcbinfo_extension_version_null);
	SUITE_ADD_TEST (suite, x509_riot_test_create_ca_signed_certificate_ueid_extension_ueid_null);
	SUITE_ADD_TEST (suite,
		x509_riot_test_create_ca_signed_certificate_ueid_extension_ueid_zero_length);
	SUITE_ADD_TEST (suite, x509_riot_test_create_ca_signed_certificate_serial_zero);
	SUITE_ADD_TEST (suite, x509_riot_test_create_ca_signed_certificate_with_long_serial_num);
	SUITE_ADD_TEST (suite, x509_riot_test_release_certificate_null);
	SUITE_ADD_TEST (suite, x509_riot_test_get_certificate_der_null);
