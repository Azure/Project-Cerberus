...
static const char *SUITE = "host_irq_handler_mask_irqs";
...
CuSuite* get_host_irq_handler_mask_irqs_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, host_irq_handler_mask_irqs_test_init);
	SUITE_ADD_TEST (suite, host_irq_handler_mask_irqs_test_init_no_recovery);
	SUITE_ADD_TEST (suite, host_irq_handler_mask_irqs_test_init_null);
	SUITE_ADD_TEST (suite, host_irq_handler_mask_irqs_test_release_null);
	SUITE_ADD_TEST (suite, host_irq_handler_mask_irqs_test_enter_reset);
	SUITE_ADD_TEST (suite, host_irq_handler_mask_irqs_test_enter_reset_no_recovery);
	SUITE_ADD_TEST (suite, host_irq_handler_mask_irqs_test_enter_reset_null);
	SUITE_ADD_TEST (suite, host_irq_handler_mask_irqs_test_enter_reset_host_error);
	SUITE_ADD_TEST (suite, host_irq_handler_mask_irqs_test_exit_reset);
	SUITE_ADD_TEST (suite, host_irq_handler_mask_irqs_test_exit_reset_no_recovery);
	SUITE_ADD_TEST (suite, host_irq_handler_mask_irqs_test_exit_reset_null);
	SUITE_ADD_TEST (suite, host_irq_handler_mask_irqs_test_assert_cs0);
	SUITE_ADD_TEST (suite, host_irq_handler_mask_irqs_test_assert_cs0_no_recovery);
	SUITE_ADD_TEST (suite, host_irq_handler_mask_irqs_test_assert_cs0_null);
	SUITE_ADD_TEST (suite, host_irq_handler_mask_irqs_test_assert_cs1);
	SUITE_ADD_TEST (suite, host_irq_handler_mask_irqs_test_assert_cs1_no_recovery);
	SUITE_ADD_TEST (suite, host_irq_handler_mask_irqs_test_assert_cs1_null);
	SUITE_ADD_TEST (suite, host_irq_handler_mask_irqs_test_assert_cs1_recovery_error);
