...
static const char *SUITE = "manifest_flash_v2";
...
CuSuite* get_manifest_flash_v2_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, manifest_flash_v2_test_init);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_init_null);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_init_not_aligned);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_init_block_size_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_with_mock_hash);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_platform_id_first);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_ecc_signature);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_sha384);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_sha512);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_different_hash_types);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_no_element_hashes);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_partial_element_hashes);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_max_entries_and_hashes);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_minimum_platform_id_buffer_length);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_with_hash_out);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_with_hash_out_sha384);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_with_hash_out_sha512);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_null);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_small_hash_buffer);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_small_hash_buffer_sha384);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_small_hash_buffer_sha512);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_header_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_header_read_error_with_hash_out);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_bad_magic_number);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_bad_magic_number_v1_unsupported);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_bad_magic_number_v2_unsupported);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_sig_unknown_hash_type);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_sig_longer_than_manifest);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_sig_same_length_as_manifest);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_sig_length_into_header);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_sig_too_long);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_sig_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_bad_signature);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_bad_signature_with_hash_out);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_bad_signature_ecc_with_hash_out);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_start_hash_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_header_hash_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_toc_unknown_hash_type);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_toc_no_platform_id_element);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_toc_header_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_toc_header_hash_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_toc_element_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_toc_element_hash_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_toc_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_toc_hash_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_toc_hash_hash_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_manifest_part1_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_platform_id_too_long);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_platform_id_header_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_platform_id_header_hash_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_platform_id_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_platform_id_hash_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_manifest_part2_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_finish_hash_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_verify_finish_hash_error_with_hash_out);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_id);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_id_null);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_id_verify_never_run);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_id_after_verify_header_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_id_after_verify_bad_signature);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_platform_id);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_platform_id_manifest_allocation);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_platform_id_null);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_platform_id_small_buffer);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_platform_id_verify_never_run);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_platform_id_after_verify_header_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_platform_id_after_verify_bad_signature);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_hash_sha256);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_hash_sha384);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_hash_sha512);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_hash_verify_never_run);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_hash_after_verify_header_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_hash_after_verify_finish_hash_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_hash_after_verify_bad_signature);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_hash_null);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_hash_small_hash_buffer);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_hash_small_hash_buffer_sha384);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_hash_small_hash_buffer_sha512);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_hash_header_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_hash_bad_magic_number);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_hash_bad_magic_number_v1_unsupported);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_hash_bad_magic_number_v2_unsupported);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_hash_sig_longer_than_manifest);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_hash_sig_same_length_as_manifest);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_hash_sig_length_into_header);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_hash_verify_never_run_small_hash_buffer);
	SUITE_ADD_TEST (suite,
		manifest_flash_v2_test_get_hash_verify_never_run_small_hash_buffer_sha384);
	SUITE_ADD_TEST (suite,
		manifest_flash_v2_test_get_hash_verify_never_run_small_hash_buffer_sha512);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_hash_unknown_hash_type);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_hash_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_signature);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_signature_verify_never_run);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_signature_after_verify_header_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_signature_after_verify_finish_hash_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_signature_after_verify_bad_signature);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_signature_null);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_signature_small_sig_buffer);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_signature_verify_never_run_small_sig_buffer);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_signature_header_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_signature_bad_magic_number);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_signature_bad_magic_number_v1_unsupported);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_signature_bad_magic_number_v2_unsupported);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_signature_sig_longer_than_manifest);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_signature_sig_same_length_as_manifest);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_signature_sig_length_into_header);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_get_signature_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_no_found_output);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_no_format_output);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_no_total_length_output);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_dynamic_allocation);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_with_mock_hash);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_first_element);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_first_element_hash);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_with_start_offset);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_no_hash);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_no_hash_invalid_id);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_with_parent);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_second_element_instance);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_partial_element);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_partial_element_no_hash);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_large_buffer);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_max_entry_and_hash);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_with_read_offset);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_with_read_offset_no_hash);
	SUITE_ADD_TEST (suite,
		manifest_flash_v2_test_read_element_data_with_read_offset_dynamic_allocation);
	SUITE_ADD_TEST (suite,
		manifest_flash_v2_test_read_element_data_partial_element_with_read_offset);
	SUITE_ADD_TEST (suite,
		manifest_flash_v2_test_read_element_data_partial_element_with_read_offset_no_hash);
	SUITE_ADD_TEST (suite,
		manifest_flash_v2_test_read_element_data_with_read_offset_larger_than_element);
	SUITE_ADD_TEST (suite,
		manifest_flash_v2_test_read_element_data_with_read_offset_larger_than_element_dynamic_allocation);
	SUITE_ADD_TEST (suite,
		manifest_flash_v2_test_read_element_data_with_read_offset_equal_to_element_length);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_read_zero_length);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_read_null_element);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_null);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_verify_never_run);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_after_verify_header_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_after_verify_bad_signature);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_element_not_found_not_present);
	SUITE_ADD_TEST (suite,
		manifest_flash_v2_test_read_element_data_element_not_found_start_after_element);
	SUITE_ADD_TEST (suite,
		manifest_flash_v2_test_read_element_data_element_not_found_bad_start_entry);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_with_parent_wrong_type);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_with_parent_wrong_type_no_hash);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_with_parent_child_not_found);
	SUITE_ADD_TEST (suite,
		manifest_flash_v2_test_read_element_data_with_parent_child_not_found_last_element);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_with_parent_bad_start_entry);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_child_no_parent_specified);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_bad_toc_hash);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_bad_element_hash);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_start_toc_hash_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_toc_header_hash_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_toc_beginning_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_toc_entry_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_toc_entry_hash_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_toc_middle_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_toc_element_hash_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_toc_element_hash_hash_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_toc_end_read_error);
	SUITE_ADD_TEST (suite,
		manifest_flash_v2_test_read_element_data_toc_end_no_element_hash_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_finish_toc_hash_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_start_element_hash_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_element_offset_data_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_element_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_element_hash_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_extra_element_data_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_read_element_data_finish_element_hash_error);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_compare_platform_id_equal);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_compare_platform_id_different);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_compare_platform_id_no_manifest1);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_compare_platform_id_no_manifest2);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_compare_platform_id_no_manifests);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_compare_platform_id_null_manifest1);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_compare_platform_id_null_manifest2);
	SUITE_ADD_TEST (suite, manifest_flash_v2_test_compare_platform_id_both_null);
