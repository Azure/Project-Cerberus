...
static const char *SUITE = "signature_verification_ecc";
...
CuSuite* get_signature_verification_ecc_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, signature_verification_ecc_test_init);
	SUITE_ADD_TEST (suite, signature_verification_ecc_test_init_private_key);
	SUITE_ADD_TEST (suite, signature_verification_ecc_test_init_null);
	SUITE_ADD_TEST (suite, signature_verification_ecc_test_init_not_ecc_key);
	SUITE_ADD_TEST (suite, signature_verification_ecc_test_init_private_key_error);
	SUITE_ADD_TEST (suite, signature_verification_ecc_test_release_null);
	SUITE_ADD_TEST (suite, signature_verification_ecc_test_verify_signature);
	SUITE_ADD_TEST (suite, signature_verification_ecc_test_verify_signature_private_key);
	SUITE_ADD_TEST (suite, signature_verification_ecc_test_verify_signature_bad_hash);
	SUITE_ADD_TEST (suite, signature_verification_ecc_test_verify_signature_bad_signature);
	SUITE_ADD_TEST (suite, signature_verification_ecc_test_verify_signature_null);
