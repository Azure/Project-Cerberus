...
#include "mock/firmware_image_mock.h"
#include "mock/app_context_mock.h"
#include "mock/flash_mock.h"
#include "mock/firmware_update_notification_mock.h"
#include "mock/key_manifest_mock.h"
#include "mock/firmware_update_mock.h"
#include "mock/firmware_update_observer_mock.h"
#include "rsa_testing.h"
#include "firmware_header_testing.h"
#include "image_header_testing.h"


static const char *SUITE = "firmware_update";
...
CuSuite* get_firmware_update_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, firmware_update_test_init);
	SUITE_ADD_TEST (suite, firmware_update_test_init_null);
	SUITE_ADD_TEST (suite, firmware_update_test_init_no_recovery);
	SUITE_ADD_TEST (suite, firmware_update_test_init_no_recovery_backup);
	SUITE_ADD_TEST (suite, firmware_update_test_init_no_backup);
	SUITE_ADD_TEST (suite, firmware_update_test_init_no_recovery_no_backup);
	SUITE_ADD_TEST (suite, firmware_update_test_init_no_active_or_staging);
	SUITE_ADD_TEST (suite, firmware_update_test_release_null);
	SUITE_ADD_TEST (suite, firmware_update_test_release_no_init);
	SUITE_ADD_TEST (suite, firmware_update_test_set_recovery_good_null);
	SUITE_ADD_TEST (suite, firmware_update_test_set_recovery_revision_null);
	SUITE_ADD_TEST (suite, firmware_update_test_set_image_offset_null);
	SUITE_ADD_TEST (suite, firmware_update_test_add_observer_null);
	SUITE_ADD_TEST (suite, firmware_update_test_remove_observer_null);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_header_last);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_header_last_small_page);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_no_notifications);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_callback_null);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_image_offset);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_finalize_image);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_finalize_image_with_offset);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_with_observer);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_observer_removed);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_extra_data_received);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_null);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_verify_incomplete_image);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_verify_fail_load);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_verify_invalid_image);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_verify_manifest_revoked);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_verify_error);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_verify_rollback_disallowed);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_verify_null_firmware_header);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_verify_img_size_error);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_blocked_by_observer);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_context_error);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_backup_fail_load);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_backup_img_size_error);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_backup_error);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_page_size_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_erase_failure);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_write_staging_error);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_write_staging_error_header_last);
	SUITE_ADD_TEST (suite,
		firmware_update_test_run_update_write_staging_error_header_last_small_page);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_write_staging_error_fail_recovery_erase);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_write_staging_error_fail_recovery);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_write_staging_error_image_offset);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_header_last_image_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_header_last_header_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_finalize_image_error);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_finalize_image_error_with_offset);
	SUITE_ADD_TEST (suite,
		firmware_update_test_run_update_finalize_image_error_fail_recovery_erase);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_finalize_image_error_fail_recovery);
	SUITE_ADD_TEST (suite,
		firmware_update_test_run_update_finalize_image_error_fail_recovery_finalize);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_cert_check_load_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_cert_check_manifest_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_cert_check_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_cert_revocation);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_cert_revocation_header_last);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_cert_revocation_header_last_small_page);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_cert_revocation_image_offset);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_cert_revocation_finalize_image);
	SUITE_ADD_TEST (suite,
		firmware_update_test_run_update_cert_revocation_finalize_image_with_offset);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_cert_backup_load_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_cert_backup_img_size_error);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_cert_backup_recovery_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_recovery_page_size_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_recovery_erase_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_recovery_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_recovery_fail_header_last);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_recovery_fail_header_last_small_page);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_recovery_fail_finalize);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_recovery_restore_erase_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_recovery_restore_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_recovery_restore_fail_finalize);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_cert_revocation_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_no_recovery_backup);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_no_recovery_backup_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_recovery_restore_no_recovery_backup);
	SUITE_ADD_TEST (suite,
		firmware_update_test_run_update_recovery_restore_no_recovery_backup_header_last);
	SUITE_ADD_TEST (suite,
		firmware_update_test_run_update_recovery_restore_no_recovery_backup_erase_fail);
	SUITE_ADD_TEST (suite,
		firmware_update_test_run_update_recovery_restore_no_recovery_backup_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_cert_revocation_no_recovery);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_different_flash_devices);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_different_flash_devices_finalize_image);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_no_backup);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_no_backup_write_staging_error);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_no_backup_finalize_image_error);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_no_backup_cert_revocation);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_no_backup_recovery_erase_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_no_backup_recovery_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_no_backup_recovery_finalize_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_recovery_bad);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_recovery_bad_finalize_image);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_recovery_bad_page_size_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_recovery_bad_erase_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_recovery_bad_update_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_recovery_bad_finalize_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_recovery_bad_no_recovery);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_recovery_bad_cert_revocation);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_after_recovery_page_size_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_after_recovery_erase_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_after_recovery_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_after_recovery_finalize_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_after_recovery_restore_erase_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_after_recovery_restore_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_after_recovery_restore_finalize_fail);
	SUITE_ADD_TEST (suite,
		firmware_update_test_run_update_no_recovery_backup_after_recovery_restore_erase_fail);
	SUITE_ADD_TEST (suite,
		firmware_update_test_run_update_no_recovery_backup_after_recovery_restore_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_after_recovery_backup_load_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_after_recovery_backup_img_size_error);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_after_recovery_backup_fail);
	SUITE_ADD_TEST (suite,
		firmware_update_test_run_update_no_recovery_backup_after_recovery_backup_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_no_backup_after_recovery_erase_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_no_backup_after_recovery_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_no_backup_after_recovery_finalize_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_after_recovery_bad);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_after_recovery_bad_page_size_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_after_recovery_bad_erase_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_after_recovery_bad_update_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_after_recovery_bad_finalize_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_new_recovery_revision_higher);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_new_recovery_revision_lower);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_same_revision_after_recovery_update);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_same_revision_after_cert_revocation);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_recovery_bad_different_revision);
	SUITE_ADD_TEST (suite, firmware_update_test_run_update_same_revision_after_recovery_bad);
	SUITE_ADD_TEST (suite, firmware_update_test_prepare_staging);
	SUITE_ADD_TEST (suite, firmware_update_test_prepare_staging_image_offset);
	SUITE_ADD_TEST (suite, firmware_update_test_prepare_staging_null_updater);
	SUITE_ADD_TEST (suite, firmware_update_test_prepare_staging_null_callback);
	SUITE_ADD_TEST (suite, firmware_update_test_prepare_staging_image_too_large);
	SUITE_ADD_TEST (suite, firmware_update_test_prepare_staging_image_too_large_image_offset);
	SUITE_ADD_TEST (suite, firmware_update_test_prepare_staging_erase_error);
	SUITE_ADD_TEST (suite, firmware_update_test_write_to_staging);
	SUITE_ADD_TEST (suite, firmware_update_test_write_to_staging_multiple_calls);
	SUITE_ADD_TEST (suite, firmware_update_test_write_to_staging_image_offset);
	SUITE_ADD_TEST (suite, firmware_update_test_write_to_staging_null_updater);
	SUITE_ADD_TEST (suite, firmware_update_test_write_to_staging_null_callback);
	SUITE_ADD_TEST (suite, firmware_update_test_write_to_staging_write_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_write_to_staging_image_too_large);
	SUITE_ADD_TEST (suite, firmware_update_test_write_to_staging_image_too_large_image_offset);
	SUITE_ADD_TEST (suite, firmware_update_test_write_to_staging_partial_write);
	SUITE_ADD_TEST (suite, firmware_update_test_multiple_prepare_and_write_cycles);
	SUITE_ADD_TEST (suite, firmware_update_test_multiple_prepare_and_write_cycles_image_offset);
	SUITE_ADD_TEST (suite, firmware_update_test_validate_recovery_image);
	SUITE_ADD_TEST (suite, firmware_update_test_validate_recovery_image_offset);
	SUITE_ADD_TEST (suite, firmware_update_test_validate_recovery_image_extra_verify);
	SUITE_ADD_TEST (suite, firmware_update_test_validate_recovery_image_extra_verify_offset);
	SUITE_ADD_TEST (suite, firmware_update_test_validate_recovery_image_no_recovery);
	SUITE_ADD_TEST (suite, firmware_update_test_validate_recovery_image_set_recovery_revision);
	SUITE_ADD_TEST (suite, firmware_update_test_validate_recovery_image_bad);
	SUITE_ADD_TEST (suite, firmware_update_test_validate_recovery_image_bad_extra_verify);
	SUITE_ADD_TEST (suite, firmware_update_test_validate_recovery_image_load_verify_bad_format);
	SUITE_ADD_TEST (suite, firmware_update_test_validate_recovery_image_load_verify_bad_checksum);
	SUITE_ADD_TEST (suite,
		firmware_update_test_validate_recovery_image_load_verify_manifest_format);
	SUITE_ADD_TEST (suite,
		firmware_update_test_validate_recovery_image_load_verify_fw_header_min_size);
	SUITE_ADD_TEST (suite,
		firmware_update_test_validate_recovery_image_load_verify_fw_header_too_long);
	SUITE_ADD_TEST (suite,
		firmware_update_test_validate_recovery_image_load_verify_fw_header_bad_marker);
	SUITE_ADD_TEST (suite,
		firmware_update_test_validate_recovery_image_load_verify_fw_header_bad_fmt_length);
	SUITE_ADD_TEST (suite, firmware_update_test_validate_recovery_image_offset_null);
	SUITE_ADD_TEST (suite, firmware_update_test_validate_recovery_image_load_failure);
	SUITE_ADD_TEST (suite, firmware_update_test_validate_recovery_image_verify_failure);
	SUITE_ADD_TEST (suite, firmware_update_test_validate_recovery_image_extra_verify_failure);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite, firmware_update_test_restore_recovery_image_no_recovery);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_recovery_image_recovery_good);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_recovery_image_with_offset);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_recovery_image_finalize_image);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_recovery_image_finalize_image_with_offset);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_recovery_image_followed_by_update);
	SUITE_ADD_TEST (suite,
		firmware_update_test_restore_recovery_image_followed_by_update_same_revision);
	SUITE_ADD_TEST (suite,
		firmware_update_test_restore_recovery_image_followed_by_update_different_revision);
	SUITE_ADD_TEST (suite,
		firmware_update_test_restore_recovery_image_followed_by_update_null_header);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_recovery_image_null);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_recovery_image_fail_load);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_recovery_image_invalid_image);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_recovery_image_img_size_error);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_recovery_image_page_size_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_recovery_image_erase_failure);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_recovery_image_write_active_error);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_recovery_image_finalize_image_error);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_active_image);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_active_image_header_last);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_active_image_header_last_small_page);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_active_image_no_recovery);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_active_image_with_offset);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_active_image_finalize_image);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_active_image_finalize_image_with_offset);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_active_image_null);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_active_image_fail_load);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_active_image_invalid_image);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_active_image_img_size_error);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_active_image_page_size_fail);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_active_image_erase_failure);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_active_image_write_active_error);
	SUITE_ADD_TEST (suite, firmware_update_test_restore_active_image_finalize_image_error);
	SUITE_ADD_TEST (suite, firmware_update_test_is_recovery_good);
	SUITE_ADD_TEST (suite, firmware_update_test_is_recovery_good_null);
