...
#define	ECC_TESTING_ENGINE_INIT                 \
		ECC_TESTING_ENGINE_INIT_FUNC(ECC_TESTING_ENGINE_NAME)
...
#define	ECC_TESTING_ENGINE_RELEASE                  \
		ECC_TESTING_ENGINE_RELEASE_FUNC(ECC_TESTING_ENGINE_NAME)
