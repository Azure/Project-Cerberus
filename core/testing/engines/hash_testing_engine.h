...
#define	HASH_TESTING_ENGINE_INIT                \
		HASH_TESTING_ENGINE_INIT_FUNC(HASH_TESTING_ENGINE_NAME)
...
#define	HASH_TESTING_ENGINE_RELEASE                 \
		HASH_TESTING_ENGINE_RELEASE_FUNC(HASH_TESTING_ENGINE_NAME)
