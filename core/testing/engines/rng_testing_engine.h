...
#define	RNG_TESTING_ENGINE_INIT                 \
		RNG_TESTING_ENGINE_INIT_FUNC(RNG_TESTING_ENGINE_NAME)
...
#define	RNG_TESTING_ENGINE_RELEASE                  \
		RNG_TESTING_ENGINE_RELEASE_FUNC(RNG_TESTING_ENGINE_NAME)
