...
static const char *SUITE = "recovery_image_section_header";
...
CuSuite* get_recovery_image_section_header_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, recovery_image_section_header_test_init_format0);
	SUITE_ADD_TEST (suite, recovery_image_section_header_test_init_unknown_format_max_length);
	SUITE_ADD_TEST (suite, recovery_image_section_header_test_init_null);
	SUITE_ADD_TEST (suite, recovery_image_section_header_test_init_bad_marker);
	SUITE_ADD_TEST (suite, recovery_image_section_header_test_init_read_base_error);
	SUITE_ADD_TEST (suite, recovery_image_section_header_test_init_read_data_error);
	SUITE_ADD_TEST (suite, recovery_image_section_header_test_init_less_than_min_length);
	SUITE_ADD_TEST (suite, recovery_image_section_header_test_init_format0_too_short);
	SUITE_ADD_TEST (suite, recovery_image_section_header_test_init_format0_too_long);
	SUITE_ADD_TEST (suite, recovery_image_section_header_test_init_unknown_format_too_short);
	SUITE_ADD_TEST (suite, recovery_image_section_header_test_init_unknown_format_too_long);
	SUITE_ADD_TEST (suite, recovery_image_section_header_test_release_null);
	SUITE_ADD_TEST (suite, recovery_image_section_header_test_get_section_image_length_format0);
	SUITE_ADD_TEST (suite,
		recovery_image_section_header_test_get_section_image_length_unknown_format);
	SUITE_ADD_TEST (suite, recovery_image_section_header_test_get_section_image_length_null);
	SUITE_ADD_TEST (suite, recovery_image_section_header_test_get_host_write_addr_format0);
	SUITE_ADD_TEST (suite, recovery_image_section_header_test_get_host_write_addr_unknown_format);
	SUITE_ADD_TEST (suite, recovery_image_section_header_test_get_host_write_addr_null);
	SUITE_ADD_TEST (suite, recovery_image_section_header_test_get_length);
	SUITE_ADD_TEST (suite, recovery_image_section_header_test_get_length_null);
