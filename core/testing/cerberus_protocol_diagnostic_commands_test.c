...
#include "cerberus_protocol_diagnostic_commands_testing.h"


static const char *SUITE = "cerberus_protocol_diagnostic_commands";
...
CuSuite* get_cerberus_protocol_diagnostic_commands_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, cerberus_protocol_diagnostic_commands_test_heap_stats_format);
