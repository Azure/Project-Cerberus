...
static bool host_flash_manager_dual_mock_has_two_flash_devices (
	const struct host_flash_manager *manager)
{
	...
	MOCK_RETURN_NO_ARGS (&mock->mock, host_flash_manager_dual_mock_has_two_flash_devices, manager);
}
...
static int host_flash_manager_dual_mock_swap_flash_devices (
...
static int host_flash_manager_dual_mock_host_has_flash_access (
	const struct host_flash_manager *manager, const struct host_control *control)
{
	struct host_flash_manager_dual_mock *mock = (struct host_flash_manager_dual_mock*) manager;
...
static int host_flash_manager_dual_mock_reset_flash (
	const struct host_flash_manager *manager)
{
	struct host_flash_manager_dual_mock *mock = (struct host_flash_manager_dual_mock*) manager;
	...
	MOCK_RETURN_NO_ARGS (&mock->mock, host_flash_manager_dual_mock_reset_flash, manager);
}
...
{
	if (func == host_flash_manager_dual_mock_has_two_flash_devices) {
		return "has_two_flash_devices";
	}
	else if (func == host_flash_manager_dual_mock_get_read_only_flash) {
	...
	else if (func == host_flash_manager_dual_mock_reset_flash) {
		return "reset_flash";
	}
	else {
		return "unknown";
...
int host_flash_manager_dual_mock_init (struct host_flash_manager_dual_mock *mock)
{
	...
	mock->base.base.has_two_flash_devices = host_flash_manager_dual_mock_has_two_flash_devices;
	...
	mock->base.base.reset_flash = host_flash_manager_dual_mock_reset_flash;
