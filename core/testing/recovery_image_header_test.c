...
static const char *SUITE = "recovery_image_header";
...
CuSuite* get_recovery_image_header_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, recovery_image_header_test_init_format0);
	SUITE_ADD_TEST (suite, recovery_image_header_test_init_unknown_format_max_length);
	SUITE_ADD_TEST (suite, recovery_image_header_test_init_null);
	SUITE_ADD_TEST (suite, recovery_image_header_test_init_bad_marker);
	SUITE_ADD_TEST (suite, recovery_image_header_test_init_read_base_error);
	SUITE_ADD_TEST (suite, recovery_image_header_test_init_read_data_error);
	SUITE_ADD_TEST (suite, recovery_image_header_test_init_less_than_min_length);
	SUITE_ADD_TEST (suite, recovery_image_header_test_init_format0_too_short);
	SUITE_ADD_TEST (suite, recovery_image_header_test_init_format0_too_long);
	SUITE_ADD_TEST (suite, recovery_image_header_test_init_unknown_format_too_short);
	SUITE_ADD_TEST (suite, recovery_image_header_test_init_unknown_format_too_long);
	SUITE_ADD_TEST (suite, recovery_image_header_test_init_format0_platform_id_length_too_short);
	SUITE_ADD_TEST (suite, recovery_image_header_test_init_format0_platform_id_length_too_long);
	SUITE_ADD_TEST (suite, recovery_image_header_test_init_format0_platform_id_no_null);
	SUITE_ADD_TEST (suite, recovery_image_header_test_init_format0_platform_id_null);
	SUITE_ADD_TEST (suite, recovery_image_header_test_init_format0_platform_id_too_short);
	SUITE_ADD_TEST (suite,
		recovery_image_header_test_init_format0_platform_id_length_less_than_min_length);
	SUITE_ADD_TEST (suite, recovery_image_header_test_init_format0_version_id_no_null);
	SUITE_ADD_TEST (suite, recovery_image_header_test_init_format0_version_id_null);
	SUITE_ADD_TEST (suite, recovery_image_header_test_init_format0_sig_longer_than_image);
	SUITE_ADD_TEST (suite, recovery_image_header_test_init_format0_sig_same_length_as_image);
	SUITE_ADD_TEST (suite, recovery_image_header_test_init_format0_sig_length_into_header);
	SUITE_ADD_TEST (suite, recovery_image_header_test_release_null);
	SUITE_ADD_TEST (suite, recovery_image_header_test_get_version_id_format0);
	SUITE_ADD_TEST (suite, recovery_image_header_test_get_version_id_unknown_format);
	SUITE_ADD_TEST (suite, recovery_image_header_test_get_version_id_null);
	SUITE_ADD_TEST (suite, recovery_image_header_test_get_platform_id_format0);
	SUITE_ADD_TEST (suite, recovery_image_header_test_get_platform_id_unknown_format);
	SUITE_ADD_TEST (suite, recovery_image_header_test_get_platform_id_null);
	SUITE_ADD_TEST (suite, recovery_image_header_test_get_image_length_format0);
	SUITE_ADD_TEST (suite, recovery_image_header_test_get_image_length_unknown_format);
	SUITE_ADD_TEST (suite, recovery_image_header_test_get_image_length_null);
	SUITE_ADD_TEST (suite, recovery_image_header_test_get_signature_length_format0);
	SUITE_ADD_TEST (suite, recovery_image_header_test_get_signature_length_unknown_format);
	SUITE_ADD_TEST (suite, recovery_image_header_test_get_signature_length_null);
	SUITE_ADD_TEST (suite, recovery_image_header_test_get_length);
	SUITE_ADD_TEST (suite, recovery_image_header_test_get_length_null);
