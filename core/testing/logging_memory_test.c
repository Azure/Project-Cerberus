...
static const char *SUITE = "logging_memory";
...
CuSuite* get_logging_memory_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, logging_memory_test_init);
	SUITE_ADD_TEST (suite, logging_memory_test_init_null);
	SUITE_ADD_TEST (suite, logging_memory_test_release_null);
	SUITE_ADD_TEST (suite, logging_memory_test_get_size_null);
	SUITE_ADD_TEST (suite, logging_memory_test_create_entry);
	SUITE_ADD_TEST (suite, logging_memory_test_create_entry_multiple);
	SUITE_ADD_TEST (suite, logging_memory_test_create_entry_full_log);
	SUITE_ADD_TEST (suite, logging_memory_test_create_entry_null);
	SUITE_ADD_TEST (suite, logging_memory_test_create_entry_bad_length);
	SUITE_ADD_TEST (suite, logging_memory_test_create_entry_log_wrap);
	SUITE_ADD_TEST (suite, logging_memory_test_create_entry_log_wrap_twice);
	SUITE_ADD_TEST (suite, logging_memory_test_flush);
	SUITE_ADD_TEST (suite, logging_memory_test_flush_null);
	SUITE_ADD_TEST (suite, logging_memory_test_read_contents_partial_read);
	SUITE_ADD_TEST (suite, logging_memory_test_read_contents_partial_read_with_wrap);
	SUITE_ADD_TEST (suite, logging_memory_test_read_contents_partial_read_across_wrap);
	SUITE_ADD_TEST (suite, logging_memory_test_read_contents_offset_read);
	SUITE_ADD_TEST (suite, logging_memory_test_read_contents_offset_read_with_wrap);
	SUITE_ADD_TEST (suite, logging_memory_test_read_contents_offset_across_wrap);
	SUITE_ADD_TEST (suite, logging_memory_test_read_contents_offset_past_end);
	SUITE_ADD_TEST (suite, logging_memory_test_read_contents_partial_read_with_offset);
	SUITE_ADD_TEST (suite, logging_memory_test_read_contents_partial_read_with_offset_across_wrap);
	SUITE_ADD_TEST (suite, logging_memory_test_clear);
	SUITE_ADD_TEST (suite, logging_memory_test_clear_log_wrap);
	SUITE_ADD_TEST (suite, logging_memory_test_clear_add_after_clear);
	SUITE_ADD_TEST (suite, logging_memory_test_clear_null);
