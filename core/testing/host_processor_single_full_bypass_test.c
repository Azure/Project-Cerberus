...
static const char *SUITE = "host_processor_single_full_bypass";
...
CuSuite* get_host_processor_single_full_bypass_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, host_processor_single_full_bypass_test_init);
	SUITE_ADD_TEST (suite, host_processor_single_full_bypass_test_init_null);
	SUITE_ADD_TEST (suite, host_processor_single_full_bypass_test_init_pulse_reset);
	SUITE_ADD_TEST (suite, host_processor_single_full_bypass_test_init_pulse_reset_null);
	SUITE_ADD_TEST (suite,
		host_processor_single_full_bypass_test_init_pulse_reset_invalid_pulse_width);
	SUITE_ADD_TEST (suite, host_processor_single_full_bypass_test_release_null);
	SUITE_ADD_TEST (suite, host_processor_single_full_bypass_test_power_on_reset_no_pfm);
	SUITE_ADD_TEST (suite, host_processor_single_full_bypass_test_power_on_reset_no_pfm_cs1);
	SUITE_ADD_TEST (suite,
		host_processor_single_full_bypass_test_power_on_reset_no_pfm_no_observer);
	SUITE_ADD_TEST (suite, host_processor_single_full_bypass_test_power_on_reset_no_pfm_bypass);
	SUITE_ADD_TEST (suite, host_processor_single_full_bypass_test_power_on_reset_no_pfm_checked);
	SUITE_ADD_TEST (suite,
		host_processor_single_full_bypass_test_power_on_reset_no_pfm_checked_bypass);
	SUITE_ADD_TEST (suite, host_processor_single_full_bypass_test_power_on_reset_no_pfm_dirty);
	SUITE_ADD_TEST (suite,
		host_processor_single_full_bypass_test_power_on_reset_no_pfm_dirty_bypass);
	SUITE_ADD_TEST (suite,
		host_processor_single_full_bypass_test_power_on_reset_no_pfm_dirty_checked);
	SUITE_ADD_TEST (suite,
		host_processor_single_full_bypass_test_power_on_reset_no_pfm_dirty_checked_bypass);
	SUITE_ADD_TEST (suite,
		host_processor_single_full_bypass_test_power_on_reset_no_pfm_pulse_reset);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite,
		host_processor_single_full_bypass_test_power_on_reset_no_pfm_filter_error);
	SUITE_ADD_TEST (suite,
		host_processor_single_full_bypass_test_power_on_reset_pending_pfm_no_active_dirty_bypass_enable_error);
	SUITE_ADD_TEST (suite,
		host_processor_single_full_bypass_test_soft_reset_rot_access_error_pulse_reset);
	SUITE_ADD_TEST (suite, host_processor_single_full_bypass_test_soft_reset_no_pfm);
	SUITE_ADD_TEST (suite, host_processor_single_full_bypass_test_soft_reset_no_pfm_filter_error);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite, host_processor_single_full_bypass_test_run_time_verification_no_pfm);
	SUITE_ADD_TEST (suite,
		host_processor_single_full_bypass_test_run_time_verification_no_pfm_filter_error);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite, host_processor_single_full_bypass_test_bypass_mode_ro_flash);
	SUITE_ADD_TEST (suite, host_processor_single_full_bypass_test_bypass_mode_ro_flash_cs1);
	SUITE_ADD_TEST (suite, host_processor_single_full_bypass_test_bypass_mode_rw_flash);
	SUITE_ADD_TEST (suite, host_processor_single_full_bypass_test_bypass_mode_rw_flash_cs0);
	SUITE_ADD_TEST (suite, host_processor_single_full_bypass_test_bypass_mode_enable_error);
