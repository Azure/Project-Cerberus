...
static const char *SUITE = "x509_thread_safe";
...
CuSuite* get_x509_thread_safe_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, x509_thread_safe_test_init);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_init_null);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_release_null);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_create_csr);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_create_csr_error);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_create_csr_null);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_create_self_signed_certificate);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_create_self_signed_certificate_error);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_create_self_signed_certificate_null);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_create_ca_signed_certificate);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_create_ca_signed_certificate_error);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_create_ca_signed_certificate_null);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_load_certificate);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_load_certificate_error);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_load_certificate_null);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_release_certificate);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_release_certificate_null);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_get_certificate_der);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_get_certificate_der_error);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_get_certificate_der_null);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_get_certificate_version);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_get_certificate_version_error);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_get_certificate_version_null);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_get_serial_number);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_get_serial_number_error);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_get_serial_number_null);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_get_public_key_type);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_get_public_key_type_error);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_get_public_key_type_null);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_get_public_key_length);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_get_public_key_length_error);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_get_public_key_length_null);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_get_public_key);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_get_public_key_error);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_get_public_key_null);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_init_ca_cert_store);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_init_ca_cert_store_error);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_init_ca_cert_store_null);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_release_ca_cert_store);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_release_ca_cert_store_null);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_add_root_ca);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_add_root_ca_error);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_add_root_ca_null);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_add_intermediate_ca);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_add_intermediate_ca_error);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_add_intermediate_ca_null);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_authenticate);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_authenticate_error);
	SUITE_ADD_TEST (suite, x509_thread_safe_test_authenticate_null);
