...
CuSuite* get_pcd_manager_suite ()
{
	...
	SUITE_ADD_TEST (suite, pcd_manager_test_on_pcd_verified_no_pending_pcd);
	...
	SUITE_ADD_TEST (suite, pcd_manager_test_on_clear_active_no_observers);
	SUITE_ADD_TEST (suite, pcd_manager_test_on_clear_active_one_observer);
	SUITE_ADD_TEST (suite, pcd_manager_test_on_clear_active_no_event_handler);
	SUITE_ADD_TEST (suite, pcd_manager_test_on_clear_active_null);
	...
	SUITE_ADD_TEST (suite, pcd_manager_test_get_id_measured_data_0_bytes_read);
	...
	SUITE_ADD_TEST (suite, pcd_manager_test_get_platform_id_measured_data_0_bytes_read);
	...
	SUITE_ADD_TEST (suite, pcd_manager_test_get_pcd_measured_data_sha384);
	SUITE_ADD_TEST (suite, pcd_manager_test_get_pcd_measured_data_sha512);
	...
	SUITE_ADD_TEST (suite, pcd_manager_test_get_pcd_measured_data_0_bytes_read);
