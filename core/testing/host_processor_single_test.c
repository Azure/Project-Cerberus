 ...
 */
static void host_processor_single_testing_init_dependencies (CuTest *test,
	...
	struct host_processor_single_testing *host)
{
	...
	status = host_processor_single_init (&host->test, &host->control.base, &host->flash_mgr.base,
	...
	struct host_processor_single_testing *host)
{
	...
	status = host_processor_single_init_pulse_reset (&host->test, &host->control.base,
...
CuSuite* get_host_processor_single_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, host_processor_single_test_init);
	SUITE_ADD_TEST (suite, host_processor_single_test_init_null);
	SUITE_ADD_TEST (suite, host_processor_single_test_init_pulse_reset);
	SUITE_ADD_TEST (suite, host_processor_single_test_init_pulse_reset_null);
	SUITE_ADD_TEST (suite, host_processor_single_test_init_pulse_reset_invalid_pulse_width);
	SUITE_ADD_TEST (suite, host_processor_single_test_release_null);
	SUITE_ADD_TEST (suite, host_processor_single_test_needs_config_recovery);
	SUITE_ADD_TEST (suite, host_processor_single_test_needs_config_recovery_no_host_access);
	SUITE_ADD_TEST (suite, host_processor_single_test_needs_config_recovery_null);
	SUITE_ADD_TEST (suite, host_processor_single_test_needs_config_recovery_check_access_error);
	SUITE_ADD_TEST (suite, host_processor_single_test_get_next_reset_verification_actions_no_pfm);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_get_next_reset_verification_actions_no_pfm_bypass);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_get_next_reset_verification_actions_no_pfm_checked);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_get_next_reset_verification_actions_no_pfm_checked_bypass);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_get_next_reset_verification_actions_no_pfm_dirty);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_get_next_reset_verification_actions_no_pfm_dirty_bypass);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_get_next_reset_verification_actions_no_pfm_dirty_checked);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_get_next_reset_verification_actions_no_pfm_dirty_checked_bypass);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_get_next_reset_verification_actions_active_pfm_not_dirty);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite,
		host_processor_single_test_get_next_reset_verification_actions_active_pfm_dirty);
	SUITE_ADD_TEST (suite,
		host_processor_single_test_get_next_reset_verification_actions_active_pfm_dirty_bypass);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite,
		host_processor_single_test_get_next_reset_verification_actions_active_pfm_dirty_checked);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite, host_processor_single_test_get_next_reset_verification_actions_null);
