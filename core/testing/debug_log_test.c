...
static const char *SUITE = "debug_log";
...
CuSuite* get_debug_log_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, debug_log_test_create_entry);
	SUITE_ADD_TEST (suite, debug_log_test_create_entry_no_log);
	SUITE_ADD_TEST (suite, debug_log_test_create_entry_invalid_severity);
	SUITE_ADD_TEST (suite, debug_log_test_flush);
	SUITE_ADD_TEST (suite, debug_log_test_flush_no_log);
	SUITE_ADD_TEST (suite, debug_log_test_clear);
	SUITE_ADD_TEST (suite, debug_log_test_clear_no_log);
	SUITE_ADD_TEST (suite, debug_log_test_get_size);
	SUITE_ADD_TEST (suite, debug_log_test_get_size_no_log);
	SUITE_ADD_TEST (suite, debug_log_test_read_contents);
	SUITE_ADD_TEST (suite, debug_log_test_read_contents_no_log);

	/* Tear down after the tests in this suite have run. */
	SUITE_ADD_TEST (suite, debug_log_testing_suite_tear_down);
	return suite;
}
