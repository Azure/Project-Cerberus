...
CuSuite* get_host_processor_dual_bypass_mode_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, host_processor_dual_test_bypass_mode_ro_flash);
	SUITE_ADD_TEST (suite, host_processor_dual_test_bypass_mode_ro_flash_cs1);
	SUITE_ADD_TEST (suite, host_processor_dual_test_bypass_mode_rw_flash);
	SUITE_ADD_TEST (suite, host_processor_dual_test_bypass_mode_rw_flash_cs0);
	SUITE_ADD_TEST (suite, host_processor_dual_test_bypass_mode_no_observer);
	SUITE_ADD_TEST (suite, host_processor_dual_test_bypass_mode_unsupported_flash);
	SUITE_ADD_TEST (suite, host_processor_dual_test_bypass_mode_null);
	SUITE_ADD_TEST (suite, host_processor_dual_test_bypass_mode_filter_error);
	SUITE_ADD_TEST (suite, host_processor_dual_test_bypass_mode_host_access_error);
