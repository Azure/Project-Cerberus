...
static const char *SUITE = "manifest_verification";
...
CuSuite* get_manifest_verification_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, manifest_verification_test_init_no_key_stored);
	SUITE_ADD_TEST (suite, manifest_verification_test_init_key_stored);
	SUITE_ADD_TEST (suite, manifest_verification_test_init_bad_key_stored);
	SUITE_ADD_TEST (suite, manifest_verification_test_init_bad_length_stored);
	SUITE_ADD_TEST (suite, manifest_verification_test_init_bad_signature_stored);
	SUITE_ADD_TEST (suite, manifest_verification_test_init_null);
	SUITE_ADD_TEST (suite, manifest_verification_test_init_manifest_key_bad_signature);
	SUITE_ADD_TEST (suite, manifest_verification_test_init_manifest_key_hash_error);
	SUITE_ADD_TEST (suite, manifest_verification_test_init_manifest_key_signature_error);
	SUITE_ADD_TEST (suite, manifest_verification_test_init_load_error);
	SUITE_ADD_TEST (suite, manifest_verification_test_init_stored_key_hash_error);
	SUITE_ADD_TEST (suite, manifest_verification_test_init_stored_key_signature_error);
	SUITE_ADD_TEST (suite, manifest_verification_test_init_save_error);
	SUITE_ADD_TEST (suite, manifest_verification_test_release_null);
	SUITE_ADD_TEST (suite, manifest_verification_test_get_observers);
	SUITE_ADD_TEST (suite, manifest_verification_test_get_pfm_observer_null);
	SUITE_ADD_TEST (suite, manifest_verification_test_get_cfm_observer_null);
	SUITE_ADD_TEST (suite, manifest_verification_test_get_pcd_observer_null);
	SUITE_ADD_TEST (suite, manifest_verification_test_verify_signature_no_key_stored);
	SUITE_ADD_TEST (suite, manifest_verification_test_verify_signature_no_key_stored_bad_hash);
	SUITE_ADD_TEST (suite, manifest_verification_test_verify_signature_no_key_stored_bad_signature);
	SUITE_ADD_TEST (suite, manifest_verification_test_verify_signature_key_stored);
	SUITE_ADD_TEST (suite, manifest_verification_test_verify_signature_key_stored_match_default);
	SUITE_ADD_TEST (suite, manifest_verification_test_verify_signature_key_stored_higher_id);
	SUITE_ADD_TEST (suite, manifest_verification_test_verify_signature_key_stored_same_id);
	SUITE_ADD_TEST (suite, manifest_verification_test_verify_signature_key_stored_bad_hash);
	SUITE_ADD_TEST (suite, manifest_verification_test_verify_signature_key_stored_bad_signature);
	SUITE_ADD_TEST (suite,
		manifest_verification_test_verify_signature_key_stored_higher_id_bad_signature);
	SUITE_ADD_TEST (suite,
		manifest_verification_test_verify_signature_key_stored_same_id_bad_signature);
	SUITE_ADD_TEST (suite, manifest_verification_test_verify_signature_null);
	SUITE_ADD_TEST (suite,
		manifest_verification_test_verify_signature_no_key_stored_signature_error);
	SUITE_ADD_TEST (suite, manifest_verification_test_verify_signature_key_stored_signature_error);
	SUITE_ADD_TEST (suite, manifest_verification_test_on_pfm_activated_no_key_stored);
	SUITE_ADD_TEST (suite, manifest_verification_test_on_pfm_activated_key_stored);
	SUITE_ADD_TEST (suite, manifest_verification_test_on_pfm_activated_key_stored_sha384);
	SUITE_ADD_TEST (suite, manifest_verification_test_on_pfm_activated_key_stored_sha512);
	SUITE_ADD_TEST (suite, manifest_verification_test_on_pfm_activated_key_stored_match_default);
	SUITE_ADD_TEST (suite, manifest_verification_test_on_pfm_activated_key_stored_higher_id);
	SUITE_ADD_TEST (suite, manifest_verification_test_on_pfm_activated_key_stored_same_id);
	SUITE_ADD_TEST (suite, manifest_verification_test_on_pfm_activated_key_stored_hash_error);
	SUITE_ADD_TEST (suite, manifest_verification_test_on_pfm_activated_key_stored_signature_error);
	SUITE_ADD_TEST (suite, manifest_verification_test_on_pfm_activated_key_stored_rsa_error);
	SUITE_ADD_TEST (suite, manifest_verification_test_on_pfm_activated_key_stored_save_error);
	SUITE_ADD_TEST (suite, manifest_verification_test_on_cfm_activated_no_key_stored);
	SUITE_ADD_TEST (suite, manifest_verification_test_on_cfm_activated_key_stored);
	SUITE_ADD_TEST (suite, manifest_verification_test_on_cfm_activated_key_stored_match_default);
	SUITE_ADD_TEST (suite, manifest_verification_test_on_pcd_activated_no_key_stored);
	SUITE_ADD_TEST (suite, manifest_verification_test_on_pcd_activated_key_stored);
	SUITE_ADD_TEST (suite, manifest_verification_test_on_pcd_activated_key_stored_match_default);
	SUITE_ADD_TEST (suite, manifest_verification_test_on_update_start_no_key_stored);
	SUITE_ADD_TEST (suite, manifest_verification_test_on_update_start_key_stored);
	SUITE_ADD_TEST (suite, manifest_verification_test_after_default_activated_verify_signature);
	SUITE_ADD_TEST (suite, manifest_verification_test_after_default_activated_on_pfm_activated);
	SUITE_ADD_TEST (suite, manifest_verification_test_after_default_activated_on_update_start);
	SUITE_ADD_TEST (suite,
		manifest_verification_test_after_default_activated_hash_error_verify_signature);
	SUITE_ADD_TEST (suite,
		manifest_verification_test_after_default_activated_hash_error_on_update_start);
	SUITE_ADD_TEST (suite,
		manifest_verification_test_after_default_activated_signature_error_verify_signature);
	SUITE_ADD_TEST (suite,
		manifest_verification_test_after_default_activated_signature_error_on_update_start);
	SUITE_ADD_TEST (suite,
		manifest_verification_test_after_default_activated_rsa_error_verify_signature);
	SUITE_ADD_TEST (suite,
		manifest_verification_test_after_default_activated_rsa_error_on_update_start);
	SUITE_ADD_TEST (suite,
		manifest_verification_test_after_default_activated_save_error_verify_signature);
	SUITE_ADD_TEST (suite,
		manifest_verification_test_after_default_activated_save_error_on_pfm_activated);
	SUITE_ADD_TEST (suite,
		manifest_verification_test_after_default_activated_save_error_twice_on_pfm_activated);
	SUITE_ADD_TEST (suite,
		manifest_verification_test_after_default_activated_save_error_on_update_start);
	SUITE_ADD_TEST (suite,
		manifest_verification_test_after_default_activated_save_error_on_update_start_save_error);
	SUITE_ADD_TEST (suite,
		manifest_verification_test_after_default_activated_save_error_on_update_start_already_error);
	SUITE_ADD_TEST (suite, manifest_verification_test_after_default_activated_match_stored);
