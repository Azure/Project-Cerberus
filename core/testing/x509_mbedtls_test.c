...
static void x509_mbedtls_test_create_csr_ca_tcbinfo_extension_ueid_null (CuTest *test)
{
	struct x509_engine_mbedtls engine;
	int status;
	struct x509_dice_tcbinfo tcb;
...
static void x509_mbedtls_test_create_csr_end_entity_tcbinfo_extension_ueid_null (CuTest *test)
{
	struct x509_engine_mbedtls engine;
	int status;
	struct x509_dice_tcbinfo tcb;
...
static void x509_mbedtls_test_create_csr_ca_tcbinfo_unknown_hash (CuTest *test)
{
	struct x509_engine_mbedtls engine;
	int status;
	struct x509_dice_tcbinfo tcb;
...
static void x509_mbedtls_test_create_csr_ca_tcbinfo_fwid_null (CuTest *test)
{
	struct x509_engine_mbedtls engine;
	int status;
	struct x509_dice_tcbinfo tcb;
...
static void x509_mbedtls_test_create_csr_ca_tcbinfo_version_null (CuTest *test)
{
	struct x509_engine_mbedtls engine;
	int status;
	struct x509_dice_tcbinfo tcb;
...
static void x509_mbedtls_test_create_csr_ueid_null (CuTest *test)
{
	struct x509_engine_mbedtls engine;
	int status;
	struct x509_dice_tcbinfo tcb;
...
static void x509_mbedtls_test_create_csr_ueid_zero_length (CuTest *test)
{
	struct x509_engine_mbedtls engine;
	int status;
	struct x509_dice_tcbinfo tcb;
...
static void x509_mbedtls_test_create_self_signed_certificate_ecc_ca_tcbinfo_extension_ueid_null (
	CuTest *test)
{
	struct x509_engine_mbedtls engine;
	struct x509_certificate cert;
...
static void x509_mbedtls_test_create_self_signed_certificate_ecc_end_entity_tcbinfo_extension_ueid_null (
	CuTest *test)
{
	struct x509_engine_mbedtls engine;
	struct x509_certificate cert;
...
static void x509_mbedtls_test_create_self_signed_certificate_tcbinfo_unknown_hash (
	CuTest *test)
{
	struct x509_engine_mbedtls engine;
	struct x509_certificate cert;
...
static void x509_mbedtls_test_create_self_signed_certificate_tcbinfo_fwid_null (CuTest *test)
{
	struct x509_engine_mbedtls engine;
	struct x509_certificate cert;
	int status;
...
static void x509_mbedtls_test_create_self_signed_certificate_tcbinfo_version_null (CuTest *test)
{
	struct x509_engine_mbedtls engine;
	struct x509_certificate cert;
	int status;
...
static void x509_mbedtls_test_create_self_signed_certificate_ueid_null (CuTest *test)
{
	struct x509_engine_mbedtls engine;
	struct x509_certificate cert;
	int status;
...
static void x509_mbedtls_test_create_self_signed_certificate_ueid_zero_length (CuTest *test)
{
	struct x509_engine_mbedtls engine;
	struct x509_certificate cert;
	int status;
...
static void x509_mbedtls_test_create_ca_signed_certificate_ca_tcbinfo_extension_ueid_null (
	CuTest *test)
{
	struct x509_engine_mbedtls engine;
	struct x509_certificate ca_cert;
...
static void x509_mbedtls_test_create_ca_signed_certificate_end_entity_tcbinfo_extension_ueid_null (
	CuTest *test)
{
	struct x509_engine_mbedtls engine;
	struct x509_certificate ca_cert;
...
static void x509_mbedtls_test_create_ca_signed_certificate_tcbinfo_extension_unknown_hash (
	CuTest *test)
{
	struct x509_engine_mbedtls engine;
	struct x509_certificate ca_cert;
...
static void x509_mbedtls_test_create_ca_signed_certificate_tcbinfo_extension_fwid_null (
	CuTest *test)
{
	struct x509_engine_mbedtls engine;
	struct x509_certificate ca_cert;
...
static void x509_mbedtls_test_create_ca_signed_certificate_tcbinfo_extension_version_null (
	CuTest *test)
{
	struct x509_engine_mbedtls engine;
	struct x509_certificate ca_cert;
...
static void x509_mbedtls_test_create_ca_signed_certificate_ueid_extension_ueid_null (CuTest *test)
{
	struct x509_engine_mbedtls engine;
	struct x509_certificate ca_cert;
	struct x509_certificate cert;
...
static void x509_mbedtls_test_create_ca_signed_certificate_ueid_extension_ueid_zero_length (
	CuTest *test)
{
	struct x509_engine_mbedtls engine;
	struct x509_certificate ca_cert;
...
CuSuite* get_x509_mbedtls_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, x509_mbedtls_test_init);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_init_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_release_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_csr_ecc_ca);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_csr_ecc_end_entity);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_csr_rsa_ca);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_csr_rsa_end_entity);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_csr_ca_non_zero_path_length_constraint);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_csr_ca_no_path_length_constraint);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_csr_ca_with_eku_oid);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_csr_end_entity_with_eku_oid);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_csr_ca_tcbinfo_and_ueid_extension);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_csr_end_entity_tcbinfo_and_ueid_extension);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_csr_ca_tcbinfo_and_ueid_extension_sha1);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_csr_ca_tcbinfo_and_ueid_extension_svn_zero);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_csr_ca_tcbinfo_extension_ueid_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_csr_end_entity_tcbinfo_extension_ueid_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_csr_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_csr_with_public_key);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_csr_ca_tcbinfo_unknown_hash);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_csr_ca_tcbinfo_fwid_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_csr_ca_tcbinfo_version_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_csr_ueid_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_csr_ueid_zero_length);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_self_signed_certificate_ecc_ca);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_self_signed_certificate_ecc_end_entity);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_self_signed_certificate_rsa_ca);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_self_signed_certificate_rsa_end_entity);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_self_signed_certificate_ca_non_zero_path_length_constraint);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_self_signed_certificate_ca_no_path_length_constraint);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_self_signed_certificate_ecc_ca_tcbinfo_and_ueid_extension);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_self_signed_certificate_ecc_end_entity_tcbinfo_and_ueid_extension);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_self_signed_certificate_ecc_ca_tcbinfo_and_ueid_extension_sha1);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_self_signed_certificate_ecc_ca_tcbinfo_and_ueid_extension_svn_zero);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_self_signed_certificate_ecc_ca_tcbinfo_extension_ueid_null);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_self_signed_certificate_ecc_end_entity_tcbinfo_extension_ueid_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_self_signed_certificate_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_self_signed_certificate_with_public_key);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_self_signed_certificate_tcbinfo_unknown_hash);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_self_signed_certificate_tcbinfo_fwid_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_self_signed_certificate_tcbinfo_version_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_self_signed_certificate_ueid_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_self_signed_certificate_ueid_zero_length);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_self_signed_certificate_serial_zero);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_load_certificate);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_load_certificate_riot);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_load_certificate_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_load_certificate_bad);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_ca_signed_certificate_ecc_ca_private_key);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_ca_signed_certificate_intermediate_ca_ecc_ca_private_key);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_ca_signed_certificate_ecc_end_entity_private_key);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_ca_signed_certificate_rsa_ca_private_key);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_ca_signed_certificate_rsa_end_entity_private_key);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_ca_signed_certificate_ecc_ca_public_key);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_ca_signed_certificate_ecc_end_entity_public_key);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_ca_signed_certificate_rsa_ca_public_key);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_ca_signed_certificate_rsa_end_entity_public_key);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_ca_signed_certificate_ecc_ca2_public_key);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_ca_signed_certificate_end_entity_ecc_ca2_public_key);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_ca_signed_certificate_ca_non_zero_path_length_constraint);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_ca_signed_certificate_ca_no_path_length_constraint);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_ca_signed_certificate_ca_tcbinfo_and_ueid_extension);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_ca_signed_certificate_end_entity_tcbinfo_and_ueid_extension);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_ca_signed_certificate_ca_tcbinfo_and_ueid_extension_sha1);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_ca_signed_certificate_ca_tcbinfo_and_ueid_extension_svn_zero);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_ca_signed_certificate_ca_tcbinfo_extension_ueid_null);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_ca_signed_certificate_end_entity_tcbinfo_extension_ueid_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_ca_signed_certificate_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_ca_signed_certificate_ca_public_key);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_ca_signed_certificate_tcbinfo_extension_unknown_hash);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_ca_signed_certificate_tcbinfo_extension_fwid_null);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_ca_signed_certificate_tcbinfo_extension_version_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_ca_signed_certificate_ueid_extension_ueid_null);
	SUITE_ADD_TEST (suite,
		x509_mbedtls_test_create_ca_signed_certificate_ueid_extension_ueid_zero_length);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_create_ca_signed_certificate_serial_zero);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_release_certificate_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_get_certificate_der_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_get_certificate_version);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_get_certificate_version_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_get_serial_number);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_get_serial_number_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_get_serial_number_small_buffer);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_get_public_key_type_ecc);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_get_public_key_type_rsa);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_get_public_key_type_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_get_public_key_length_ecc);
#if (ECC_MAX_KEY_LENGTH >= 384)
	SUITE_ADD_TEST (suite, x509_mbedtls_test_get_public_key_length_ecc384);
#endif
#if (ECC_MAX_KEY_LENGTH >= 521)
	SUITE_ADD_TEST (suite, x509_mbedtls_test_get_public_key_length_ecc521);
#endif
	SUITE_ADD_TEST (suite, x509_mbedtls_test_get_public_key_length_rsa);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_get_public_key_length_rsa4k);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_get_public_key_length_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_get_public_key_ecc);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_get_public_key_rsa);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_get_public_key_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_init_ca_cert_store);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_init_ca_cert_store_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_release_ca_cert_store_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_add_root_ca_ecc);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_add_root_ca_ecc_bad_signature);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_add_root_ca_rsa);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_add_root_ca_rsa_bad_signature);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_add_root_ca_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_add_root_ca_ecc_corrupt_signature);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_add_root_ca_rsa_corrupt_signature);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_add_root_ca_bad_cert);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_add_root_ca_not_self_signed);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_add_root_ca_end_entity);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_add_intermediate_ca_ecc);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_add_intermediate_ca_ecc_bad_signature);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_add_intermediate_ca_ecc_corrupt_signature);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_add_intermediate_ca_rsa);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_add_intermediate_ca_rsa_bad_signature);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_add_intermediate_ca_rsa_corrupt_signature);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_add_intermediate_ca_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_add_intermediate_ca_ecc_bad_cert);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_add_intermediate_ca_self_signed);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_add_intermediate_ca_end_entity);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_authenticate_ecc_end_entity_no_intermediate_certs);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_authenticate_ecc_ca_no_intermediate_certs);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_authenticate_rsa_end_entity_no_intermediate_certs);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_authenticate_rsa_ca_no_intermediate_certs);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_authenticate_end_entity_one_intermediate_cert);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_authenticate_ca_one_intermediate_cert);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_authenticate_end_entity_root_pathlen_constraint);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_authenticate_ca_root_pathlen_constraint);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_authenticate_end_entity_multiple_intermediate_certs);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_authenticate_ca_multiple_intermediate_certs);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_authenticate_ecc_riot_alias);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_authenticate_null);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_authenticate_no_path_to_root);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_authenticate_partial_path_to_root);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_authenticate_violate_path_length_constraint);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_authenticate_intermediate_bad_signature);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_authenticate_intermediate_corrupt_signature);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_authenticate_bad_signature);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_authenticate_corrupt_signature);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_authenticate_no_root_ca);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_authenticate_empty_ca_store);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_authenticate_self_signed);
	SUITE_ADD_TEST (suite, x509_mbedtls_test_authenticate_different_ca_stores);
