...
CuSuite* get_recovery_image_observer_pcr_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, recovery_image_observer_pcr_test_init);
	SUITE_ADD_TEST (suite, recovery_image_observer_pcr_test_init_null);
	SUITE_ADD_TEST (suite, recovery_image_observer_pcr_test_init_bad_measurement_type);
	SUITE_ADD_TEST (suite, recovery_image_observer_pcr_test_release_null);
	SUITE_ADD_TEST (suite, recovery_image_observer_pcr_test_on_recovery_image_activated);
	SUITE_ADD_TEST (suite, recovery_image_observer_pcr_test_on_recovery_image_activated_hash_error);
	SUITE_ADD_TEST (suite, recovery_image_observer_pcr_test_record_measurement);
	SUITE_ADD_TEST (suite, recovery_image_observer_pcr_test_record_measurement_no_active);
	SUITE_ADD_TEST (suite, recovery_image_observer_pcr_test_record_measurement_null);
	SUITE_ADD_TEST (suite, recovery_image_observer_pcr_test_record_measurement_hash_error);
	SUITE_ADD_TEST (suite, recovery_image_observer_pcr_test_on_recovery_image_deactivated);
