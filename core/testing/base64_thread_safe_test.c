...
static const char *SUITE = "base64_thread_safe";
...
CuSuite* get_base64_thread_safe_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, base64_thread_safe_test_init);
	SUITE_ADD_TEST (suite, base64_thread_safe_test_init_null);
	SUITE_ADD_TEST (suite, base64_thread_safe_test_release_null);
	SUITE_ADD_TEST (suite, base64_thread_safe_test_encode);
	SUITE_ADD_TEST (suite, base64_thread_safe_test_encode_error);
	SUITE_ADD_TEST (suite, base64_thread_safe_test_encode_null);
