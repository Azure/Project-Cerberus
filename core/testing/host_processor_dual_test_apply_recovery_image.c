...
CuSuite* get_host_processor_dual_apply_recovery_image_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, host_processor_dual_test_apply_recovery_image);
	SUITE_ADD_TEST (suite, host_processor_dual_test_apply_recovery_image_pulse_reset);
	SUITE_ADD_TEST (suite, host_processor_dual_test_apply_recovery_image_no_observer);
	SUITE_ADD_TEST (suite, host_processor_dual_test_apply_recovery_image_bypass);
	SUITE_ADD_TEST (suite, host_processor_dual_test_apply_recovery_image_no_reset);
	SUITE_ADD_TEST (suite, host_processor_dual_test_apply_recovery_image_no_reset_pulse_reset);
	SUITE_ADD_TEST (suite, host_processor_dual_test_apply_recovery_image_no_valid_image);
	SUITE_ADD_TEST (suite,
		host_processor_dual_test_apply_recovery_image_no_valid_image_pulse_reset);
	SUITE_ADD_TEST (suite, host_processor_dual_test_apply_recovery_image_no_recovery_manager);
	SUITE_ADD_TEST (suite,
		host_processor_dual_test_apply_recovery_image_no_recovery_manager_pulse_reset);
	SUITE_ADD_TEST (suite, host_processor_dual_test_apply_recovery_image_unsupported_flash);
	SUITE_ADD_TEST (suite, host_processor_dual_test_apply_recovery_image_bypass_unsupported_flash);
	SUITE_ADD_TEST (suite, host_processor_dual_test_apply_recovery_image_null);
	SUITE_ADD_TEST (suite,
		host_processor_dual_test_apply_recovery_image_set_flash_for_rot_access_error);
	SUITE_ADD_TEST (suite,
		host_processor_dual_test_apply_recovery_image_set_flash_for_rot_access_error_pulse_reset);
	SUITE_ADD_TEST (suite,
		host_processor_dual_test_apply_recovery_image_set_flash_for_rot_access_error_host_access_error);
	SUITE_ADD_TEST (suite, host_processor_dual_test_apply_recovery_image_chip_erase_error);
	SUITE_ADD_TEST (suite,
		host_processor_dual_test_apply_recovery_image_chip_erase_error_pulse_reset);
	SUITE_ADD_TEST (suite, host_processor_dual_test_apply_recovery_image_bad_image);
	SUITE_ADD_TEST (suite, host_processor_dual_test_apply_recovery_image_bad_image_pulse_reset);
	SUITE_ADD_TEST (suite, host_processor_dual_test_apply_recovery_image_clear_rw_region_error);
	SUITE_ADD_TEST (suite,
		host_processor_dual_test_apply_recovery_image_clear_rw_region_error_pulse_reset);
	SUITE_ADD_TEST (suite, host_processor_dual_test_apply_recovery_image_spi_filter_config_error);
	SUITE_ADD_TEST (suite,
		host_processor_dual_test_apply_recovery_image_spi_filter_config_error_pulse_reset);
	SUITE_ADD_TEST (suite,
		host_processor_dual_test_apply_recovery_image_set_flash_for_host_access_error);
	SUITE_ADD_TEST (suite,
