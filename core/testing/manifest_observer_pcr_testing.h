...
#ifndef MANIFEST_OBSERVER_PCR_TESTING_H_
#define MANIFEST_OBSERVER_PCR_TESTING_H_


extern const uint8_t MANIFEST_ID_HASH[];
extern const uint32_t MANIFEST_ID_HASH_LEN;

extern const uint8_t NO_MANIFEST_ID_HASH[];
