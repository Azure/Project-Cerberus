...
CuSuite* get_host_state_manager_suite ()
{
	...
	SUITE_ADD_TEST (suite, host_state_manager_test_init);
	SUITE_ADD_TEST (suite, host_state_manager_test_init_null);
	SUITE_ADD_TEST (suite, host_state_manager_test_init_not_sector_aligned);
	SUITE_ADD_TEST (suite, host_state_manager_test_get_read_only_flash_cs0);
	SUITE_ADD_TEST (suite, host_state_manager_test_get_read_only_flash_cs1);
	SUITE_ADD_TEST (suite, host_state_manager_test_get_read_only_flash_no_state);
	SUITE_ADD_TEST (suite, host_state_manager_test_get_read_only_flash_null);
	SUITE_ADD_TEST (suite, host_state_manager_test_save_read_only_flash_cs0);
	...
	SUITE_ADD_TEST (suite, host_state_manager_test_is_inactive_dirty_no_state);
	SUITE_ADD_TEST (suite, host_state_manager_test_is_inactive_dirty_null);
	SUITE_ADD_TEST (suite, host_state_manager_test_save_inactive_dirty_not_dirty);
	SUITE_ADD_TEST (suite, host_state_manager_test_save_inactive_dirty_dirty);
	SUITE_ADD_TEST (suite, host_state_manager_test_save_inactive_dirty_same_state);
	SUITE_ADD_TEST (suite,
		host_state_manager_test_save_inactive_dirty_dirty_with_prevalidated_flash);
	SUITE_ADD_TEST (suite,
		host_state_manager_test_save_inactive_dirty_dirty_with_prevalidated_flash_and_pfm);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite, host_state_manager_test_get_active_pfm_no_state);
	SUITE_ADD_TEST (suite, host_state_manager_test_get_active_pfm_null);
	SUITE_ADD_TEST (suite, host_state_manager_test_save_active_pfm_region1);
	...
	SUITE_ADD_TEST (suite, host_state_manager_test_is_pfm_dirty);
	SUITE_ADD_TEST (suite, host_state_manager_test_is_pfm_dirty_null);
	SUITE_ADD_TEST (suite, host_state_manager_test_set_pfm_dirty);
	SUITE_ADD_TEST (suite, host_state_manager_test_set_pfm_dirty_dirty_with_prevalidated_flash);
	SUITE_ADD_TEST (suite,
		host_state_manager_test_set_pfm_dirty_dirty_with_prevalidated_flash_and_pfm);
	...
	SUITE_ADD_TEST (suite, host_state_manager_test_get_active_recovery_image_no_state);
	SUITE_ADD_TEST (suite, host_state_manager_test_get_active_recovery_image_null);
	SUITE_ADD_TEST (suite, host_state_manager_test_save_active_recovery_image_region1);
