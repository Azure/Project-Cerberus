...
static const char *SUITE = "host_flash_manager_single";
...
CuSuite* get_host_flash_manager_single_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, host_flash_manager_single_test_init);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_init_null);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_init_with_managed_flash_initialization);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_init_with_managed_flash_initialization_null);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_release_null);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_get_read_only_flash);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_get_read_only_flash_null);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_get_read_write_flash);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_get_read_write_flash_null);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_swap_flash_devices);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_swap_flash_devices_activate_pending_pfm);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_swap_flash_devices_no_data_migration);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_swap_flash_devices_null);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_swap_flash_devices_dirty_clear_error);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_swap_flash_devices_allow_writes_error);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_swap_flash_devices_spi_filter_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_swap_flash_devices_activate_pending_pfm_error);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_config_spi_filter_flash_devices);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_config_spi_filter_flash_devices_null);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_config_spi_filter_flash_devices_allow_writes_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_config_spi_filter_flash_devices_mode_error);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_validate_read_only_flash);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_validate_read_only_flash_single_fw);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_validate_read_only_flash_multiple_fw);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_validate_read_only_flash_full_validation);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_only_flash_full_validation_not_blank_byte);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_only_flash_full_validation_single_fw);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_only_flash_full_validation_multiple_fw);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_validate_read_only_flash_good_pfm);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_only_flash_good_pfm_single_fw);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_only_flash_good_pfm_multiple_fw);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_only_flash_good_pfm_no_match_image);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_only_flash_good_pfm_no_match_image_multiple_fw);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_only_flash_good_pfm_full_validation);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_validate_read_only_flash_null);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_only_flash_pfm_firmware_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_only_flash_pfm_version_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_only_flash_pfm_version_error_multiple_fw);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_only_flash_pfm_images_error);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_validate_read_only_flash_pfm_rw_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_only_flash_flash_version_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_only_flash_flash_image_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_only_flash_full_flash_image_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_only_flash_good_pfm_pfm_firmware_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_only_flash_good_pfm_pfm_version_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_only_flash_good_pfm_pfm_version_error_multiple_fw);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_only_flash_good_pfm_flash_version_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_only_flash_good_pfm_pfm_images_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_only_flash_good_pfm_pfm_rw_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_only_flash_good_pfm_good_images_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_only_flash_good_pfm_flash_image_error);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_validate_read_write_flash);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_validate_read_write_flash_not_blank_byte);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_validate_read_write_flash_single_fw);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_validate_read_write_flash_multiple_fw);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_validate_read_write_flash_null);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_write_flash_pfm_firmware_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_write_flash_pfm_version_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_validate_read_write_flash_pfm_version_error_multiple_fw);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_validate_read_write_flash_pfm_images_error);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_validate_read_write_flash_pfm_rw_error);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_validate_read_write_flash_version_error);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_validate_read_write_flash_verify_error);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_free_read_write_regions_null);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_free_read_write_regions_null_list);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_free_read_write_regions_null_pfm);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_set_flash_for_rot_access);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_set_flash_for_rot_access_not_initilized_device);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_set_flash_for_rot_access_check_qspi_error);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_set_flash_for_rot_access_wip_set);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_set_flash_for_rot_access_with_flash_initialization);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_set_flash_for_rot_access_null);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_set_flash_for_rot_access_filter_error);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_set_flash_for_rot_access_mux_error);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_set_flash_for_rot_access_wip_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_set_flash_for_rot_access_block_protect_error);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_set_flash_for_rot_access_qspi_error);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_set_flash_for_rot_access_4byte_error);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_set_flash_for_rot_access_id_error);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_set_flash_for_rot_access_unknown_id_ff);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_set_flash_for_rot_access_unknown_id_00);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_set_flash_for_rot_access_with_flash_initialization_error);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_set_flash_for_host_access);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_set_flash_for_host_access_null);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_set_flash_for_host_access_mux_error);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_set_flash_for_host_access_enable_error);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_config_spi_filter_flash_type);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_config_spi_filter_flash_type_4byte);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_config_spi_filter_flash_type_require_write_enable);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_config_spi_filter_flash_type_fixed_addr_mode_3byte);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_config_spi_filter_flash_type_fixed_addr_mode_4byte);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_config_spi_filter_flash_type_reset_addr_mode_4byte);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_config_spi_filter_flash_type_set_size_unsupported);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_config_spi_filter_flash_type_addr_mode_write_en_unsupported);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_config_spi_filter_flash_type_reset_addr_mode_unsupported);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_config_spi_filter_flash_type_null);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_config_spi_filter_flash_type_id_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_config_spi_filter_flash_type_get_reset_addr_mode_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_config_spi_filter_flash_type_filter_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_config_spi_filter_flash_type_unsupported_mfg);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_config_spi_filter_flash_type_unsupported_dev);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_config_spi_filter_flash_type_filter_size_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_config_spi_filter_flash_type_addr_mode_write_en_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_config_spi_filter_flash_type_addr_mode_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_config_spi_filter_flash_type_fixed_addr_mode_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_config_spi_filter_flash_type_reset_addr_mode_error);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_initialize_flash_protection_3byte);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_initialize_flash_protection_4byte);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_initialize_flash_protection_fixed_3byte);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_initialize_flash_protection_fixed_4byte);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_initialize_flash_protection_multiple_fw);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_initialize_flash_protection_null);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_initialize_flash_protection_dirty_clear_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_initialize_flash_protection_filter_addr_mode_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_initialize_flash_protection_allow_writes_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_initialize_flash_protection_filter_flash_mode_error);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_get_flash_read_write_regions_ro_flash);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_get_flash_read_write_regions_ro_flash_single_fw);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_get_flash_read_write_regions_ro_flash_multiple_fw);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_get_flash_read_write_regions_rw_flash);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_get_flash_read_write_regions_rw_flash_single_fw);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_get_flash_read_write_regions_rw_flash_multiple_fw);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_get_flash_read_write_regions_null);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_get_flash_read_write_regions_pfm_firmware_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_get_flash_read_write_regions_pfm_version_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_get_flash_read_write_regions_pfm_version_error_multiple_fw);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_get_flash_read_write_regions_ro_flash_version_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_get_flash_read_write_regions_rw_flash_version_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_get_flash_read_write_regions_pfm_rw_error);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_get_flash_read_write_regions_pfm_rw_error_multiple_fw);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_host_has_flash_access);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_host_has_flash_access_rot_access);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_host_has_flash_access_filter_disabled);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_host_has_flash_access_null);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_host_has_flash_access_access_check_error);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_host_has_flash_access_filter_check_error);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_restore_flash_read_write_regions);
	SUITE_ADD_TEST (suite,
		host_flash_manager_single_test_restore_flash_read_write_regions_multiple_fw);
	SUITE_ADD_TEST (suite, host_flash_manager_single_test_restore_flash_read_write_regions_null);
