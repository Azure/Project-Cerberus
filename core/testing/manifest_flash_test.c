	...
	struct manifest_flash_testing *manifest, uint32_t address)
{
	...
	status = spi_flash_init (&manifest->flash, &manifest->flash_mock.base);
	CuAssertIntEquals (test, 0, status);
...
CuSuite* get_manifest_flash_suite ()
{
	...
	SUITE_ADD_TEST (suite, manifest_flash_test_release_null);
	SUITE_ADD_TEST (suite, manifest_flash_test_get_addr_null);
	SUITE_ADD_TEST (suite, manifest_flash_test_get_flash_null);
	...
	SUITE_ADD_TEST (suite, manifest_flash_test_get_id_verify_never_run);
	SUITE_ADD_TEST (suite, manifest_flash_test_get_id_after_verify_header_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_test_get_id_after_verify_bad_signature);
	...
	SUITE_ADD_TEST (suite, manifest_flash_test_get_signature_after_verify);
	SUITE_ADD_TEST (suite, manifest_flash_test_get_signature_after_verify_error);
	SUITE_ADD_TEST (suite, manifest_flash_test_get_signature_after_verify_bad_signature);
	SUITE_ADD_TEST (suite, manifest_flash_test_get_signature_after_verify_header_read_error);
	SUITE_ADD_TEST (suite, manifest_flash_test_get_signature_after_verify_bad_magic_number);
	SUITE_ADD_TEST (suite, manifest_flash_test_get_signature_after_verify_bad_sig_length);
	SUITE_ADD_TEST (suite, manifest_flash_test_get_signature_after_verify_sig_read_error);
	...
	SUITE_ADD_TEST (suite, manifest_flash_test_compare_id_higher);
	SUITE_ADD_TEST (suite, manifest_flash_test_compare_id_lower);
	SUITE_ADD_TEST (suite, manifest_flash_test_compare_id_equal);
	SUITE_ADD_TEST (suite, manifest_flash_test_compare_id_no_manifest1);
	SUITE_ADD_TEST (suite, manifest_flash_test_compare_id_no_manifest2);
	SUITE_ADD_TEST (suite, manifest_flash_test_compare_id_no_manifests);
	SUITE_ADD_TEST (suite, manifest_flash_test_compare_id_null_manifest1);
	SUITE_ADD_TEST (suite, manifest_flash_test_compare_id_null_manifest2);
	SUITE_ADD_TEST (suite, manifest_flash_test_compare_id_both_null);
