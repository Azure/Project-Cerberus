...
static const char *SUITE = "host_irq_handler";
...
CuSuite* get_host_irq_handler_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, host_irq_handler_test_init);
	SUITE_ADD_TEST (suite, host_irq_handler_test_init_no_recovery);
	SUITE_ADD_TEST (suite, host_irq_handler_test_init_null);
	SUITE_ADD_TEST (suite, host_irq_handler_test_release_null);
	SUITE_ADD_TEST (suite, host_irq_handler_test_enter_reset);
	SUITE_ADD_TEST (suite, host_irq_handler_test_enter_reset_no_recovery);
	SUITE_ADD_TEST (suite, host_irq_handler_test_enter_reset_null);
	SUITE_ADD_TEST (suite, host_irq_handler_test_enter_reset_host_error);
	SUITE_ADD_TEST (suite, host_irq_handler_test_exit_reset);
	SUITE_ADD_TEST (suite, host_irq_handler_test_exit_reset_no_recovery);
	SUITE_ADD_TEST (suite, host_irq_handler_test_exit_reset_null);
	SUITE_ADD_TEST (suite, host_irq_handler_test_assert_cs0);
	SUITE_ADD_TEST (suite, host_irq_handler_test_assert_cs0_no_recovery);
	SUITE_ADD_TEST (suite, host_irq_handler_test_assert_cs0_null);
	SUITE_ADD_TEST (suite, host_irq_handler_test_assert_cs1);
	SUITE_ADD_TEST (suite, host_irq_handler_test_assert_cs1_no_recovery);
	...
	SUITE_ADD_TEST (suite, host_irq_handler_test_power_on_flash_rollback_error);
	...
	SUITE_ADD_TEST (suite, host_irq_handler_test_power_on_apply_recovery_image_no_image);
	SUITE_ADD_TEST (suite,
		host_irq_handler_test_power_on_apply_recovery_image_unsupported_allow_unsecure);
	SUITE_ADD_TEST (suite,
		host_irq_handler_test_power_on_apply_recovery_image_no_image_allow_unsecure);
