...
#include "mock/observer_mock.h"


static const char *SUITE = "observable";
...
CuSuite* get_observable_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, observable_test_init);
	SUITE_ADD_TEST (suite, observable_test_init_null);
	SUITE_ADD_TEST (suite, observable_test_release_null);
	SUITE_ADD_TEST (suite, observable_test_notify_observers_no_observers);
	SUITE_ADD_TEST (suite, observable_test_notify_observers_one_observer);
	SUITE_ADD_TEST (suite, observable_test_notify_observers_twice);
	SUITE_ADD_TEST (suite, observable_test_notify_observers_multiple_observers);
	SUITE_ADD_TEST (suite, observable_test_notify_observers_no_event_handler);
	SUITE_ADD_TEST (suite, observable_test_notify_observers_null);
	SUITE_ADD_TEST (suite, observable_test_notify_observers_with_ptr_no_observers);
	SUITE_ADD_TEST (suite, observable_test_notify_observers_with_ptr_one_observer);
	SUITE_ADD_TEST (suite, observable_test_notify_observers_with_ptr_twice);
	SUITE_ADD_TEST (suite, observable_test_notify_observers_with_ptr_multiple_observers);
	SUITE_ADD_TEST (suite, observable_test_notify_observers_with_ptr_no_event_handler);
	SUITE_ADD_TEST (suite, observable_test_notify_observers_with_ptr_argument_null);
	SUITE_ADD_TEST (suite, observable_test_notify_observers_with_ptr_null);
	SUITE_ADD_TEST (suite, observable_test_add_observer_same_twice);
	SUITE_ADD_TEST (suite, observable_test_add_observer_null);
	SUITE_ADD_TEST (suite, observable_test_remove_observer);
	SUITE_ADD_TEST (suite, observable_test_remove_observer_only_one);
	SUITE_ADD_TEST (suite, observable_test_remove_observer_none);
	SUITE_ADD_TEST (suite, observable_test_remove_observer_not_registered);
	SUITE_ADD_TEST (suite, observable_test_remove_observer_null);
