...
static const char *SUITE = "rng_thread_safe";
...
CuSuite* get_rng_thread_safe_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, rng_thread_safe_test_init);
	SUITE_ADD_TEST (suite, rng_thread_safe_test_init_null);
	SUITE_ADD_TEST (suite, rng_thread_safe_test_release_null);
	SUITE_ADD_TEST (suite, rng_thread_safe_test_generate_random_buffer);
	SUITE_ADD_TEST (suite, rng_thread_safe_test_generate_random_buffer_error);
	SUITE_ADD_TEST (suite, rng_thread_safe_test_generate_random_buffer_null);
