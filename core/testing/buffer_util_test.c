...
static const char *SUITE = "buffer_util";
...
CuSuite* get_buffer_util_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, buffer_copy_full_buffer);
	SUITE_ADD_TEST (suite, buffer_copy_full_buffer_null_offset);
	SUITE_ADD_TEST (suite, buffer_copy_full_buffer_with_offset);
	SUITE_ADD_TEST (suite, buffer_copy_full_buffer_with_offset_same_as_source_length);
	SUITE_ADD_TEST (suite, buffer_copy_full_buffer_with_offset_longer_than_source);
	SUITE_ADD_TEST (suite, buffer_copy_full_buffer_small_buffer);
	SUITE_ADD_TEST (suite, buffer_copy_full_buffer_null_length);
	SUITE_ADD_TEST (suite, buffer_copy_full_buffer_zero_length);
	SUITE_ADD_TEST (suite, buffer_copy_full_buffer_with_offset_small_buffer);
	SUITE_ADD_TEST (suite, buffer_copy_full_buffer_with_offset_small_buffer_past_source_end);
	SUITE_ADD_TEST (suite, buffer_copy_null_source);
	SUITE_ADD_TEST (suite, buffer_copy_zero_length_source);
	SUITE_ADD_TEST (suite, buffer_copy_null_destination);
