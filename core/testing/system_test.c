...
#include "mock/system_observer_mock.h"
#include "mock/logging_mock.h"
#include "debug_log_testing.h"


static const char *SUITE = "system";
...
CuSuite* get_system_suite ()
{
	...
	SUITE_ADD_TEST (suite, system_test_init);
	SUITE_ADD_TEST (suite, system_test_init_null);
	SUITE_ADD_TEST (suite, system_test_release_null);
	SUITE_ADD_TEST (suite, system_test_add_observer);
	SUITE_ADD_TEST (suite, system_test_add_observer_null);
	SUITE_ADD_TEST (suite, system_test_remove_observer);
	SUITE_ADD_TEST (suite, system_test_remove_observer_null);
	SUITE_ADD_TEST (suite, system_test_reset);
	SUITE_ADD_TEST (suite, system_test_reset_no_observers);
	SUITE_ADD_TEST (suite, system_test_reset_null);
	SUITE_ADD_TEST (suite, system_test_reset_device_reset_error);
