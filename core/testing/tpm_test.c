...
#include "platform.h"
#include "testing.h"
#include "mock/flash_store_mock.h"
#include "tpm/tpm.h"
...
CuSuite* get_tpm_suite ()
{
	...
	SUITE_ADD_TEST (suite, tpm_test_init_large_flash_blocks);
	SUITE_ADD_TEST (suite, tpm_test_init_no_header);
	SUITE_ADD_TEST (suite, tpm_test_init_no_header_no_data);
	SUITE_ADD_TEST (suite, tpm_test_init_no_header_corrupt_data);
	SUITE_ADD_TEST (suite, tpm_test_init_clear);
	SUITE_ADD_TEST (suite, tpm_test_init_null);
	SUITE_ADD_TEST (suite, tpm_test_init_small_flash_blocks);
	SUITE_ADD_TEST (suite, tpm_test_init_block_size_fail);
	SUITE_ADD_TEST (suite, tpm_test_init_read_header_fail);
	SUITE_ADD_TEST (suite, tpm_test_init_no_header_write_fail);
	SUITE_ADD_TEST (suite, tpm_test_init_clear_write_empty_buffer_fail);
	SUITE_ADD_TEST (suite, tpm_test_init_clear_write_header_fail);
	SUITE_ADD_TEST (suite, tpm_test_init_clear_write_empty_buffer_and_header_fail);
	SUITE_ADD_TEST (suite, tpm_test_init_clear_num_blocks_fail);
	SUITE_ADD_TEST (suite, tpm_test_release_null);
	SUITE_ADD_TEST (suite, tpm_test_get_counter);
	SUITE_ADD_TEST (suite, tpm_test_get_counter_null);
	SUITE_ADD_TEST (suite, tpm_test_get_counter_invalid_storage);
	SUITE_ADD_TEST (suite, tpm_test_get_counter_invalid_storage_no_data);
	SUITE_ADD_TEST (suite, tpm_test_get_counter_invalid_storage_corrupt_data);
	...
	SUITE_ADD_TEST (suite, tpm_test_increment_counter_invalid_storage_no_data);
	SUITE_ADD_TEST (suite, tpm_test_increment_counter_invalid_storage_corrupt_data);
	SUITE_ADD_TEST (suite, tpm_test_increment_counter_null);
	...
	SUITE_ADD_TEST (suite, tpm_test_set_storage_not_first);
	SUITE_ADD_TEST (suite, tpm_test_set_storage_null);
	SUITE_ADD_TEST (suite, tpm_test_set_storage_write_fail);
	SUITE_ADD_TEST (suite, tpm_test_get_storage);
	SUITE_ADD_TEST (suite, tpm_test_get_storage_mask_errors);
	SUITE_ADD_TEST (suite, tpm_test_get_storage_not_first);
	SUITE_ADD_TEST (suite, tpm_test_get_storage_no_data);
	SUITE_ADD_TEST (suite, tpm_test_get_storage_no_data_mask_errors);
	SUITE_ADD_TEST (suite, tpm_test_get_storage_corrupt_data);
	SUITE_ADD_TEST (suite, tpm_test_get_storage_corrupt_data_mask_errors);
	SUITE_ADD_TEST (suite, tpm_test_get_storage_null);
	...
	SUITE_ADD_TEST (suite, tpm_test_on_soft_reset_invalid_storage_no_data);
	SUITE_ADD_TEST (suite, tpm_test_on_soft_reset_invalid_storage_corrupt_data);
	SUITE_ADD_TEST (suite, tpm_test_on_soft_reset_null);
	SUITE_ADD_TEST (suite, tpm_test_on_soft_reset_read_fail);
	SUITE_ADD_TEST (suite, tpm_test_on_soft_reset_write_empty_buffer_fail);
	SUITE_ADD_TEST (suite, tpm_test_on_soft_reset_write_header_fail);
	SUITE_ADD_TEST (suite, tpm_test_on_soft_reset_write_empty_buffer_and_header_fail);
	SUITE_ADD_TEST (suite, tpm_test_on_soft_reset_num_blocks_fail);
	...
	SUITE_ADD_TEST (suite, tpm_test_schedule_clear_invalid_storage_no_data);
	SUITE_ADD_TEST (suite, tpm_test_schedule_clear_invalid_storage_corrupt_data);
