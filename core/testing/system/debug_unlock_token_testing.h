...
#ifndef DEBUG_UNLOCK_TOKEN_TESTING_H_
#define DEBUG_UNLOCK_TOKEN_TESTING_H_
...
extern const uint8_t DEBUG_UNLOCK_TOKEN_TESTING_COUNTER_LOCKED_UNLOCKED[];
extern const size_t DEBUG_UNLOCK_TOKEN_TESTING_COUNTER_LOCKED_LEN;

extern const uint8_t DEBUG_UNLOCK_TOKEN_TESTING_NONCE[32];
extern const size_t DEBUG_UNLOCK_TOKEN_TESTING_NONCE_LEN;

extern const uint8_t DEBUG_UNLOCK_TOKEN_TESTING_UNLOCK_POLICY[];
extern const size_t DEBUG_UNLOCK_TOKEN_TESTING_UNLOCK_POLICY_LEN;
...
#endif /* DEBUG_UNLOCK_TOKEN_TESTING_H_ */
