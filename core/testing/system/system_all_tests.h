...
#if (defined TESTING_RUN_DEVICE_UNLOCK_TOKEN_SUITE || \
		defined TESTING_RUN_ALL_TESTS || defined TESTING_RUN_ALL_CORE_TESTS || \
		(!defined TESTING_SKIP_ALL_TESTS && !defined TESTING_SKIP_ALL_CORE_TESTS)) && \
	!defined TESTING_SKIP_DEVICE_UNLOCK_TOKEN_SUITE
	TESTING_RUN_SUITE (device_unlock_token);
#endif
...
#endif
#if (defined TESTING_RUN_FATAL_ERROR_SUITE || \
		defined TESTING_RUN_ALL_TESTS || defined TESTING_RUN_ALL_CORE_TESTS || \
		(!defined TESTING_SKIP_ALL_TESTS && !defined TESTING_SKIP_ALL_CORE_TESTS)) && \
	!defined TESTING_SKIP_FATAL_ERROR_SUITE
	TESTING_RUN_SUITE (fatal_error);
#endif
