...
static const char *SUITE = "logging_flash";
...
CuSuite* get_logging_flash_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, logging_flash_test_init_empty);
	SUITE_ADD_TEST (suite, logging_flash_test_init_first_sector_partial);
	SUITE_ADD_TEST (suite, logging_flash_test_init_first_sector_partial_different_lengths);
	SUITE_ADD_TEST (suite, logging_flash_test_init_first_sector_full_all_bytes);
	SUITE_ADD_TEST (suite, logging_flash_test_init_first_sector_full_unused_bytes);
	SUITE_ADD_TEST (suite, logging_flash_test_init_first_sector_full_unused_bytes_terminator);
	SUITE_ADD_TEST (suite, logging_flash_test_init_first_sector_full_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_init_second_sector_partial_all_bytes);
	SUITE_ADD_TEST (suite, logging_flash_test_init_second_sector_partial_unused_bytes);
	SUITE_ADD_TEST (suite, logging_flash_test_init_second_sector_partial_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_init_second_sector_partial_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_init_all_sectors_full_all_bytes);
	SUITE_ADD_TEST (suite, logging_flash_test_init_all_sectors_full_unused_bytes);
	SUITE_ADD_TEST (suite, logging_flash_test_init_all_sectors_full_unused_bytes_terminator);
	SUITE_ADD_TEST (suite, logging_flash_test_init_all_sectors_full_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_init_all_sectors_full_overwrite_all_bytes);
	SUITE_ADD_TEST (suite, logging_flash_test_init_all_sectors_full_overwrite_unused_bytes);
	SUITE_ADD_TEST (suite,
		logging_flash_test_init_all_sectors_full_overwrite_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_init_all_sectors_full_overwrite_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_init_all_sectors_partial_overwrite_all_bytes);
	SUITE_ADD_TEST (suite, logging_flash_test_init_all_sectors_partial_overwrite_unused_bytes);
	SUITE_ADD_TEST (suite,
		logging_flash_test_init_all_sectors_partial_overwrite_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_init_all_sectors_partial_overwrite_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_init_ca_entry);
	SUITE_ADD_TEST (suite, logging_flash_test_init_valid_entry_unknown_format);
	SUITE_ADD_TEST (suite, logging_flash_test_init_no_valid_entry_markers);
	SUITE_ADD_TEST (suite, logging_flash_test_init_entry_bad_length);
	SUITE_ADD_TEST (suite, logging_flash_test_init_partial_entry_bad_length);
	SUITE_ADD_TEST (suite, logging_flash_test_init_terminator_bad_length);
	SUITE_ADD_TEST (suite, logging_flash_test_init_partial_terminator_bad_length);
	SUITE_ADD_TEST (suite, logging_flash_test_init_partial_unused_not_blank);
	SUITE_ADD_TEST (suite, logging_flash_test_init_null);
	SUITE_ADD_TEST (suite, logging_flash_test_init_not_block_aligned);
	SUITE_ADD_TEST (suite, logging_flash_test_init_flash_read_error);
	SUITE_ADD_TEST (suite, logging_flash_test_release_null);
	SUITE_ADD_TEST (suite, logging_flash_test_get_size_null);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_multiple);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_multiple_different_lengths);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_full_buffer_flush);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_full_buffer_flush_unused_bytes);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_full_buffer_flush_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_full_buffer_flush_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_sector_partial_full);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_second_sector_partial_all_bytes);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_second_sector_partial_unused_bytes);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_second_sector_partial_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_second_sector_partial_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_fill_partial_buffer_flush);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_fill_partial_buffer_flush_unused_bytes);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_fill_partial_buffer_flush_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_fill_partial_buffer_flush_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_all_sectors_full);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_all_sectors_full_unused_bytes);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_all_sectors_full_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_all_sectors_full_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_full_overwrite_middle);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_full_overwrite_middle_unused_bytes);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_full_overwrite_middle_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_full_overwrite_middle_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_full_partial_overwrite_middle);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_full_partial_overwrite_middle_unused_bytes);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_full_partial_overwrite_middle_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_full_partial_overwrite_middle_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_full_buffer_after_partial_flush);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_full_buffer_after_partial_flush_unused_bytes);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_full_buffer_after_partial_flush_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_full_buffer_after_partial_flush_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_full_buffer_flush_multiple);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_full_buffer_flush_multiple_unused_bytes);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_full_buffer_flush_multiple_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_full_buffer_flush_multiple_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_wrap_to_start);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_wrap_to_start_unused_bytes);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_wrap_to_start_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_wrap_to_start_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_init_with_entry_too_long);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_init_with_entry_too_short);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_init_with_terminator_too_long);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_init_with_terminator_too_short);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_sector_unused_not_blank);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_sector_unused_partially_not_blank);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_first_sector_not_valid);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_null);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_bad_length);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_flush_error);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_after_incomplete_flush);
	SUITE_ADD_TEST (suite, logging_flash_test_create_entry_after_incomplete_flush_unused_bytes);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_after_incomplete_flush_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_after_incomplete_flush_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_full_buffer_flush_after_incomplete_flush);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_full_buffer_flush_after_incomplete_flush_unused_bytes);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_full_buffer_flush_after_incomplete_flush_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_create_entry_full_buffer_flush_after_incomplete_flush_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_flush_no_data);
	SUITE_ADD_TEST (suite, logging_flash_test_flush_null);
	SUITE_ADD_TEST (suite, logging_flash_test_flush_erase_error);
	SUITE_ADD_TEST (suite, logging_flash_test_flush_write_error);
	SUITE_ADD_TEST (suite, logging_flash_test_flush_incomplete_write);
	SUITE_ADD_TEST (suite, logging_flash_test_flush_incomplete_write_unused_bytes);
	SUITE_ADD_TEST (suite, logging_flash_test_flush_incomplete_write_unused_bytes_terminator);
	SUITE_ADD_TEST (suite, logging_flash_test_flush_incomplete_write_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_flush_after_incomplete_write);
	SUITE_ADD_TEST (suite, logging_flash_test_flush_after_incomplete_write_unused_bytes);
	SUITE_ADD_TEST (suite, logging_flash_test_flush_after_incomplete_write_unused_bytes_terminator);
	SUITE_ADD_TEST (suite, logging_flash_test_flush_after_incomplete_write_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_read_contents);
	SUITE_ADD_TEST (suite, logging_flash_test_read_contents_empty);
	SUITE_ADD_TEST (suite, logging_flash_test_read_contents_buffered_entry_only);
	SUITE_ADD_TEST (suite, logging_flash_test_read_contents_first_sector_full);
	SUITE_ADD_TEST (suite, logging_flash_test_read_contents_first_sector_full_unused_bytes);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_first_sector_full_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_first_sector_full_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_read_contents_second_sector_partial);
	SUITE_ADD_TEST (suite, logging_flash_test_read_contents_second_sector_partial_usused_bytes);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_second_sector_partial_usused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_second_sector_partial_usused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_read_contents_all_sectors_full);
	SUITE_ADD_TEST (suite, logging_flash_test_read_contents_all_sectors_full_unused_bytes);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_all_sectors_full_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_all_sectors_full_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_read_contents_all_sectors_full_overwrite);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_all_sectors_full_overwrite_unused_bytes);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_all_sectors_full_overwrite_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_all_sectors_full_overwrite_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_read_contents_all_sectors_partial_overwrite);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_all_sectors_partial_overwrite_unused_bytes);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_all_sectors_partial_overwrite_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_all_sectors_partial_overwrite_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_read_contents_after_erase_new_middle_sector);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_after_erase_new_middle_sector_unused_bytes);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_after_erase_new_middle_sector_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_after_erase_new_middle_sector_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_read_contents_partial_read);
	SUITE_ADD_TEST (suite, logging_flash_test_read_contents_partial_read_buffered_entries);
	SUITE_ADD_TEST (suite, logging_flash_test_read_contents_offset_read_in_first_sector);
	SUITE_ADD_TEST (suite, logging_flash_test_read_contents_offset_read_in_second_sector);
	SUITE_ADD_TEST (suite, logging_flash_test_read_contents_offset_read_buffered_entries);
	SUITE_ADD_TEST (suite, logging_flash_test_read_contents_partial_read_with_offset);
	SUITE_ADD_TEST (suite, logging_flash_test_read_contents_offset_past_end);
	SUITE_ADD_TEST (suite, logging_flash_test_read_contents_zero);
	SUITE_ADD_TEST (suite, logging_flash_test_read_contents_flash_and_buffered_entries);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_flash_and_buffered_entries_unused_bytes);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_flash_and_buffered_entries_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_flash_and_buffered_entries_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_read_contents_full_log_with_buffered_entries);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_full_log_with_buffered_entries_unused_bytes);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_full_log_with_buffered_entries_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_full_log_with_buffered_entries_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_full_buffer_flush_after_incomplete_flush);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_full_buffer_flush_after_incomplete_flush_unused_bytes);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_full_buffer_flush_after_incomplete_flush_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_read_contents_full_buffer_flush_after_incomplete_flush_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_read_contents_null);
	SUITE_ADD_TEST (suite, logging_flash_test_read_contents_read_error);
	SUITE_ADD_TEST (suite, logging_flash_test_clear);
	SUITE_ADD_TEST (suite, logging_flash_test_clear_buffered_entry);
	SUITE_ADD_TEST (suite, logging_flash_test_clear_flushed_entry);
	SUITE_ADD_TEST (suite, logging_flash_test_clear_with_entries_then_fill_buffer);
	SUITE_ADD_TEST (suite, logging_flash_test_clear_with_entries_then_fill_buffer_unused_bytes);
	SUITE_ADD_TEST (suite,
		logging_flash_test_clear_with_entries_then_fill_buffer_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_clear_with_entries_then_fill_buffer_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_clear_after_partial_flush_then_fill_buffer);
	SUITE_ADD_TEST (suite,
		logging_flash_test_clear_after_partial_flush_then_fill_buffer_unused_bytes);
	SUITE_ADD_TEST (suite,
		logging_flash_test_clear_after_partial_flush_then_fill_buffer_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_clear_after_partial_flush_then_fill_buffer_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_clear_full_overwrite);
	SUITE_ADD_TEST (suite, logging_flash_test_clear_full_overwrite_unused_bytes);
	SUITE_ADD_TEST (suite, logging_flash_test_clear_full_overwrite_unused_bytes_terminator);
	SUITE_ADD_TEST (suite, logging_flash_test_clear_full_overwrite_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_clear_full_buffer_flush_after_incomplete_flush);
	SUITE_ADD_TEST (suite,
		logging_flash_test_clear_full_buffer_flush_after_incomplete_flush_unused_bytes);
	SUITE_ADD_TEST (suite,
		logging_flash_test_clear_full_buffer_flush_after_incomplete_flush_unused_bytes_terminator);
	SUITE_ADD_TEST (suite,
		logging_flash_test_clear_full_buffer_flush_after_incomplete_flush_unused_bytes_terminator_large);
	SUITE_ADD_TEST (suite, logging_flash_test_clear_null);
	SUITE_ADD_TEST (suite, logging_flash_test_clear_erase_error);
