...
static const char *SUITE = "pfm_flash_v2";
...
CuSuite* get_pfm_flash_v2_suite ()
{
	...
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_verify);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_verify_with_mock_hash);
	...
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_verify_rw_test);
	...
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_verify_flash_device_element_bad_length);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_id);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_id_null);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_id_after_verify_flash_device_element_read_error);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_id_after_verify_flash_device_element_bad_length);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_platform_id);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_platform_id_manifest_allocation);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_platform_id_null);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_free_platform_id_null);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_hash);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_hash_null);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_signature);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_signature_null);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_multiple);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_no_flash_dev_element);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_no_firmware_entries);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_null);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_verify_never_run);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_read_element_error);
	SUITE_ADD_TEST (suite,
		pfm_flash_v2_test_get_firmware_bad_firmware_element_length_less_than_min);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_bad_firmware_element_length_less_than_id);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_supported_versions);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_supported_versions_multiple_firmware);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_supported_versions_multiple_versions);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_supported_versions_null_firmware_id);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_supported_versions_no_versions);
	SUITE_ADD_TEST (suite,
		pfm_flash_v2_test_get_supported_versions_no_flash_dev_element_null_firmware_id);
	SUITE_ADD_TEST (suite,
		pfm_flash_v2_test_get_supported_versions_no_firmware_entries_null_firmware_id);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_supported_versions_null);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_supported_versions_verify_never_run);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_supported_versions_no_flash_dev_element);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_supported_versions_no_firmware_entries);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_supported_versions_unknown_firmware);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_supported_versions_find_firmware_error);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_supported_versions_read_element_error);
	SUITE_ADD_TEST (suite,
		pfm_flash_v2_test_get_supported_versions_bad_firmware_element_length_less_than_min);
	SUITE_ADD_TEST (suite,
		pfm_flash_v2_test_get_supported_versions_bad_firmware_element_length_less_than_id);
	SUITE_ADD_TEST (suite,
		pfm_flash_v2_test_get_supported_versions_bad_fw_version_element_length_less_than_min);
	SUITE_ADD_TEST (suite,
		pfm_flash_v2_test_get_supported_versions_bad_fw_version_element_length_less_than_version);
	SUITE_ADD_TEST (suite,
		pfm_flash_v2_test_get_supported_versions_bad_fw_version_element_length_less_than_rw);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_read_write_regions);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_read_write_regions_multiple_firmware);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_read_write_regions_multiple_versions);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_read_write_regions_multiple_regions);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_read_write_regions_null_firmware_id);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_read_write_regions_no_regions);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_read_write_regions_max_element_single_read);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_read_write_regions_additional_element_read);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_read_write_regions_max_version_string);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_read_write_regions_max_rw_regions);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_read_write_regions_null);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_read_write_regions_verify_never_run);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_read_write_regions_no_flash_dev_element);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_read_write_regions_no_firmware_entries);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_read_write_regions_unknown_firmware);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_read_write_regions_find_firmware_error);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_read_write_regions_unknown_version);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_read_write_regions_unknown_version_last_entry);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_read_write_regions_find_version_error);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_read_write_regions_too_many_rw_regions);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_read_write_regions_additional_element_read_error);
	SUITE_ADD_TEST (suite,
		pfm_flash_v2_test_get_read_write_regions_bad_firmware_element_length_less_than_min);
	SUITE_ADD_TEST (suite,
		pfm_flash_v2_test_get_read_write_regions_bad_firmware_element_length_less_than_id);
	SUITE_ADD_TEST (suite,
		pfm_flash_v2_test_get_read_write_regions_bad_fw_version_element_length_less_than_min);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_images_multiple_versions);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_images_multiple_images);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_images_multiple_regions);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_images_multiple_images_multiple_regions);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_images_extra_flags);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_images_null_firmware_id);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_images_max_element_single_read);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_images_additional_element_read);
	SUITE_ADD_TEST (suite,
		pfm_flash_v2_test_get_firmware_images_additional_element_read_rw_overflow);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_images_multiple_element_read);
	SUITE_ADD_TEST (suite,
		pfm_flash_v2_test_get_firmware_images_multiple_element_read_multiple_per_element);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_images_max_version_string);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_images_max_image_regions);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_images_null);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_images_verify_never_run);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_images_no_flash_dev_element);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_images_no_firmware_entries);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_images_unknown_firmware);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_images_find_firmware_error);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_images_unknown_version);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_images_find_version_error);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_images_invalid_hash_type);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_images_no_regions);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_images_too_many_image_regions);
	SUITE_ADD_TEST (suite, pfm_flash_v2_test_get_firmware_images_additional_element_read_error);
	SUITE_ADD_TEST (suite,
		pfm_flash_v2_test_get_firmware_images_bad_firmware_element_length_less_than_min);
	SUITE_ADD_TEST (suite,
		pfm_flash_v2_test_get_firmware_images_bad_firmware_element_length_less_than_id);
	SUITE_ADD_TEST (suite,
		pfm_flash_v2_test_get_firmware_images_bad_fw_version_element_length_less_than_min);
	SUITE_ADD_TEST (suite,
		pfm_flash_v2_test_get_firmware_images_bad_fw_version_element_length_less_than_version);
	SUITE_ADD_TEST (suite,
		pfm_flash_v2_test_get_firmware_images_bad_fw_version_element_length_less_than_rw);
	SUITE_ADD_TEST (suite,
		pfm_flash_v2_test_get_firmware_images_bad_fw_version_element_length_less_than_img_min);
	SUITE_ADD_TEST (suite,
		pfm_flash_v2_test_get_firmware_images_bad_fw_version_element_length_less_than_img);
	SUITE_ADD_TEST (suite,
