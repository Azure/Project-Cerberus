...
static void cfm_flash_test_get_component_pmr_component_not_found (CuTest *test)
{
	...
	for (int i = 27; i < CFM_TESTING.manifest.toc_entries; ++i) {
		status |= mock_expect (&cfm.manifest.flash.mock, cfm.manifest.flash.base.read,
			&cfm.manifest.flash, 0, MOCK_ARG (cfm.manifest.addr + MANIFEST_V2_TOC_ENTRY_OFFSET +
	...
	CuTest *test)
{
	...
	cfm_flash_testing_init_and_verify (test, &cfm, 0x10000, &CFM_MALFORMED_MEASUREMENT_TESTING,
		0, false, 0);
...
static void cfm_flash_test_get_next_pfm_multiple_big_endian_ids (CuTest *test)
{
	...
	manifest_flash_v2_testing_iterate_manifest_toc (test, &cfm.manifest, &CFM_TESTING.manifest, 16,
		18);
...
static void cfm_flash_test_get_next_pfm_second_pfm_big_endian (CuTest *test)
{
	...
	manifest_flash_v2_testing_iterate_manifest_toc (test, &cfm.manifest, &CFM_TESTING.manifest, 18,
		26);

	manifest_flash_v2_testing_read_element (test, &cfm.manifest, &CFM_TESTING.manifest, 18, 18, 18,
		0x83e, 0xe, 0xe, 0);

	manifest_flash_v2_testing_iterate_manifest_toc (test, &cfm.manifest, &CFM_TESTING.manifest, 19,
		20);
...
static void cfm_flash_test_get_next_pfm_no_more_pfm (CuTest *test)
{
	...
	manifest_flash_v2_testing_iterate_manifest_toc (test, &cfm.manifest, &CFM_TESTING.manifest, 20,
		26);
...
static void cfm_flash_test_get_next_pfm_second_component_big_endian (CuTest *test)
{
	...
	manifest_flash_v2_testing_iterate_manifest_toc (test, &cfm.manifest, &CFM_TESTING.manifest, 34,
		35);
...
static void cfm_flash_test_get_next_cfm_big_endian (CuTest *test)
{
	...
	manifest_flash_v2_testing_iterate_manifest_toc (test, &cfm.manifest, &CFM_TESTING.manifest, 21,
		22);
...
static void cfm_flash_test_get_next_cfm_second_cfm (CuTest *test)
{
	...
	manifest_flash_v2_testing_iterate_manifest_toc (test, &cfm.manifest, &CFM_TESTING.manifest, 22,
		26);

	manifest_flash_v2_testing_read_element (test, &cfm.manifest, &CFM_TESTING.manifest, 22, 22, 22,
		0x86a, 0xe, 0xe, 0);

	manifest_flash_v2_testing_iterate_manifest_toc (test, &cfm.manifest, &CFM_TESTING.manifest, 23,
		24);
...
static void cfm_flash_test_get_next_cfm_no_more_cfm (CuTest *test)
{
	...
	manifest_flash_v2_testing_iterate_manifest_toc (test, &cfm.manifest, &CFM_TESTING.manifest, 24,
		26);
...
static void cfm_flash_test_get_next_cfm_second_component (CuTest *test)
{
	...
	manifest_flash_v2_testing_iterate_manifest_toc (test, &cfm.manifest, &CFM_TESTING.manifest, 36,
		37);
...
static void cfm_flash_test_get_pcd (CuTest *test)
{
	...
	manifest_flash_v2_testing_iterate_manifest_toc (test, &cfm.manifest, &CFM_TESTING.manifest, 25,
		26);
...
static void cfm_flash_test_get_pcd_second_component_big_endian (CuTest *test)
{
	...
	manifest_flash_v2_testing_iterate_manifest_toc (test, &cfm.manifest, &CFM_TESTING.manifest, 38,
		38);
