 ...
 */
struct manifest_cmd_handler_pcd_testing {
	...
	struct manifest_cmd_handler_pcd test;		/**< Manifest handler under test. */
};
 ...
 */
static void manifest_cmd_handler_pcd_testing_init_dependencies (CuTest *test,
 ...
 * @param handler The testing components to initialize.
 */
static void manifest_cmd_handler_pcd_testing_init (CuTest *test,
	struct manifest_cmd_handler_pcd_testing *handler)
{
	int status;

	manifest_cmd_handler_pcd_testing_init_dependencies (test, handler);

	status = manifest_cmd_handler_pcd_init (&handler->test, &handler->state,
 ...
 * @param handler The testing components to initialize.
 */
static void manifest_cmd_handler_pcd_testing_init_static (CuTest *test,
	struct manifest_cmd_handler_pcd_testing *handler, struct manifest_cmd_handler_pcd *test_static)
{
	int status;

	manifest_cmd_handler_pcd_testing_init_dependencies (test, handler);

	status = manifest_cmd_handler_pcd_init_state (test_static);
	CuAssertIntEquals (test, 0, status);
}
 ...
 */
static void manifest_cmd_handler_pcd_testing_release_dependencies (CuTest *test,
	struct manifest_cmd_handler_pcd_testing *handler)
{
	int status;
 ...
 */
static void manifest_cmd_handler_pcd_testing_validate_and_release (CuTest *test,
	struct manifest_cmd_handler_pcd_testing *handler)
{
	manifest_cmd_handler_pcd_testing_release_dependencies (test, handler);
	manifest_cmd_handler_pcd_release (&handler->test);
}
...
static void manifest_cmd_handler_pcd_test_init (CuTest *test)
{
	struct manifest_cmd_handler_pcd_testing handler;
	int status;
	...
	status = manifest_cmd_handler_pcd_init (&handler.test, &handler.state, &handler.manifest.base,
		&handler.task.base);
	CuAssertIntEquals (test, 0, status);
	...
	manifest_cmd_handler_pcd_testing_validate_and_release (test, &handler);
}

static void manifest_cmd_handler_pcd_test_init_null (CuTest *test)
{
	struct manifest_cmd_handler_pcd_testing handler;
	int status;
	...
	status = manifest_cmd_handler_pcd_init (NULL, &handler.state, &handler.manifest.base,
		&handler.task.base);
	CuAssertIntEquals (test, MANIFEST_MANAGER_INVALID_ARGUMENT, status);

	status = manifest_cmd_handler_pcd_init (&handler.test, NULL, &handler.manifest.base,
		&handler.task.base);
	CuAssertIntEquals (test, MANIFEST_MANAGER_INVALID_ARGUMENT, status);

	status = manifest_cmd_handler_pcd_init (&handler.test, &handler.state, NULL,
		&handler.task.base);
	CuAssertIntEquals (test, MANIFEST_MANAGER_INVALID_ARGUMENT, status);
...
static void manifest_cmd_handler_pcd_test_static_init (CuTest *test)
{
	...
	manifest_cmd_handler_pcd_testing_release_dependencies (test, &handler);
	manifest_cmd_handler_pcd_release (&test_static);
}
...
static void manifest_cmd_handler_pcd_test_static_init_null (CuTest *test)
{
	...
	status = manifest_cmd_handler_pcd_init_state (NULL);
	CuAssertIntEquals (test, MANIFEST_MANAGER_INVALID_ARGUMENT, status);
...
static void manifest_cmd_handler_pcd_test_release_null (CuTest *test)
{
	TEST_START;

	manifest_cmd_handler_pcd_release (NULL);
}

static void manifest_cmd_handler_pcd_test_get_status (CuTest *test)
{
	struct manifest_cmd_handler_pcd_testing handler;
	int status;
	...
	manifest_cmd_handler_pcd_testing_init (test, &handler);
...
static void manifest_cmd_handler_pcd_test_get_status_static_init (CuTest *test)
{
	...
	manifest_cmd_handler_pcd_testing_init_static (test, &handler, &test_static);
...
static void manifest_cmd_handler_pcd_test_activation (CuTest *test)
{
	struct manifest_cmd_handler_pcd_testing handler;
	int status;
	bool reset = false;
	struct debug_log_entry_info entry = {
		...
		.msg_index = MANIFEST_LOGGING_PCD_UPDATE,
		.arg1 = 0,
		.arg2 = 0
	};
...
TEST (manifest_cmd_handler_pcd_test_init_null);
TEST (manifest_cmd_handler_pcd_test_static_init);
TEST (manifest_cmd_handler_pcd_test_static_init_null);
TEST (manifest_cmd_handler_pcd_test_release_null);
TEST (manifest_cmd_handler_pcd_test_get_status);
TEST (manifest_cmd_handler_pcd_test_get_status_static_init);
TEST (manifest_cmd_handler_pcd_test_activation);
