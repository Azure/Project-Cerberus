...
static const char *SUITE = "riot_key_manager";
...
CuSuite* get_riot_key_manager_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, riot_key_manager_test_init_no_signed_device_id);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_bad_signed_device_id);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_signed_device_id);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_intermediate_signed_device_id);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_signed_device_id_no_root_ca);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_signed_device_id_bad_root_ca);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_signed_device_id_not_signed_by_root);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_signed_device_id_not_sign_alias_cert);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_intermediate_signed_device_id_no_ca);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_intermediate_signed_device_id_bad_ca);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_intermediate_signed_device_id_not_trusted);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_riot_authentication_failed);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_authentication_mock);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_null);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_signed_device_id_load_error);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_root_ca_load_error);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_intermediate_ca_load_error);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_authenticate_load_alias_error);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_authenticate_init_cert_store_error);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_authenticate_add_root_ca_error);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_authenticate_add_intermediate_ca_error);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_authenticate_add_device_id_error);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_authenticate_error);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_static_no_signed_device_id);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_static_bad_signed_device_id);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_static_signed_device_id);
	SUITE_ADD_TEST (suite, riot_key_manager_test_init_static_null);
	SUITE_ADD_TEST (suite, riot_key_manager_test_release_null);
	SUITE_ADD_TEST (suite, riot_key_manager_test_get_riot_keys_null);
	SUITE_ADD_TEST (suite, riot_key_manager_test_get_root_ca_null);
	SUITE_ADD_TEST (suite, riot_key_manager_test_get_intermediate_ca_null);
	SUITE_ADD_TEST (suite, riot_key_manager_test_verify_stored_certs_no_signed_device_id);
	SUITE_ADD_TEST (suite, riot_key_manager_test_verify_stored_certs_bad_signed_device_id);
	SUITE_ADD_TEST (suite, riot_key_manager_test_verify_stored_certs_signed_device_id);
	SUITE_ADD_TEST (suite, riot_key_manager_test_verify_stored_certs_intermediate_signed_device_id);
	SUITE_ADD_TEST (suite, riot_key_manager_test_verify_stored_certs_signed_device_id_no_root_ca);
	SUITE_ADD_TEST (suite, riot_key_manager_test_verify_stored_certs_signed_device_id_bad_root_ca);
	SUITE_ADD_TEST (suite,
		riot_key_manager_test_verify_stored_certs_signed_device_id_not_signed_by_root);
	SUITE_ADD_TEST (suite,
		riot_key_manager_test_verify_stored_certs_signed_device_id_not_sign_alias_cert);
	SUITE_ADD_TEST (suite,
		riot_key_manager_test_verify_stored_certs_intermediate_signed_device_id_no_ca);
	SUITE_ADD_TEST (suite,
		riot_key_manager_test_verify_stored_certs_intermediate_signed_device_id_bad_ca);
	SUITE_ADD_TEST (suite,
		riot_key_manager_test_verify_stored_certs_intermediate_signed_device_id_not_trusted);
	SUITE_ADD_TEST (suite, riot_key_manager_test_verify_stored_certs_riot_authentication_failed);
	SUITE_ADD_TEST (suite, riot_key_manager_test_verify_stored_certs_static);
	SUITE_ADD_TEST (suite, riot_key_manager_test_verify_stored_certs_null);
	SUITE_ADD_TEST (suite, riot_key_manager_test_verify_stored_certs_signed_device_id_load_error);
	SUITE_ADD_TEST (suite, riot_key_manager_test_verify_stored_certs_root_ca_load_error);
	SUITE_ADD_TEST (suite, riot_key_manager_test_verify_stored_certs_intermediate_ca_load_error);
	SUITE_ADD_TEST (suite, riot_key_manager_test_verify_stored_certs_load_alias_error);
	SUITE_ADD_TEST (suite, riot_key_manager_test_verify_stored_certs_init_cert_store_error);
	SUITE_ADD_TEST (suite, riot_key_manager_test_verify_stored_certs_add_root_ca_error);
	SUITE_ADD_TEST (suite, riot_key_manager_test_verify_stored_certs_add_intermediate_ca_error);
	SUITE_ADD_TEST (suite, riot_key_manager_test_verify_stored_certs_add_device_id_error);
	SUITE_ADD_TEST (suite, riot_key_manager_test_verify_stored_certs_authenticate_error);
	SUITE_ADD_TEST (suite, riot_key_manager_test_store_signed_device_id);
	SUITE_ADD_TEST (suite, riot_key_manager_test_store_signed_device_id_auth_chain_stored);
	SUITE_ADD_TEST (suite, riot_key_manager_test_store_signed_device_id_after_chain_verified);
	SUITE_ADD_TEST (suite, riot_key_manager_test_store_signed_device_id_null);
	SUITE_ADD_TEST (suite, riot_key_manager_test_store_signed_device_id_save_error);
	SUITE_ADD_TEST (suite, riot_key_manager_test_store_root_ca);
	SUITE_ADD_TEST (suite, riot_key_manager_test_store_root_ca_auth_chain_stored);
	SUITE_ADD_TEST (suite, riot_key_manager_test_store_root_ca_after_chain_verified);
	SUITE_ADD_TEST (suite, riot_key_manager_test_store_root_ca_null);
	SUITE_ADD_TEST (suite, riot_key_manager_test_store_root_ca_save_error);
	SUITE_ADD_TEST (suite, riot_key_manager_test_store_intermediate_ca);
	SUITE_ADD_TEST (suite, riot_key_manager_test_store_intermediate_ca_auth_chain_stored);
	SUITE_ADD_TEST (suite, riot_key_manager_test_store_intermediate_ca_after_chain_verified);
	SUITE_ADD_TEST (suite, riot_key_manager_test_store_intermediate_ca_null);
	SUITE_ADD_TEST (suite, riot_key_manager_test_store_intermediate_ca_save_error);
	SUITE_ADD_TEST (suite, riot_key_manager_test_release_riot_keys);
	SUITE_ADD_TEST (suite, riot_key_manager_test_release_riot_keys_null);
	SUITE_ADD_TEST (suite, riot_key_manager_test_erase_all_certificates);
	SUITE_ADD_TEST (suite, riot_key_manager_test_erase_all_certificates_none_stored);
	SUITE_ADD_TEST (suite, riot_key_manager_test_erase_all_certificates_null);
	SUITE_ADD_TEST (suite, riot_key_manager_test_erase_all_certificates_device_id_error);
	SUITE_ADD_TEST (suite, riot_key_manager_test_erase_all_certificates_root_ca_error);
	SUITE_ADD_TEST (suite, riot_key_manager_test_erase_all_certificates_intermediate_ca_error);
