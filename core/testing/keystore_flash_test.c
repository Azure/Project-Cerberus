...
CuSuite* get_keystore_flash_suite ()
{
	...
	SUITE_ADD_TEST (suite, keystore_flash_test_save_key_not_first_key);
	SUITE_ADD_TEST (suite, keystore_flash_test_save_key_null);
	SUITE_ADD_TEST (suite, keystore_flash_test_save_key_write_error);
	SUITE_ADD_TEST (suite, keystore_flash_test_load_key);
	SUITE_ADD_TEST (suite, keystore_flash_test_load_key_not_first_key);
	SUITE_ADD_TEST (suite, keystore_flash_test_load_key_backwards_compatibility);
	SUITE_ADD_TEST (suite, keystore_flash_test_load_key_backwards_compatibility_encrypted);
	SUITE_ADD_TEST (suite, keystore_flash_test_load_key_null);
	SUITE_ADD_TEST (suite, keystore_flash_test_load_key_bad_key);
	SUITE_ADD_TEST (suite, keystore_flash_test_load_key_no_key);
	SUITE_ADD_TEST (suite, keystore_flash_test_load_key_no_key_during_read);
