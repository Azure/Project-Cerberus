...
CuSuite* get_pfm_manager_suite ()
{
	...
	SUITE_ADD_TEST (suite, pfm_manager_test_on_clear_active_no_observers);
	SUITE_ADD_TEST (suite, pfm_manager_test_on_clear_active_one_observer);
	SUITE_ADD_TEST (suite, pfm_manager_test_on_clear_active_no_event_handler);
	SUITE_ADD_TEST (suite, pfm_manager_test_on_clear_active_null);
	...
	SUITE_ADD_TEST (suite, pfm_manager_test_get_id_measured_data_0_bytes_read);
	...
	SUITE_ADD_TEST (suite, pfm_manager_test_get_platform_id_measured_data_0_bytes_read);
	...
	SUITE_ADD_TEST (suite, pfm_manager_test_get_pfm_measured_data_sha384);
	SUITE_ADD_TEST (suite, pfm_manager_test_get_pfm_measured_data_sha512);
	...
	SUITE_ADD_TEST (suite, pfm_manager_test_get_pfm_measured_data_0_bytes_read);
