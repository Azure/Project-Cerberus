...
#include "firmware_component_testing.h"


static const char *SUITE = "firmware_component";
...
CuSuite* get_firmware_component_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, firmware_component_test_init);
	SUITE_ADD_TEST (suite, firmware_component_test_init_unknown_header_format_max_length);
	SUITE_ADD_TEST (suite, firmware_component_test_init_null);
	SUITE_ADD_TEST (suite, firmware_component_test_init_bad_marker);
	SUITE_ADD_TEST (suite, firmware_component_test_init_read_base_header_error);
	SUITE_ADD_TEST (suite, firmware_component_test_init_read_header_data_error);
	SUITE_ADD_TEST (suite, firmware_component_test_init_less_than_min_header_length);
	SUITE_ADD_TEST (suite, firmware_component_test_init_header_too_short);
	SUITE_ADD_TEST (suite, firmware_component_test_init_header_too_long);
	SUITE_ADD_TEST (suite, firmware_component_test_init_unknown_header_format_too_short);
	SUITE_ADD_TEST (suite, firmware_component_test_init_unknown_header_format_too_long);
	SUITE_ADD_TEST (suite, firmware_component_test_init_with_header);
	SUITE_ADD_TEST (suite,
		firmware_component_test_init_with_header_unknown_header_format_max_length);
	SUITE_ADD_TEST (suite, firmware_component_test_init_with_header_zero_length);
	SUITE_ADD_TEST (suite, firmware_component_test_init_with_header_null);
	SUITE_ADD_TEST (suite, firmware_component_test_init_with_header_bad_marker);
	SUITE_ADD_TEST (suite, firmware_component_test_init_with_header_read_base_header_error);
	SUITE_ADD_TEST (suite, firmware_component_test_init_with_header_read_header_data_error);
	SUITE_ADD_TEST (suite, firmware_component_test_init_with_header_less_than_min_header_length);
	SUITE_ADD_TEST (suite, firmware_component_test_init_with_header_header_too_short);
	SUITE_ADD_TEST (suite, firmware_component_test_init_with_header_header_too_long);
	SUITE_ADD_TEST (suite,
		firmware_component_test_init_with_header_unknown_header_format_too_short);
	SUITE_ADD_TEST (suite, firmware_component_test_init_with_header_unknown_header_format_too_long);
	SUITE_ADD_TEST (suite, firmware_component_test_release_null);
	SUITE_ADD_TEST (suite, firmware_component_test_get_length);
	SUITE_ADD_TEST (suite, firmware_component_test_get_length_with_header);
	SUITE_ADD_TEST (suite, firmware_component_test_get_length_with_header_zero_length);
	SUITE_ADD_TEST (suite, firmware_component_test_get_length_null);
	SUITE_ADD_TEST (suite, firmware_component_test_get_signature_length);
	SUITE_ADD_TEST (suite, firmware_component_test_get_signature_length_with_header);
	SUITE_ADD_TEST (suite, firmware_component_test_get_signature_length_with_header_zero_length);
	SUITE_ADD_TEST (suite, firmware_component_test_get_signature_length_null);
	SUITE_ADD_TEST (suite, firmware_component_test_get_signature);
	SUITE_ADD_TEST (suite, firmware_component_test_get_signature_with_header);
	SUITE_ADD_TEST (suite, firmware_component_test_get_signature_with_header_zero_length);
	SUITE_ADD_TEST (suite, firmware_component_test_get_signature_null);
	SUITE_ADD_TEST (suite, firmware_component_test_get_signature_small_sig_buffer);
	SUITE_ADD_TEST (suite, firmware_component_test_get_signature_read_error);
	SUITE_ADD_TEST (suite, firmware_component_test_get_hash);
	SUITE_ADD_TEST (suite, firmware_component_test_get_hash_with_header);
	SUITE_ADD_TEST (suite, firmware_component_test_get_hash_with_header_zero_length);
	SUITE_ADD_TEST (suite, firmware_component_test_get_hash_null);
	SUITE_ADD_TEST (suite, firmware_component_test_get_hash_small_buffer);
	SUITE_ADD_TEST (suite, firmware_component_test_get_hash_read_error);
	SUITE_ADD_TEST (suite, firmware_component_test_verification);
	SUITE_ADD_TEST (suite, firmware_component_test_verification_with_hash_out);
	SUITE_ADD_TEST (suite, firmware_component_test_verification_with_header);
	SUITE_ADD_TEST (suite, firmware_component_test_verification_with_header_zero_length);
	SUITE_ADD_TEST (suite, firmware_component_test_verification_null);
	SUITE_ADD_TEST (suite, firmware_component_test_verification_small_hash_buffer);
	SUITE_ADD_TEST (suite, firmware_component_test_verification_read_signature_error);
	SUITE_ADD_TEST (suite, firmware_component_test_verification_read_data_error);
	SUITE_ADD_TEST (suite, firmware_component_test_verification_verify_error);
	SUITE_ADD_TEST (suite, firmware_component_test_load);
	SUITE_ADD_TEST (suite, firmware_component_test_load_no_length_out);
	SUITE_ADD_TEST (suite, firmware_component_test_load_with_header);
	SUITE_ADD_TEST (suite, firmware_component_test_load_with_header_zero_length);
	SUITE_ADD_TEST (suite, firmware_component_test_load_null);
	SUITE_ADD_TEST (suite, firmware_component_test_load_image_too_large);
	SUITE_ADD_TEST (suite, firmware_component_test_load_image_error);
	SUITE_ADD_TEST (suite, firmware_component_test_get_image_end);
	SUITE_ADD_TEST (suite, firmware_component_test_get_image_end_with_header);
	SUITE_ADD_TEST (suite, firmware_component_test_get_image_end_with_header_zero_length);
	SUITE_ADD_TEST (suite, firmware_component_test_get_image_end_null);
	SUITE_ADD_TEST (suite, firmware_component_test_get_data_addr);
	SUITE_ADD_TEST (suite, firmware_component_test_get_data_addr_with_header);
	SUITE_ADD_TEST (suite, firmware_component_test_get_data_addr_with_header_zero_length);
	SUITE_ADD_TEST (suite, firmware_component_test_get_data_addr_null);
	SUITE_ADD_TEST (suite, firmware_component_test_load_and_verify);
	SUITE_ADD_TEST (suite, firmware_component_test_load_and_verify_no_hash_out);
	SUITE_ADD_TEST (suite, firmware_component_test_load_and_verify_no_length_out);
	SUITE_ADD_TEST (suite, firmware_component_test_load_and_verify_with_header);
	SUITE_ADD_TEST (suite, firmware_component_test_load_and_verify_with_header_zero_length);
	SUITE_ADD_TEST (suite, firmware_component_test_load_and_verify_null);
	SUITE_ADD_TEST (suite, firmware_component_test_load_and_verify_small_hash_buffer);
	SUITE_ADD_TEST (suite, firmware_component_test_load_and_verify_image_too_large);
	SUITE_ADD_TEST (suite, firmware_component_test_load_and_verify_image_error);
	SUITE_ADD_TEST (suite, firmware_component_test_load_and_verify_read_signature_error);
	SUITE_ADD_TEST (suite, firmware_component_test_load_and_verify_verify_error);
	SUITE_ADD_TEST (suite, firmware_component_test_load_and_verify_hash_start_error);
	SUITE_ADD_TEST (suite, firmware_component_test_load_and_verify_hash_header_info_error);
	SUITE_ADD_TEST (suite, firmware_component_test_load_and_verify_hash_header_data_error);
	SUITE_ADD_TEST (suite, firmware_component_test_load_and_verify_hash_image_error);
	SUITE_ADD_TEST (suite, firmware_component_test_load_and_verify_hash_finish_error);
	SUITE_ADD_TEST (suite,
		firmware_component_test_load_and_verify_with_header_read_extra_header_error);
	SUITE_ADD_TEST (suite,
		firmware_component_test_load_and_verify_with_header_hash_extra_header_error);
	SUITE_ADD_TEST (suite, firmware_component_test_copy);
	SUITE_ADD_TEST (suite, firmware_component_test_copy_no_length_out);
	SUITE_ADD_TEST (suite, firmware_component_test_copy_with_header);
	SUITE_ADD_TEST (suite, firmware_component_test_copy_with_header_zero_length);
	SUITE_ADD_TEST (suite, firmware_component_test_copy_null);
	SUITE_ADD_TEST (suite, firmware_component_test_copy_image_too_large);
	SUITE_ADD_TEST (suite, firmware_component_test_copy_erase_error);
	SUITE_ADD_TEST (suite, firmware_component_test_copy_copy_error);
	SUITE_ADD_TEST (suite, firmware_component_test_compare_and_copy);
	SUITE_ADD_TEST (suite, firmware_component_test_compare_and_copy_destination_matches);
	SUITE_ADD_TEST (suite, firmware_component_test_compare_and_copy_no_length_out);
	SUITE_ADD_TEST (suite, firmware_component_test_compare_and_copy_with_header);
	SUITE_ADD_TEST (suite,
		firmware_component_test_compare_and_copy_with_header_destination_matches);
	SUITE_ADD_TEST (suite, firmware_component_test_compare_and_copy_with_header_zero_length);
	SUITE_ADD_TEST (suite, firmware_component_test_compare_and_copy_null);
	SUITE_ADD_TEST (suite, firmware_component_test_compare_and_copy_image_too_large);
	SUITE_ADD_TEST (suite, firmware_component_test_compare_and_copy_compare_error);
	SUITE_ADD_TEST (suite, firmware_component_test_compare_and_copy_erase_error);
	SUITE_ADD_TEST (suite, firmware_component_test_compare_and_copy_copy_error);
