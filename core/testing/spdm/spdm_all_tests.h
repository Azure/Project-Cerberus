...
#endif
#if (defined TESTING_RUN_SPDM_CERTIFICATE_CHAIN_SUITE || \
		defined TESTING_RUN_ALL_TESTS || defined TESTING_RUN_ALL_CORE_TESTS || \
		(!defined TESTING_SKIP_ALL_TESTS && !defined TESTING_SKIP_ALL_CORE_TESTS)) && \
	!defined TESTING_SKIP_SPDM_CERTIFICATE_CHAIN_SUITE
	TESTING_RUN_SUITE (spdm_certificate_chain);
#endif
#if (defined TESTING_RUN_SPDM_CERTIFICATE_CHAIN_DICE_SUITE || \
		defined TESTING_RUN_ALL_TESTS || defined TESTING_RUN_ALL_CORE_TESTS || \
		(!defined TESTING_SKIP_ALL_TESTS && !defined TESTING_SKIP_ALL_CORE_TESTS)) && \
	!defined TESTING_SKIP_SPDM_CERTIFICATE_CHAIN_DICE_SUITE
	TESTING_RUN_SUITE (spdm_certificate_chain_dice);
#endif
...
#endif
#if (defined TESTING_RUN_SPDM_PERSISTENT_CONTEXT_SUITE || \
		defined TESTING_RUN_ALL_TESTS || defined TESTING_RUN_ALL_CORE_TESTS || \
		(!defined TESTING_SKIP_ALL_TESTS && !defined TESTING_SKIP_ALL_CORE_TESTS)) && \
	!defined TESTING_SKIP_SPDM_PERSISTENT_CONTEXT_SUITE
	TESTING_RUN_SUITE (spdm_persistent_context);
#endif
#if (defined TESTING_RUN_SPDM_PERSISTENT_CONTEXT_NO_SECURE_SESSION_SUITE || \
		defined TESTING_RUN_ALL_TESTS || defined TESTING_RUN_ALL_CORE_TESTS || \
		(!defined TESTING_SKIP_ALL_TESTS && !defined TESTING_SKIP_ALL_CORE_TESTS)) && \
	!defined TESTING_SKIP_SPDM_PERSISTENT_CONTEXT_NO_SECURE_SESSION_SUITE
	TESTING_RUN_SUITE (spdm_persistent_context_no_secure_session);
#endif
