...
static const char *SUITE = "rsa_thread_safe";
...
CuSuite* get_rsa_thread_safe_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, rsa_thread_safe_test_init);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_init_null);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_release_null);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_generate_key);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_generate_key_error);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_generate_key_null);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_init_private_key);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_init_private_key_error);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_init_private_key_null);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_init_public_key);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_init_public_key_error);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_init_public_key_null);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_release_key);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_release_key_null);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_get_private_key_der);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_get_private_key_der_error);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_get_private_key_der_null);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_get_public_key_der);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_get_public_key_der_error);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_get_public_key_der_null);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_decrypt);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_decrypt_error);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_decrypt_null);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_sig_verify);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_sig_verify_error);
	SUITE_ADD_TEST (suite, rsa_thread_safe_test_sig_verify_null);
