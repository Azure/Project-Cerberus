...
static const char *SUITE = "base64_riot";
...
CuSuite* get_base64_riot_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, base64_riot_test_init);
	SUITE_ADD_TEST (suite, base64_riot_test_init_null);
	SUITE_ADD_TEST (suite, base64_riot_test_release_null);
	SUITE_ADD_TEST (suite, base64_riot_test_encode);
	SUITE_ADD_TEST (suite, base64_riot_test_encode_pad_one_byte);
	SUITE_ADD_TEST (suite, base64_riot_test_encode_pad_two_bytes);
	SUITE_ADD_TEST (suite, base64_riot_test_encode_not_multiple_of_4);
	SUITE_ADD_TEST (suite, base64_riot_test_encode_null);
	SUITE_ADD_TEST (suite, base64_riot_test_encode_buffer_too_small);
