...
static const char *SUITE = "signature_verification_rsa";
...
CuSuite* get_signature_verification_rsa_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, signature_verification_rsa_test_init);
	SUITE_ADD_TEST (suite, signature_verification_rsa_test_init_null);
	SUITE_ADD_TEST (suite, signature_verification_rsa_test_release_null);
	SUITE_ADD_TEST (suite, signature_verification_rsa_test_verify_signature);
	SUITE_ADD_TEST (suite, signature_verification_rsa_test_verify_signature_bad_hash);
	SUITE_ADD_TEST (suite, signature_verification_rsa_test_verify_signature_bad_signature);
	SUITE_ADD_TEST (suite, signature_verification_rsa_test_verify_signature_null);
