...
static void host_processor_dual_test_run_time_verification_pending_pfm_no_active_dirty_init_error (
	CuTest *test)
{
	struct host_processor_dual_testing host;
	int status;
...
CuSuite* get_host_processor_dual_run_time_verification_suite ()
{
	...
	SUITE_ADD_TEST (suite,
		host_processor_dual_test_run_time_verification_pending_pfm_no_active_dirty_init_error);
	SUITE_ADD_TEST (suite,
