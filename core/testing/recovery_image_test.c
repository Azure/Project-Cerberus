...
static const char *SUITE = "recovery_image";
...
CuSuite* get_recovery_image_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, recovery_image_test_init);
	SUITE_ADD_TEST (suite, recovery_image_test_init_null);
	SUITE_ADD_TEST (suite, recovery_image_test_release_null);
	SUITE_ADD_TEST (suite, recovery_image_test_release_no_init);
	SUITE_ADD_TEST (suite, recovery_image_test_verify);
	SUITE_ADD_TEST (suite, recovery_image_test_verify_with_multiple_recovery_sections);
	SUITE_ADD_TEST (suite, recovery_image_test_verify_second_recovery_section_header_too_long);
	SUITE_ADD_TEST (suite, recovery_image_test_verify_image_length_too_long);
	SUITE_ADD_TEST (suite, recovery_image_test_verify_image_length_too_short);
	SUITE_ADD_TEST (suite, recovery_image_test_verify_section_image_length_too_long);
	SUITE_ADD_TEST (suite, recovery_image_test_verify_section_image_length_too_short);
	SUITE_ADD_TEST (suite, recovery_image_test_verify_bad_signature);
	SUITE_ADD_TEST (suite, recovery_image_test_verify_bad_signature_ecc_with_hash_out);
	SUITE_ADD_TEST (suite, recovery_image_test_verify_bad_signature_with_hash_out);
	SUITE_ADD_TEST (suite, recovery_image_test_verify_bad_hash);
	SUITE_ADD_TEST (suite, recovery_image_test_verify_null);
	SUITE_ADD_TEST (suite, recovery_image_test_verify_with_hash_out);
	SUITE_ADD_TEST (suite, recovery_image_test_verify_small_hash_buffer);
	...
	SUITE_ADD_TEST (suite, recovery_image_test_verify_read_error);
	SUITE_ADD_TEST (suite, recovery_image_test_verify_read_error_with_hash_out);
	SUITE_ADD_TEST (suite, recovery_image_test_verify_bad_magic_number);
	SUITE_ADD_TEST (suite, recovery_image_test_verify_section_address_overlap);
	SUITE_ADD_TEST (suite, recovery_image_test_verify_bad_recovery_image_header);
	SUITE_ADD_TEST (suite, recovery_image_test_get_hash);
	SUITE_ADD_TEST (suite, recovery_image_test_get_hash_after_verify);
	SUITE_ADD_TEST (suite, recovery_image_test_get_hash_after_verify_error);
	SUITE_ADD_TEST (suite, recovery_image_test_get_hash_after_verify_bad_signature);
	SUITE_ADD_TEST (suite, recovery_image_test_get_hash_after_verify_sig_read_error);
	SUITE_ADD_TEST (suite, recovery_image_test_get_hash_null);
	SUITE_ADD_TEST (suite, recovery_image_test_get_hash_small_hash_buffer);
	SUITE_ADD_TEST (suite, recovery_image_test_get_hash_read_error);
	SUITE_ADD_TEST (suite, recovery_image_test_get_hash_bad_magic_number);
	SUITE_ADD_TEST (suite, recovery_image_test_get_version_null);
	SUITE_ADD_TEST (suite, recovery_image_test_get_version);
	SUITE_ADD_TEST (suite, recovery_image_test_get_version_small_buffer);
	SUITE_ADD_TEST (suite, recovery_image_test_get_version_id_null);
	SUITE_ADD_TEST (suite, recovery_image_test_apply_to_flash);
	SUITE_ADD_TEST (suite, recovery_image_test_apply_to_flash_with_multiple_recovery_sections);
	SUITE_ADD_TEST (suite, recovery_image_test_apply_to_flash_section_image_length_too_short);
	SUITE_ADD_TEST (suite, recovery_image_test_apply_to_flash_section_image_length_too_long);
	SUITE_ADD_TEST (suite, recovery_image_test_apply_to_flash_bad_image_header);
	SUITE_ADD_TEST (suite, recovery_image_test_apply_to_flash_bad_section_header);
	SUITE_ADD_TEST (suite, recovery_image_test_apply_to_flash_read_data_error);
	SUITE_ADD_TEST (suite, recovery_image_test_apply_to_flash_null);
