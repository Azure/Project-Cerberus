...
#include "mock/cerberus_protocol_observer_mock.h"
...
CuSuite* get_cmd_interface_system_suite ()
{
	...
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_reserved_fields_not_zero);
	...
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_get_pfm_id_invalid_id);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_get_pfm_platform_id_port0_region0);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_get_pfm_platform_id_port0_region1);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_get_pfm_platform_id_port1_region0);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_get_pfm_platform_id_port1_region1);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_get_pfm_platform_id_port0_region0_null);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_get_pfm_platform_id_port0_region1_null);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_get_pfm_platform_id_port1_region0_null);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_get_pfm_platform_id_port1_region1_null);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_get_pfm_platform_id_no_active_pfm);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_get_pfm_platform_id_no_pending_pfm);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_get_pfm_platform_id_fail);
	...
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_get_cfm_id_invalid_id);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_get_cfm_platform_id_region0);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_get_cfm_platform_id_region1);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_get_cfm_platform_id_no_cfm);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_get_cfm_platform_id_no_cfm_manager);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_get_cfm_platform_id_fail);
	...
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_get_pcd_id_invalid_id);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_get_pcd_platform_id);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_get_pcd_platform_id_no_pcd);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_get_pcd_platform_id_no_pcd_manager);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_get_pcd_platform_id_fail);
	...
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_response_null);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_response_payload_too_short);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_response_unsupported_message);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_response_unknown_command);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_error_response);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_error_response_bad_len);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_response_reserved_fields_not_zero);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_response_encrypted_message);
	SUITE_ADD_TEST (suite,
		cmd_interface_system_test_process_response_encrypted_message_decrypt_fail);
	SUITE_ADD_TEST (suite,
		cmd_interface_system_test_process_response_encrypted_message_no_session_manager);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_response_get_certificate_digest);
	SUITE_ADD_TEST (suite,
		cmd_interface_system_test_process_response_get_certificate_digest_no_observer);
	SUITE_ADD_TEST (suite,
		cmd_interface_system_test_process_response_get_certificate_digest_invalid_buf_len);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_response_get_certificate);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_response_get_certificate_no_observer);
	SUITE_ADD_TEST (suite,
		cmd_interface_system_test_process_response_get_certificate_invalid_buf_len);
	SUITE_ADD_TEST (suite,
		cmd_interface_system_test_process_response_get_certificate_unsupported_slot);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_process_response_challenge_response);
	SUITE_ADD_TEST (suite,
		cmd_interface_system_test_process_response_challenge_response_no_observer);
	SUITE_ADD_TEST (suite,
		cmd_interface_system_test_process_response_challenge_response_invalid_buf_len);
	SUITE_ADD_TEST (suite,
		cmd_interface_system_test_process_response_challenge_response_unsupported_slot);
	SUITE_ADD_TEST (suite,
		cmd_interface_system_test_process_response_challenge_response_rsvd_not_fail);
	...
	SUITE_ADD_TEST (suite, cmd_interface_system_test_add_cerberus_protocol_observer_invalid_arg);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_remove_cerberus_protocol_observer);
	SUITE_ADD_TEST (suite, cmd_interface_system_test_remove_cerberus_protocol_observer_invalid_arg);
