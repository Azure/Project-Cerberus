...
CuSuite* get_riot_core_common_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	/* Run global setup for the test suite. */
	SUITE_ADD_TEST (suite, riot_core_common_testing_setup_suite);

	SUITE_ADD_TEST (suite, riot_core_common_test_init);
	SUITE_ADD_TEST (suite, riot_core_common_test_init_null);
	SUITE_ADD_TEST (suite, riot_core_common_test_release_null);
	SUITE_ADD_TEST (suite, riot_core_common_test_release_twice);
	SUITE_ADD_TEST (suite, riot_core_common_test_generate_device_id);
	SUITE_ADD_TEST (suite, riot_core_common_test_generate_device_id_null);
	SUITE_ADD_TEST (suite, riot_core_common_test_generate_device_id_cdi_hash_start_error);
	SUITE_ADD_TEST (suite, riot_core_common_test_generate_device_id_cdi_hash_first_byte_error);
	SUITE_ADD_TEST (suite, riot_core_common_test_generate_device_id_cdi_hash_error);
	SUITE_ADD_TEST (suite, riot_core_common_test_generate_device_id_cdi_hash_finish_error);
	SUITE_ADD_TEST (suite, riot_core_common_test_generate_device_id_key_pair_error);
	SUITE_ADD_TEST (suite, riot_core_common_test_generate_device_id_der_error);
	SUITE_ADD_TEST (suite, riot_core_common_test_generate_device_id_serial_hmac_error);
	SUITE_ADD_TEST (suite, riot_core_common_test_generate_device_id_subject_name_error);
	SUITE_ADD_TEST (suite, riot_core_common_test_generate_device_id_cert_error);
	SUITE_ADD_TEST (suite, riot_core_common_test_get_device_id_csr);
	SUITE_ADD_TEST (suite, riot_core_common_test_get_device_id_csr_with_oid);
	SUITE_ADD_TEST (suite, riot_core_common_test_get_device_id_csr_null);
	SUITE_ADD_TEST (suite, riot_core_common_test_get_device_id_csr_no_device_id);
	SUITE_ADD_TEST (suite, riot_core_common_test_get_device_id_csr_error);
	SUITE_ADD_TEST (suite, riot_core_common_test_get_device_id_cert);
	SUITE_ADD_TEST (suite, riot_core_common_test_get_device_id_cert_null);
	SUITE_ADD_TEST (suite, riot_core_common_test_get_device_id_cert_no_device_id);
	SUITE_ADD_TEST (suite, riot_core_common_test_get_device_id_cert_error);
	SUITE_ADD_TEST (suite, riot_core_common_test_generate_alias_key);
	SUITE_ADD_TEST (suite, riot_core_common_test_generate_alias_key_null);
	SUITE_ADD_TEST (suite, riot_core_common_test_generate_alias_key_invalid_fwid_hash);
	SUITE_ADD_TEST (suite, riot_core_common_test_generate_alias_key_no_device_id);
	SUITE_ADD_TEST (suite, riot_core_common_test_generate_alias_key_alias_kdf_error);
	SUITE_ADD_TEST (suite, riot_core_common_test_generate_alias_key_key_pair_error);
	SUITE_ADD_TEST (suite, riot_core_common_test_generate_alias_key_der_error);
	SUITE_ADD_TEST (suite, riot_core_common_test_generate_alias_key_serial_hmac_error);
	SUITE_ADD_TEST (suite, riot_core_common_test_generate_alias_key_subject_name_error);
	SUITE_ADD_TEST (suite, riot_core_common_test_generate_alias_key_cert_error);
	SUITE_ADD_TEST (suite, riot_core_common_test_get_alias_key);
	SUITE_ADD_TEST (suite, riot_core_common_test_get_alias_key_null);
	SUITE_ADD_TEST (suite, riot_core_common_test_get_alias_key_no_alias_key);
	SUITE_ADD_TEST (suite, riot_core_common_test_get_alias_key_cert);
	SUITE_ADD_TEST (suite, riot_core_common_test_get_alias_key_cert_null);
	SUITE_ADD_TEST (suite, riot_core_common_test_get_alias_key_cert_no_alias_key);
	SUITE_ADD_TEST (suite, riot_core_common_test_get_alias_key_cert_error);
	SUITE_ADD_TEST (suite, riot_core_common_test_authenticate_generated_keys);
