...
int kdf_testing_expect_hkdf_expand (struct hash_engine_mock *hash,
	enum hash_type hash_algo, const uint8_t *prk, size_t prk_length, const uint8_t *t,
...
static void kdf_test_nist800_108_counter_mode_null (CuTest *test)
{
	...
	status = kdf_nist800_108_counter_mode (&hash.base, HMAC_SHA256, KDF_TESTING_NIST800_108_CTR_KI,
		KDF_TESTING_NIST800_108_CTR_KI_LEN, NULL,
		KDF_TESTING_NIST800_108_CTR_LABEL_LEN, KDF_TESTING_NIST800_CTR_CONTEXT,
		KDF_TESTING_NIST800_CTR_CONTEXT_LEN, ko, sizeof (ko));
	CuAssertIntEquals (test, KDF_INVALID_ARGUMENT, status);
...
static void kdf_test_nist800_108_counter_mode_update_label_hmac_fail (CuTest *test)
{
	...
	status |= mock_expect (&hash.mock, hash.base.update, &hash, HASH_ENGINE_NO_MEMORY,
		MOCK_ARG_PTR_CONTAINS (KDF_TESTING_NIST800_108_CTR_LABEL,
			KDF_TESTING_NIST800_108_CTR_LABEL_LEN),
		MOCK_ARG (KDF_TESTING_NIST800_108_CTR_LABEL_LEN));
	status |= mock_expect (&hash.mock, hash.base.cancel, &hash, 0);
	CuAssertIntEquals (test, 0, status);
...
static void kdf_test_nist800_108_counter_mode_update_context_hmac_fail (CuTest *test)
{
	...
	status |= mock_expect (&hash.mock, hash.base.update, &hash, HASH_ENGINE_NO_MEMORY,
		MOCK_ARG_PTR_CONTAINS (KDF_TESTING_NIST800_CTR_CONTEXT,
			KDF_TESTING_NIST800_CTR_CONTEXT_LEN),
		MOCK_ARG (KDF_TESTING_NIST800_CTR_CONTEXT_LEN));
	status |= mock_expect (&hash.mock, hash.base.cancel, &hash, 0);
	CuAssertIntEquals (test, 0, status);
...
static void kdf_test_run_self_test_nist800_108_counter_mode_sha1 (CuTest *test)
{
	HASH_TESTING_ENGINE hash;
	int status;
	...
	status = kdf_run_self_test_nist800_108_counter_mode_sha1 (&hash.base);
#ifdef HASH_ENABLE_SHA1
	CuAssertIntEquals (test, 0, status);
#else
	CuAssertIntEquals (test, HASH_ENGINE_UNSUPPORTED_HASH, status);
...
#ifdef HASH_ENABLE_SHA1
static void kdf_test_run_self_test_nist800_108_counter_mode_sha1_ko_mismatch (CuTest *test)
{
	struct hash_engine_mock hash;
...
static void kdf_test_run_self_test_nist800_108_counter_mode_sha1_null (CuTest *test)
{
	HASH_TESTING_ENGINE hash;
	int status;
	...
	status = kdf_run_self_test_nist800_108_counter_mode_sha1 (NULL);
	CuAssertIntEquals (test, KDF_INVALID_ARGUMENT, status);

	HASH_TESTING_ENGINE_RELEASE (&hash);
}

static void kdf_test_run_self_test_nist800_108_counter_mode_sha1_kdf_fail (CuTest *test)
{
	struct hash_engine_mock hash;
	int status;
...
static void kdf_test_run_self_test_nist800_108_counter_mode_sha256 (CuTest *test)
{
	HASH_TESTING_ENGINE hash;
	int status;
	...
	status = kdf_run_self_test_nist800_108_counter_mode_sha256 (&hash.base);
	CuAssertIntEquals (test, 0, status);

	HASH_TESTING_ENGINE_RELEASE (&hash);
}

static void kdf_test_run_self_test_nist800_108_counter_mode_sha256_ko_mismatch (CuTest *test)
{
	struct hash_engine_mock hash;
...
static void kdf_test_run_self_test_nist800_108_counter_mode_sha256_null (CuTest *test)
{
	HASH_TESTING_ENGINE hash;
	int status;
	...
	status = kdf_run_self_test_nist800_108_counter_mode_sha256 (NULL);
	CuAssertIntEquals (test, KDF_INVALID_ARGUMENT, status);

	HASH_TESTING_ENGINE_RELEASE (&hash);
}

static void kdf_test_run_self_test_nist800_108_counter_mode_sha256_kdf_fail (CuTest *test)
{
	struct hash_engine_mock hash;
	int status;
...
static void kdf_test_run_self_test_nist800_108_counter_mode_sha384 (CuTest *test)
{
	HASH_TESTING_ENGINE hash;
	int status;
	...
	status = kdf_run_self_test_nist800_108_counter_mode_sha384 (&hash.base);
#ifdef HASH_ENABLE_SHA384
	CuAssertIntEquals (test, 0, status);
#else
	CuAssertIntEquals (test, HASH_ENGINE_UNSUPPORTED_HASH, status);
...
#ifdef HASH_ENABLE_SHA384
static void kdf_test_run_self_test_nist800_108_counter_mode_sha384_ko_mismatch (CuTest *test)
{
	struct hash_engine_mock hash;
...
static void kdf_test_run_self_test_nist800_108_counter_mode_sha384_null (CuTest *test)
{
	HASH_TESTING_ENGINE hash;
	int status;
	...
	status = kdf_run_self_test_nist800_108_counter_mode_sha384 (NULL);
	CuAssertIntEquals (test, KDF_INVALID_ARGUMENT, status);

	HASH_TESTING_ENGINE_RELEASE (&hash);
}

static void kdf_test_run_self_test_nist800_108_counter_mode_sha384_kdf_fail (CuTest *test)
{
	struct hash_engine_mock hash;
	int status;
...
static void kdf_test_run_self_test_nist800_108_counter_mode_sha512 (CuTest *test)
{
	HASH_TESTING_ENGINE hash;
	int status;
	...
	status = kdf_run_self_test_nist800_108_counter_mode_sha512 (&hash.base);
...
#ifdef HASH_ENABLE_SHA512
static void kdf_test_run_self_test_nist800_108_counter_mode_sha512_ko_mismatch (CuTest *test)
{
	struct hash_engine_mock hash;
...
static void kdf_test_run_self_test_nist800_108_counter_mode_sha512_null (CuTest *test)
{
	HASH_TESTING_ENGINE hash;
	int status;
	...
	status = kdf_run_self_test_nist800_108_counter_mode_sha512 (NULL);
	CuAssertIntEquals (test, KDF_INVALID_ARGUMENT, status);

	HASH_TESTING_ENGINE_RELEASE (&hash);
}

static void kdf_test_run_self_test_nist800_108_counter_mode_sha512_kdf_fail (CuTest *test)
{
	struct hash_engine_mock hash;
	int status;
...
static void kdf_test_run_self_test_hkdf_expand_sha1 (CuTest *test)
{
	HASH_TESTING_ENGINE hash;
	int status;
	...
	status = kdf_run_self_test_hkdf_expand_sha1 (&hash.base);
#ifdef HASH_ENABLE_SHA1
	CuAssertIntEquals (test, 0, status);
#else
	CuAssertIntEquals (test, HASH_ENGINE_UNSUPPORTED_HASH, status);
...
#ifdef HASH_ENABLE_SHA1
static void kdf_test_run_self_test_hkdf_expand_sha1_okm_mismatch (CuTest *test)
{
	struct hash_engine_mock hash;
...
static void kdf_test_run_self_test_hkdf_expand_sha1_null (CuTest *test)
{
	HASH_TESTING_ENGINE hash;
	int status;
	...
	status = kdf_run_self_test_hkdf_expand_sha1 (NULL);
	CuAssertIntEquals (test, KDF_INVALID_ARGUMENT, status);

	HASH_TESTING_ENGINE_RELEASE (&hash);
}

static void kdf_test_run_self_test_hkdf_expand_sha1_kdf_fail (CuTest *test)
{
	struct hash_engine_mock hash;
	int status;
...
static void kdf_test_run_self_test_hkdf_expand_sha256 (CuTest *test)
{
	HASH_TESTING_ENGINE hash;
	int status;
	...
	status = kdf_run_self_test_hkdf_expand_sha256 (&hash.base);
	CuAssertIntEquals (test, 0, status);

	HASH_TESTING_ENGINE_RELEASE (&hash);
}

static void kdf_test_run_self_test_hkdf_expand_sha256_okm_mismatch (CuTest *test)
{
	struct hash_engine_mock hash;
...
static void kdf_test_run_self_test_hkdf_expand_sha256_null (CuTest *test)
{
	HASH_TESTING_ENGINE hash;
	int status;
	...
	status = kdf_run_self_test_hkdf_expand_sha256 (NULL);
	CuAssertIntEquals (test, KDF_INVALID_ARGUMENT, status);

	HASH_TESTING_ENGINE_RELEASE (&hash);
}

static void kdf_test_run_self_test_hkdf_expand_sha256_kdf_fail (CuTest *test)
{
	struct hash_engine_mock hash;
	int status;
...
static void kdf_test_run_self_test_hkdf_expand_sha384 (CuTest *test)
{
	HASH_TESTING_ENGINE hash;
	int status;
	...
	status = kdf_run_self_test_hkdf_expand_sha384 (&hash.base);
#ifdef HASH_ENABLE_SHA384
	CuAssertIntEquals (test, 0, status);
#else
	CuAssertIntEquals (test, HASH_ENGINE_UNSUPPORTED_HASH, status);
...
#ifdef HASH_ENABLE_SHA384
static void kdf_test_run_self_test_hkdf_expand_sha384_okm_mismatch (CuTest *test)
{
	struct hash_engine_mock hash;
...
static void kdf_test_run_self_test_hkdf_expand_sha384_null (CuTest *test)
{
	HASH_TESTING_ENGINE hash;
	int status;
	...
	status = kdf_run_self_test_hkdf_expand_sha384 (NULL);
	CuAssertIntEquals (test, KDF_INVALID_ARGUMENT, status);

	HASH_TESTING_ENGINE_RELEASE (&hash);
}

static void kdf_test_run_self_test_hkdf_expand_sha384_kdf_fail (CuTest *test)
{
	struct hash_engine_mock hash;
	int status;
...
static void kdf_test_run_self_test_hkdf_expand_sha512 (CuTest *test)
{
	HASH_TESTING_ENGINE hash;
	int status;
	...
	status = kdf_run_self_test_hkdf_expand_sha512 (&hash.base);
#ifdef HASH_ENABLE_SHA512
	CuAssertIntEquals (test, 0, status);
#else
	CuAssertIntEquals (test, HASH_ENGINE_UNSUPPORTED_HASH, status);
...
#ifdef HASH_ENABLE_SHA512
static void kdf_test_run_self_test_hkdf_expand_sha512_okm_mismatch (CuTest *test)
{
	struct hash_engine_mock hash;
...
static void kdf_test_run_self_test_hkdf_expand_sha512_null (CuTest *test)
{
	HASH_TESTING_ENGINE hash;
	int status;
	...
	status = kdf_run_self_test_hkdf_expand_sha512 (NULL);
	CuAssertIntEquals (test, KDF_INVALID_ARGUMENT, status);

	HASH_TESTING_ENGINE_RELEASE (&hash);
}

static void kdf_test_run_self_test_hkdf_expand_sha512_kdf_fail (CuTest *test)
{
	struct hash_engine_mock hash;
	int status;
...
TEST (kdf_test_run_self_test_nist800_108_counter_mode_sha1);
#ifdef HASH_ENABLE_SHA1
TEST (kdf_test_run_self_test_nist800_108_counter_mode_sha1_ko_mismatch);
TEST (kdf_test_run_self_test_nist800_108_counter_mode_sha1_null);
TEST (kdf_test_run_self_test_nist800_108_counter_mode_sha1_kdf_fail);
#endif
TEST (kdf_test_run_self_test_nist800_108_counter_mode_sha256);
TEST (kdf_test_run_self_test_nist800_108_counter_mode_sha256_ko_mismatch);
TEST (kdf_test_run_self_test_nist800_108_counter_mode_sha256_null);
TEST (kdf_test_run_self_test_nist800_108_counter_mode_sha256_kdf_fail);
TEST (kdf_test_run_self_test_nist800_108_counter_mode_sha384);
#ifdef HASH_ENABLE_SHA384
TEST (kdf_test_run_self_test_nist800_108_counter_mode_sha384_ko_mismatch);
TEST (kdf_test_run_self_test_nist800_108_counter_mode_sha384_null);
TEST (kdf_test_run_self_test_nist800_108_counter_mode_sha384_kdf_fail);
#endif
TEST (kdf_test_run_self_test_nist800_108_counter_mode_sha512);
#ifdef HASH_ENABLE_SHA512
TEST (kdf_test_run_self_test_nist800_108_counter_mode_sha512_ko_mismatch);
TEST (kdf_test_run_self_test_nist800_108_counter_mode_sha512_null);
TEST (kdf_test_run_self_test_nist800_108_counter_mode_sha512_kdf_fail);
#endif
...
TEST (kdf_test_run_self_test_hkdf_expand_sha1);
#ifdef HASH_ENABLE_SHA1
TEST (kdf_test_run_self_test_hkdf_expand_sha1_okm_mismatch);
TEST (kdf_test_run_self_test_hkdf_expand_sha1_null);
TEST (kdf_test_run_self_test_hkdf_expand_sha1_kdf_fail);
#endif
TEST (kdf_test_run_self_test_hkdf_expand_sha256);
TEST (kdf_test_run_self_test_hkdf_expand_sha256_okm_mismatch);
TEST (kdf_test_run_self_test_hkdf_expand_sha256_null);
TEST (kdf_test_run_self_test_hkdf_expand_sha256_kdf_fail);
TEST (kdf_test_run_self_test_hkdf_expand_sha384);
#ifdef HASH_ENABLE_SHA384
TEST (kdf_test_run_self_test_hkdf_expand_sha384_okm_mismatch);
TEST (kdf_test_run_self_test_hkdf_expand_sha384_null);
TEST (kdf_test_run_self_test_hkdf_expand_sha384_kdf_fail);
#endif
TEST (kdf_test_run_self_test_hkdf_expand_sha512);
#ifdef HASH_ENABLE_SHA512
TEST (kdf_test_run_self_test_hkdf_expand_sha512_okm_mismatch);
TEST (kdf_test_run_self_test_hkdf_expand_sha512_null);
TEST (kdf_test_run_self_test_hkdf_expand_sha512_kdf_fail);
#endif
