...
extern const size_t AES_CBC_TESTING_SINGLE_BLOCK_KEY_LEN;
...
extern const size_t AES_CBC_TESTING_MULTI_BLOCK_KEY_LEN;
...
extern const size_t AES_CBC_TESTING_LONG_DATA_KEY_LEN;
