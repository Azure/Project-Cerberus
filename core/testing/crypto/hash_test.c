...
static void hash_test_hmac_sha1_incremental_large_key (CuTest *test)
{
	...
	uint8_t expected[] = {
		...
		0x3a, 0x90, 0xc8, 0x36, 0xe1, 0xed, 0x76, 0x7f,
		0xa3, 0x67, 0x51, 0x31
	};
	struct hmac_engine hmac_engine;
	int i;
...
static void hash_test_hmac_sha384_incremental (CuTest *test)
{
	...
	uint8_t expected[] = {
		...
		0x73, 0x8e, 0xea, 0x4f, 0x3e, 0x0c, 0x5d, 0x3f,
		0x6b, 0x60, 0x4d, 0x7b, 0x32, 0xb6, 0xa2, 0xe8,
		0xb0, 0xeb, 0x4e, 0x4e, 0x7f, 0xc9, 0x52, 0x7b,
		0xc6, 0x04, 0x44, 0xf2, 0x04, 0x7e, 0xac, 0xc1,
		0xec, 0x88, 0x0b, 0xff, 0xd0, 0xb1, 0xc1, 0xf2
	};
	struct hmac_engine hmac_engine;
...
static void hash_test_hmac_sha384_incremental_large_key (CuTest *test)
{
	...
	uint8_t expected[] = {
		...
		0x48, 0x98, 0xf4, 0xc6, 0x3b, 0xa3, 0x45, 0x29,
		0x3b, 0x1e, 0x50, 0x5c, 0x90, 0x9c, 0xd3, 0x00,
		0x70, 0xc9, 0x90, 0x18, 0xe2, 0xa1, 0x3f, 0xec,
		0x54, 0xaf, 0x70, 0x65, 0xc5, 0x3b, 0x97, 0xf7,
		0x63, 0x30, 0x9e, 0x28, 0xd1, 0xcf, 0x1f, 0x0f
	};
	struct hmac_engine hmac_engine;
	int i;
...
static void hash_test_hmac_sha512_incremental (CuTest *test)
{
	...
	uint8_t expected[] = {
		...
		0x8b, 0x51, 0xfa, 0xcb, 0x76, 0x79, 0xaf, 0x47,
		0xea, 0x35, 0xbf, 0xea, 0xb9, 0x1b, 0x34, 0xd0,
		0x9e, 0x0a, 0xac, 0xc9, 0xde, 0x64, 0x80, 0x60,
		0x29, 0x8d, 0x86, 0xd5, 0x47, 0x9d, 0x4e, 0xb5,
		0x68, 0xdf, 0xe0, 0xea, 0xb6, 0x2c, 0x0e, 0x4a,
		0x47, 0x90, 0x7e, 0x28, 0x09, 0xb8, 0x4b, 0x21,
		0xdd, 0x6b, 0xc7, 0x41, 0xca, 0x09, 0x00, 0x3a
	};
	struct hmac_engine hmac_engine;
...
static void hash_test_hmac_sha512_incremental_large_key (CuTest *test)
{
	...
	uint8_t expected[] = {
		...
		0x10, 0x48, 0xc2, 0x96, 0x78, 0xe1, 0x07, 0x95,
		0x33, 0xa1, 0x47, 0x37, 0x5b, 0x1e, 0xdd, 0x2d,
		0x5f, 0xa4, 0xbc, 0xf6, 0x22, 0x40, 0x9f, 0x96,
		0x4b, 0x54, 0x59, 0xab, 0xaa, 0x6f, 0x7b, 0x58,
		0x56, 0x14, 0xe1, 0x78, 0x6b, 0x0e, 0xd8, 0xf7,
		0x75, 0x45, 0xcb, 0x90, 0x1d, 0xd6, 0xd6, 0x12,
		0xc2, 0x33, 0xb2, 0x53, 0xb3, 0x17, 0x05, 0x5d
	};
	struct hmac_engine hmac_engine;
	int i;
