...
#endif
#if (defined TESTING_RUN_FIRMWARE_UPDATE_OBSERVER_TDISP_SUITE || \
		defined TESTING_RUN_ALL_TESTS || defined TESTING_RUN_ALL_CORE_TESTS || \
		(!defined TESTING_SKIP_ALL_TESTS && !defined TESTING_SKIP_ALL_CORE_TESTS)) && \
	!defined TESTING_SKIP_FIRMWARE_UPDATE_OBSERVER_TDISP_SUITE
	TESTING_RUN_SUITE (firmware_update_observer_tdisp);
#endif
...
#endif
#if (defined TESTING_RUN_TDISP_TDI_CONTEXT_MANAGER_SUITE || \
		defined TESTING_RUN_ALL_TESTS || defined TESTING_RUN_ALL_CORE_TESTS || \
		(!defined TESTING_SKIP_ALL_TESTS && !defined TESTING_SKIP_ALL_CORE_TESTS)) && \
	!defined TESTING_SKIP_TDISP_TDI_CONTEXT_MANAGER_SUITE
	TESTING_RUN_SUITE (tdisp_tdi_context_manager);
#endif
}
