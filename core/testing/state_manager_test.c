...
static const char *SUITE = "state_manager";
...
CuSuite* get_state_manager_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, state_manager_test_init);
	SUITE_ADD_TEST (suite, state_manager_test_init_sector_not_4k);
	SUITE_ADD_TEST (suite, state_manager_test_init_find_latest_state);
	SUITE_ADD_TEST (suite, state_manager_test_init_find_latest_state_sector_not_4k);
	SUITE_ADD_TEST (suite, state_manager_test_init_find_latest_state_second_sector);
	SUITE_ADD_TEST (suite, state_manager_test_init_find_latest_state_second_sector_sector_not_4k);
	SUITE_ADD_TEST (suite, state_manager_test_init_find_latest_state_last_byte);
	SUITE_ADD_TEST (suite, state_manager_test_init_find_latest_state_last_byte_sector_not_4k);
	SUITE_ADD_TEST (suite, state_manager_test_init_find_latest_state_first_sector_low_state_count);
	SUITE_ADD_TEST (suite, state_manager_test_init_not_block_aligned);
	SUITE_ADD_TEST (suite, state_manager_test_init_not_block_aligned_sector_not_4k);
	SUITE_ADD_TEST (suite, state_manager_test_init_find_latest_state_updated_format);
	SUITE_ADD_TEST (suite, state_manager_test_init_find_latest_state_updated_format_sector_not_4k);
	SUITE_ADD_TEST (suite, state_manager_test_init_find_latest_state_second_sector_updated_format);
	SUITE_ADD_TEST (suite,
		state_manager_test_init_find_latest_state_second_sector_updated_format_sector_not_4k);
	SUITE_ADD_TEST (suite, state_manager_test_init_find_latest_state_last_entry_updated_format);
	SUITE_ADD_TEST (suite,
		state_manager_test_init_find_latest_state_last_entry_updated_format_sector_not_4k);
	SUITE_ADD_TEST (suite, state_manager_test_init_find_latest_state_updated_format_bit_errors);
	SUITE_ADD_TEST (suite,
		state_manager_test_init_find_latest_state_updated_format_bit_error_on_type);
	SUITE_ADD_TEST (suite,
		state_manager_test_init_find_latest_state_updated_format_double_bit_error_fakes_blank);
	SUITE_ADD_TEST (suite,
		state_manager_test_init_find_latest_state_updated_format_triple_bit_error_fakes_blank);
	SUITE_ADD_TEST (suite,
		state_manager_test_init_find_latest_state_updated_format_bit_error_both_types_cleared);
	SUITE_ADD_TEST (suite, state_manager_test_init_find_latest_state_both_formats);
	SUITE_ADD_TEST (suite, state_manager_test_init_find_latest_state_both_formats_second_sector);
	SUITE_ADD_TEST (suite, state_manager_test_init_null);
	SUITE_ADD_TEST (suite, state_manager_test_init_sector_size_error);
	SUITE_ADD_TEST (suite, state_manager_test_init_not_sector_aligned);
	SUITE_ADD_TEST (suite, state_manager_test_init_not_sector_aligned_sector_not_4k);
	SUITE_ADD_TEST (suite, state_manager_test_init_read_error_first_sector);
	SUITE_ADD_TEST (suite, state_manager_test_init_read_error_second_sector);
	SUITE_ADD_TEST (suite, state_manager_test_init_find_state_read_error);
	SUITE_ADD_TEST (suite, state_manager_test_init_find_state_read_second_sector_error);
	SUITE_ADD_TEST (suite, state_manager_test_init_find_state_low_state_count_read_error);
	SUITE_ADD_TEST (suite,
		state_manager_test_init_find_state_low_state_count_second_sector_read_error);
	SUITE_ADD_TEST (suite, state_manager_test_init_find_state_updated_format_read_error);
	SUITE_ADD_TEST (suite,
		state_manager_test_init_find_state_updated_format_second_sector_read_error);
	SUITE_ADD_TEST (suite, state_manager_test_init_erase_error);
	SUITE_ADD_TEST (suite, state_manager_test_release_null);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_sector_not_4k);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_not_first);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_not_first_sector_not_4k);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_second_sector);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_second_sector_sector_not_4k);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_same_state);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_store_change_twice);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_multiple_changes);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_wrap_to_second_sector);
	SUITE_ADD_TEST (suite,
		state_manager_test_store_non_volatile_state_wrap_to_second_sector_sector_not_4k);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_wrap_to_first_sector);
	SUITE_ADD_TEST (suite,
		state_manager_test_store_non_volatile_state_wrap_to_first_sector_sector_not_4k);
	SUITE_ADD_TEST (suite,
		state_manager_test_store_non_volatile_state_write_twice_second_not_blank);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_write_twice_first_not_blank);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_wrap_to_second_then_first);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_wrap_to_first_then_second);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_upgrade_to_sector2);
	SUITE_ADD_TEST (suite,
		state_manager_test_store_non_volatile_state_upgrade_to_sector2_sector_not_4k);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_upgrade_to_sector1);
	SUITE_ADD_TEST (suite,
		state_manager_test_store_non_volatile_state_upgrade_to_sector1_sector_not_4k);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_upgrade_sector1_full);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_bit_errors);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_reserved_bits);
	SUITE_ADD_TEST (suite,
		state_manager_test_store_non_volatile_state_double_bit_error_fakes_blank);
	SUITE_ADD_TEST (suite,
		state_manager_test_store_non_volatile_state_triple_bit_error_fakes_blank);
	SUITE_ADD_TEST (suite,
		state_manager_test_store_non_volatile_state_double_bit_error_fakes_blank_not_latest);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_same_state_flash_different);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_same_state_bit_error);
	SUITE_ADD_TEST (suite,
		state_manager_test_store_non_volatile_state_same_state_bit_error_on_entry_marker);
	SUITE_ADD_TEST (suite,
		state_manager_test_store_non_volatile_state_same_state_bit_error_on_entry_marker_sector_not_4k);
	SUITE_ADD_TEST (suite,
		state_manager_test_store_non_volatile_state_same_state_bit_error_on_entry_marker_sector2);
	SUITE_ADD_TEST (suite,
		state_manager_test_store_non_volatile_state_same_state_bit_error_on_entry_marker_sector2_sector_not_4k);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_null);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_write_error);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_incomplete_write);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_sector1_erase_error);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_sector2_erase_error);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_none_blank);
	SUITE_ADD_TEST (suite,
		state_manager_test_store_non_volatile_state_last_entry_second_sector_not_blank);
	SUITE_ADD_TEST (suite,
		state_manager_test_store_non_volatile_state_last_entry_second_sector_not_blank_sector_not_4k);
	SUITE_ADD_TEST (suite,
		state_manager_test_store_non_volatile_state_last_entry_first_sector_not_blank);
	SUITE_ADD_TEST (suite,
		state_manager_test_store_non_volatile_state_last_entry_first_sector_not_blank_sector_not_4k);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_same_state_read_error);
	SUITE_ADD_TEST (suite, state_manager_test_store_non_volatile_state_after_blocking);
	SUITE_ADD_TEST (suite, state_manager_test_block_non_volatile_state_storage_null);
