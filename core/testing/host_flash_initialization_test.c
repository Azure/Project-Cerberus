...
static const char *SUITE = "host_flash_initialization";
...
CuSuite* get_host_flash_initialization_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, host_flash_initialization_test_init);
	SUITE_ADD_TEST (suite, host_flash_initialization_test_init_null);
	SUITE_ADD_TEST (suite, host_flash_initialization_test_init_single_flash);
	SUITE_ADD_TEST (suite, host_flash_initialization_test_init_single_flash_null);
	SUITE_ADD_TEST (suite, host_flash_initialization_test_release_null);
	SUITE_ADD_TEST (suite, host_flash_initialization_test_initialize_flash);
	SUITE_ADD_TEST (suite, host_flash_initialization_test_initialize_flash_fast_read);
	SUITE_ADD_TEST (suite, host_flash_initialization_test_initialize_flash_drive_strength);
	SUITE_ADD_TEST (suite, host_flash_initialization_test_initialize_flash_twice);
	SUITE_ADD_TEST (suite, host_flash_initialization_test_initialize_flash_single_flash);
	SUITE_ADD_TEST (suite, host_flash_initialization_test_initialize_flash_null);
	SUITE_ADD_TEST (suite, host_flash_initialization_test_initialize_flash_cs0_error);
	SUITE_ADD_TEST (suite, host_flash_initialization_test_initialize_flash_cs1_error);
