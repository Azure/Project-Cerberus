...
#include "testing/aes_testing.h"


static const char *SUITE = "flash_store_encrypted";
...
CuSuite* get_flash_store_encrypted_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, flash_store_encrypted_test_init_fixed_storage);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_fixed_storage_one_sector_per_block_max_space);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_fixed_storage_multiple_sector_per_block_max_space);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_fixed_storage_data_not_sector_aligned_max_space);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_fixed_storage_extra_sector_for_tag_max_space);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_init_fixed_storage_max_data);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_init_fixed_storage_null);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_init_fixed_storage_no_data);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_init_fixed_storage_block_too_large);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_init_fixed_storage_sector_size_error);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_init_fixed_storage_not_sector_aligned);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_init_fixed_storage_device_size_error);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_init_fixed_storage_base_out_of_range);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_fixed_storage_one_sector_per_block_not_enough_space);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_fixed_storage_multiple_sector_per_block_not_enough_space);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_fixed_storage_decreasing_multiple_sector_per_block_max_space);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_fixed_storage_decreasing_data_not_sector_aligned_max_space);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_fixed_storage_decreasing_extra_sector_for_tag_max_space);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_init_fixed_storage_decreasing_max_data);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_init_fixed_storage_decreasing_null);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_init_fixed_storage_decreasing_no_data);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_fixed_storage_decreasing_block_too_large);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_fixed_storage_decreasing_sector_size_error);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_fixed_storage_decreasing_not_sector_aligned);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_fixed_storage_decreasing_device_size_error);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_fixed_storage_decreasing_base_out_of_range);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_fixed_storage_decreasing_one_sector_per_block_not_enough_space);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_fixed_storage_decreasing_multiple_sector_per_block_not_enough_space);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_variable_storage_multiple_sector_per_block_max_space);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_variable_storage_data_not_sector_aligned_max_space);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_variable_storage_extra_sector_for_tag_max_space);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_variable_storage_extra_sector_for_header_max_space);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_init_variable_storage_max_data);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_init_variable_storage_null);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_init_variable_storage_no_data);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_init_variable_storage_block_too_large);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_init_variable_storage_sector_size_error);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_init_variable_storage_not_sector_aligned);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_init_variable_storage_device_size_error);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_init_variable_storage_base_out_of_range);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_variable_storage_one_sector_per_block_not_enough_space);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_variable_storage_multiple_sector_per_block_not_enough_space);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_variable_storage_data_not_sector_aligned_not_enough_space);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_variable_storage_extra_sector_for_tag_not_enough_space);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_variable_storage_decreasing_multiple_sector_per_block_max_space);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_variable_storage_decreasing_data_not_sector_aligned_max_space);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_variable_storage_decreasing_extra_sector_for_tag_max_space);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_variable_storage_decreasing_extra_sector_for_header_max_space);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_init_variable_storage_decreasing_max_data);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_init_variable_storage_decreasing_null);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_init_variable_storage_decreasing_no_data);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_variable_storage_decreasing_block_too_large);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_variable_storage_decreasing_sector_size_error);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_variable_storage_decreasing_not_sector_aligned);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_variable_storage_decreasing_device_size_error);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_variable_storage_decreasing_base_out_of_range);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_variable_storage_decreasing_one_sector_per_block_not_enough_space);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_variable_storage_decreasing_multiple_sector_per_block_not_enough_space);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_variable_storage_decreasing_data_not_sector_aligned_not_enough_space);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_init_variable_storage_decreasing_extra_sector_for_tag_not_enough_space);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_write_fixed_storage_multiple_sectors_last_block);
	...
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_write_fixed_storage_decreasing_multiple_sectors);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_write_fixed_storage_decreasing_multiple_sectors_last_block);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_write_variable_storage_old_header);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_write_variable_storage_multiple_sectors);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_write_variable_storage_multiple_sectors_last_block);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_write_variable_storage_extra_sector_for_header);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_write_variable_storage_extra_sector_for_header_last_block);
	...
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_write_variable_storage_decreasing_old_header);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_write_variable_storage_decreasing_multiple_sectors);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_write_variable_storage_decreasing_multiple_sectors_last_block);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_write_variable_storage_decreasing_extra_sector_for_header);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_write_variable_storage_decreasing_extra_sector_for_header_last_block);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_write_fixed_storage_iv_error);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_write_fixed_storage_encrypt_error);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_write_fixed_storage_erase_error);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_write_fixed_storage_write_error);
	...
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_write_variable_storage_iv_error);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_write_variable_storage_encrypt_error);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_write_variable_storage_erase_error);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_write_variable_storage_write_error);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_write_variable_storage_verify_error);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_write_variable_storage_write_tag_error);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_write_variable_storage_verify_tag_error);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_write_variable_storage_write_header_error);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_write_variable_storage_verify_header_error);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_fixed_storage_corrupt_data);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_fixed_storage_multiple_sectors);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_read_fixed_storage_multiple_sectors_last_block);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_fixed_storage_extra_sector_for_tag);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_read_fixed_storage_extra_sector_for_tag_last_block);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_fixed_storage_decreasing);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_fixed_storage_decreasing_last_block);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_fixed_storage_decreasing_large_buffer);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_fixed_storage_decreasing_corrupt_data);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_read_fixed_storage_decreasing_multiple_sectors);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_read_fixed_storage_decreasing_multiple_sectors_last_block);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_read_fixed_storage_decreasing_extra_sector_for_tag);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_read_fixed_storage_decreasing_extra_sector_for_tag_last_block);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_variable_storage);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_variable_storage_last_block);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_variable_storage_corrupt_data);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_variable_storage_max_length);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_variable_storage_min_length);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_variable_storage_multiple_sectors);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_read_variable_storage_multiple_sectors_last_block);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_read_variable_storage_extra_sector_for_header);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_read_variable_storage_extra_sector_for_header_last_block);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_variable_storage_extra_sector_for_tag);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_read_variable_storage_extra_sector_for_tag_last_block);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_variable_storage_longer_header);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_variable_storage_old_format);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_variable_storage_decreasing);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_variable_storage_decreasing_last_block);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_read_variable_storage_decreasing_corrupt_data);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_variable_storage_decreasing_max_length);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_variable_storage_decreasing_min_length);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_read_variable_storage_decreasing_multiple_sectors);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_read_variable_storage_decreasing_multiple_sectors_last_block);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_read_variable_storage_decreasing_extra_sector_for_header);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_read_variable_storage_decreasing_extra_sector_for_header_last_block);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_read_variable_storage_decreasing_extra_sector_for_tag);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_read_variable_storage_decreasing_extra_sector_for_tag_last_block);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_read_variable_storage_decreasing_longer_header);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_variable_storage_decreasing_old_format);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_fixed_storage_null);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_fixed_storage_invalid_id);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_fixed_storage_small_buffer);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_fixed_storage_read_error);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_fixed_storage_read_tag_error);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_fixed_storage_decrypt_error);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_variable_storage_null);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_variable_storage_invalid_id);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_variable_storage_small_buffer);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_variable_storage_read_header_error);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_variable_storage_invalid_header_marker);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_variable_storage_short_header);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_variable_storage_invalid_data_length);
	SUITE_ADD_TEST (suite,
		flash_store_encrypted_test_read_variable_storage_old_format_invalid_data_length);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_variable_storage_read_error);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_variable_storage_read_tag_error);
	SUITE_ADD_TEST (suite, flash_store_encrypted_test_read_variable_storage_decrypt_error);
