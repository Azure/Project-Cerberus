...
CuSuite* get_host_processor_dual_full_bypass_suite ()
{
	...
	SUITE_ADD_TEST (suite,
		host_processor_dual_full_bypass_test_init_pulse_reset_invalid_pulse_width);
	...
	SUITE_ADD_TEST (suite, host_processor_dual_full_bypass_test_power_on_reset_no_pfm_filter_error);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite, host_processor_dual_full_bypass_test_soft_reset_no_pfm);
	SUITE_ADD_TEST (suite, host_processor_dual_full_bypass_test_soft_reset_no_pfm_filter_error);
	SUITE_ADD_TEST (suite,
	...
	SUITE_ADD_TEST (suite, host_processor_dual_full_bypass_test_run_time_verification_no_pfm);
	SUITE_ADD_TEST (suite,
		host_processor_dual_full_bypass_test_run_time_verification_no_pfm_filter_error);
	SUITE_ADD_TEST (suite,
