...
static const char *SUITE = "intrusion_manager_async";
...
CuSuite* get_intrusion_manager_async_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, intrusion_manager_async_test_init);
	SUITE_ADD_TEST (suite, intrusion_manager_async_test_init_second_measurement);
	SUITE_ADD_TEST (suite, intrusion_manager_async_test_init_null);
	SUITE_ADD_TEST (suite, intrusion_manager_async_test_init_invalid_measurement);
	SUITE_ADD_TEST (suite, intrusion_manager_async_test_init_hash_error);
	SUITE_ADD_TEST (suite, intrusion_manager_async_test_release_null);
	/* Base implementations are used for handle_intrusion and reset_intrusion. */
	SUITE_ADD_TEST (suite, intrusion_manager_async_test_check_state_no_intrusion);
	SUITE_ADD_TEST (suite, intrusion_manager_async_test_check_state_intrusion);
	SUITE_ADD_TEST (suite, intrusion_manager_async_test_check_state_check_error);
	SUITE_ADD_TEST (suite, intrusion_manager_async_test_check_state_check_error_from_intrusion);
	SUITE_ADD_TEST (suite, intrusion_manager_async_test_check_state_check_error_from_no_intrusion);
	SUITE_ADD_TEST (suite, intrusion_manager_async_test_check_state_deferred);
	SUITE_ADD_TEST (suite, intrusion_manager_async_test_check_state_null);
	SUITE_ADD_TEST (suite, intrusion_manager_async_test_check_state_no_intrusion_hash_error);
	SUITE_ADD_TEST (suite, intrusion_manager_async_test_check_state_intrusion_hash_error);
	SUITE_ADD_TEST (suite, intrusion_manager_async_test_check_state_check_error_and_hash_error);
	SUITE_ADD_TEST (suite, intrusion_manager_async_test_on_intrusion);
	SUITE_ADD_TEST (suite, intrusion_manager_async_test_on_intrusion_hash_error);
	SUITE_ADD_TEST (suite, intrusion_manager_async_test_on_no_intrusion);
	SUITE_ADD_TEST (suite, intrusion_manager_async_test_on_no_intrusion_hash_error);
	SUITE_ADD_TEST (suite, intrusion_manager_async_test_on_error);
	SUITE_ADD_TEST (suite, intrusion_manager_async_test_on_error_hash_error);
