...
static void host_processor_single_test_bypass_mode_ro_flash_two_flash_devices (CuTest *test)
{
	struct host_processor_single_testing host;
	int status;
...
static void host_processor_single_test_bypass_mode_ro_flash_two_flash_devices_cs1 (CuTest *test)
{
	struct host_processor_single_testing host;
	int status;
...
static void host_processor_single_test_bypass_mode_rw_flash_two_flash_devices (CuTest *test)
{
	struct host_processor_single_testing host;
	int status;
...
static void host_processor_single_test_bypass_mode_rw_flash_two_flash_devices_cs0 (CuTest *test)
{
	struct host_processor_single_testing host;
	int status;
...
static void host_processor_single_test_bypass_mode_static_init (CuTest *test)
{
	struct host_processor_single_testing host = {
...
static void host_processor_single_test_bypass_mode_static_init_pulse_reset (CuTest *test)
{
	struct host_processor_single_testing host = {
...
// *INDENT-OFF*
TEST_SUITE_START (host_processor_single_bypass_mode);

TEST (host_processor_single_test_bypass_mode_ro_flash);
TEST (host_processor_single_test_bypass_mode_ro_flash_cs1);
TEST (host_processor_single_test_bypass_mode_ro_flash_two_flash_devices);
TEST (host_processor_single_test_bypass_mode_ro_flash_two_flash_devices_cs1);
TEST (host_processor_single_test_bypass_mode_rw_flash);
TEST (host_processor_single_test_bypass_mode_rw_flash_cs0);
TEST (host_processor_single_test_bypass_mode_rw_flash_two_flash_devices);
TEST (host_processor_single_test_bypass_mode_rw_flash_two_flash_devices_cs0);
TEST (host_processor_single_test_bypass_mode_no_observer);
TEST (host_processor_single_test_bypass_mode_unsupported_flash);
TEST (host_processor_single_test_bypass_mode_static_init);
TEST (host_processor_single_test_bypass_mode_static_init_pulse_reset);
TEST (host_processor_single_test_bypass_mode_null);
TEST (host_processor_single_test_bypass_mode_filter_error);
TEST (host_processor_single_test_bypass_mode_host_access_error);
