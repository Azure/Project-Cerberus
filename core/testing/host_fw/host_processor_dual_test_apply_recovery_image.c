...
static void host_processor_dual_test_apply_recovery_image_static_init (CuTest *test)
{
	struct host_processor_dual_testing host = {
...
static void host_processor_dual_test_apply_recovery_image_static_init_pulse_reset (CuTest *test)
{
	struct host_processor_dual_testing host = {
...
static void host_processor_dual_test_apply_recovery_image_static_init_no_recovery_manager (
	CuTest *test)
{
	struct host_processor_dual_testing host = {
		.test = host_processor_dual_static_init (&host.state, &host.control.base,
...
static void
host_processor_dual_test_apply_recovery_image_static_init_no_recovery_manager_pulse_reset (
	CuTest *test)
{
	struct host_processor_dual_testing host = {
		.test = host_processor_dual_static_init_pulse_reset (&host.state, &host.control.base,
...
TEST (host_processor_dual_test_apply_recovery_image_static_init);
TEST (host_processor_dual_test_apply_recovery_image_static_init_pulse_reset);
TEST (host_processor_dual_test_apply_recovery_image_static_init_no_recovery_manager);
TEST (host_processor_dual_test_apply_recovery_image_static_init_no_recovery_manager_pulse_reset);
