...
static void host_processor_single_test_init_reset_flash (CuTest *test)
{
	...
	status = host_processor_single_init_reset_flash (&host, &state, &control.base, &flash_mgr.base,
...
static void host_processor_single_test_init_reset_flash_null (CuTest *test)
{
	...
	status = host_processor_single_init_reset_flash (NULL, &state, &control.base, &flash_mgr.base,
		&host_state, &filter.base, &pfm_mgr.base, NULL);
	CuAssertIntEquals (test, HOST_PROCESSOR_INVALID_ARGUMENT, status);

	status = host_processor_single_init_reset_flash (&host, NULL, &control.base, &flash_mgr.base,
		&host_state, &filter.base, &pfm_mgr.base, NULL);
	CuAssertIntEquals (test, HOST_PROCESSOR_INVALID_ARGUMENT, status);

	status = host_processor_single_init_reset_flash (&host, &state, NULL, &flash_mgr.base,
		&host_state, &filter.base, &pfm_mgr.base, NULL);
	CuAssertIntEquals (test, HOST_PROCESSOR_INVALID_ARGUMENT, status);

	status = host_processor_single_init_reset_flash (&host, &state, &control.base, NULL,
		&host_state, &filter.base, &pfm_mgr.base, NULL);
	CuAssertIntEquals (test, HOST_PROCESSOR_INVALID_ARGUMENT, status);
...
static void host_processor_single_test_init_reset_flash_pulse_reset (CuTest *test)
{
	...
	status = host_processor_single_init_reset_flash_pulse_reset (&host, &state, &control.base,
...
static void host_processor_single_test_init_reset_flash_pulse_reset_null (CuTest *test)
{
	...
	status = host_processor_single_init_reset_flash_pulse_reset (NULL, &state, &control.base,
		&flash_mgr.base, &host_state, &filter.base, &pfm_mgr.base, NULL, 100);
	CuAssertIntEquals (test, HOST_PROCESSOR_INVALID_ARGUMENT, status);

	status = host_processor_single_init_reset_flash_pulse_reset (&host, NULL, &control.base,
		&flash_mgr.base, &host_state, &filter.base, &pfm_mgr.base, NULL, 100);
	CuAssertIntEquals (test, HOST_PROCESSOR_INVALID_ARGUMENT, status);

	status = host_processor_single_init_reset_flash_pulse_reset (&host, &state, NULL,
		&flash_mgr.base, &host_state, &filter.base, &pfm_mgr.base, NULL, 100);
	CuAssertIntEquals (test, HOST_PROCESSOR_INVALID_ARGUMENT, status);

	status = host_processor_single_init_reset_flash_pulse_reset (&host, &state, &control.base, NULL,
...
static void host_processor_single_test_static_init_reset_flash (CuTest *test)
{
	struct host_processor_single_testing host = {
		.test = host_processor_single_static_init_reset_flash (&host.state, &host.control.base,
...
static void host_processor_single_test_static_init_reset_flash_null (CuTest *test)
{
	struct host_processor_single_testing host;
	int status;

	struct host_processor_filtered null_state =
		host_processor_single_static_init_reset_flash ((struct host_processor_filtered_state*) NULL,
	...
	struct host_processor_filtered null_control =
		host_processor_single_static_init_reset_flash (&host.state, NULL, &host.flash_mgr.base,
		&host.host_state, &host.filter.base, &host.pfm_mgr.base, NULL);

	struct host_processor_filtered null_flash =
		host_processor_single_static_init_reset_flash (&host.state, &host.control.base,
...
static void host_processor_single_test_static_init_reset_flash_pulse_reset (CuTest *test)
{
	struct host_processor_single_testing host = {
		.test = host_processor_single_static_init_reset_flash_pulse_reset (&host.state,
			&host.control.base, &host.flash_mgr.base, &host.host_state, &host.filter.base,
...
static void host_processor_single_test_static_init_reset_flash_pulse_reset_null (CuTest *test)
{
	struct host_processor_single_testing host;
	int status;

	struct host_processor_filtered null_state =
		host_processor_single_static_init_reset_flash_pulse_reset (
	...
	struct host_processor_filtered null_control =
		host_processor_single_static_init_reset_flash_pulse_reset (&host.state, NULL,
		&host.flash_mgr.base, &host.host_state, &host.filter.base, &host.pfm_mgr.base, NULL, 100);

	struct host_processor_filtered null_flash =
		host_processor_single_static_init_reset_flash_pulse_reset (&host.state, &host.control.base,
		(struct host_flash_manager_single*) NULL, &host.host_state, &host.filter.base,
		&host.pfm_mgr.base, NULL, 100);
...
static void host_processor_single_test_static_init_reset_flash_pulse_reset_invalid_pulse_width (
	CuTest *test)
{
	struct host_processor_single_testing host;
	int status;
...
static void host_processor_single_test_soft_reset_static_init_reset_flash (CuTest *test)
{
	struct host_processor_single_testing host = {
		.test = host_processor_single_static_init_reset_flash (&host.state, &host.control.base,
...
static void host_processor_single_test_soft_reset_static_init_pulse_reset_reset_flash (CuTest *test)
{
	struct host_processor_single_testing host = {
		.test = host_processor_single_static_init_reset_flash_pulse_reset (&host.state,
			&host.control.base, &host.flash_mgr.base, &host.host_state, &host.filter.base,
...
static void host_processor_single_test_apply_recovery_image_static_init_reset_flash (CuTest *test)
{
	struct host_processor_single_testing host = {
		.test = host_processor_single_static_init_reset_flash (&host.state, &host.control.base,
			&host.flash_mgr.base, &host.host_state, &host.filter.base, &host.pfm_mgr.base,
...
static void host_processor_single_test_apply_recovery_image_static_init_reset_flash_pulse_reset (
	CuTest *test)
{
	struct host_processor_single_testing host = {
		.test = host_processor_single_static_init_reset_flash_pulse_reset (&host.state,
...
static void
host_processor_single_test_apply_recovery_image_static_init_reset_flash_no_recovery_manager (
	CuTest *test)
{
	struct host_processor_single_testing host = {
		.test = host_processor_single_static_init_reset_flash (&host.state, &host.control.base,
...
static void
host_processor_single_test_apply_recovery_image_static_init_reset_flash_no_recovery_manager_pulse_reset
	(CuTest *test)
{
	struct host_processor_single_testing host = {
		.test = host_processor_single_static_init_reset_flash_pulse_reset (&host.state,
...
static void host_processor_single_test_config_read_only_flash_static_init_reset_flash (CuTest *test)
{
	struct host_processor_single_testing host = {
		.test = host_processor_single_static_init_reset_flash (&host.state, &host.control.base,
			&host.flash_mgr.base, &host.host_state, &host.filter.base, &host.pfm_mgr.base,
...
static void host_processor_single_test_config_read_only_flash_static_init_reset_flash_pulse_reset (
	CuTest *test)
{
	struct host_processor_single_testing host = {
		.test = host_processor_single_static_init_reset_flash_pulse_reset (&host.state,
...
TEST (host_processor_single_test_static_init_reset_flash);
TEST (host_processor_single_test_static_init_reset_flash_null);
TEST (host_processor_single_test_static_init_reset_flash_pulse_reset);
TEST (host_processor_single_test_static_init_reset_flash_pulse_reset_null);
TEST (host_processor_single_test_static_init_reset_flash_pulse_reset_invalid_pulse_width);
...
TEST (host_processor_single_test_soft_reset_static_init_reset_flash);
TEST (host_processor_single_test_soft_reset_static_init_pulse_reset_reset_flash);
...
TEST (host_processor_single_test_apply_recovery_image_static_init_reset_flash);
TEST (host_processor_single_test_apply_recovery_image_static_init_reset_flash_pulse_reset);
TEST (host_processor_single_test_apply_recovery_image_static_init_reset_flash_no_recovery_manager);
TEST (host_processor_single_test_apply_recovery_image_static_init_reset_flash_no_recovery_manager_pulse_reset);
TEST (host_processor_single_test_config_read_only_flash_static_init_reset_flash);
TEST (host_processor_single_test_config_read_only_flash_static_init_reset_flash_pulse_reset);
