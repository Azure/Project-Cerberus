...
TEST_SUITE_LABEL ("host_flash_manager_dual");
...
static void host_flash_manager_dual_test_init_null (CuTest *test)
{
	...
	status = host_flash_manager_dual_init (&manager.test, &manager.flash0, &manager.flash1, NULL,
...
static void host_flash_manager_dual_test_init_with_managed_flash_initialization_null (CuTest *test)
{
	...
	status = host_flash_manager_dual_init_with_managed_flash_initialization (NULL, &manager.flash0,
		&manager.flash1, &manager.host_state, &manager.filter.base, &manager.handler.base,
		&manager.flash_init);
	CuAssertIntEquals (test, HOST_FLASH_MGR_INVALID_ARGUMENT, status);

	status = host_flash_manager_dual_init_with_managed_flash_initialization (&manager.test, NULL,
		&manager.flash1, &manager.host_state, &manager.filter.base, &manager.handler.base,
		&manager.flash_init);
	CuAssertIntEquals (test, HOST_FLASH_MGR_INVALID_ARGUMENT, status);
...
static void host_flash_manager_dual_test_static_init (CuTest *test)
{
	struct host_flash_manager_dual_testing manager = {
...
static void host_flash_manager_dual_test_static_init_with_managed_flash_initialization (
	CuTest *test)
{
	struct host_flash_manager_dual_testing manager = {
		.test =
			host_flash_manager_dual_static_init_with_managed_flash_initialization (&manager.flash0,
			&manager.flash1, &manager.host_state, &manager.filter.base, &manager.handler.base,
			&manager.flash_init)
	};
...
static void host_flash_manager_dual_test_get_read_only_flash_override_cs0 (CuTest *test)
{
	struct host_flash_manager_dual_testing manager;
	const struct spi_flash *active;
	int status;
...
static void host_flash_manager_dual_test_get_read_only_flash_override_cs1 (CuTest *test)
{
	struct host_flash_manager_dual_testing manager;
	const struct spi_flash *active;
	int status;
...
static void host_flash_manager_dual_test_get_read_only_flash_static_init (CuTest *test)
{
	struct host_flash_manager_dual_testing manager = {
		.test = host_flash_manager_dual_static_init (&manager.flash0, &manager.flash1,
			&manager.host_state, &manager.filter.base, &manager.handler.base)
...
static void host_flash_manager_dual_test_get_read_write_flash_override_cs1 (CuTest *test)
{
	struct host_flash_manager_dual_testing manager;
	const struct spi_flash *inactive;
	int status;
...
static void host_flash_manager_dual_test_get_read_write_flash_override_cs0 (CuTest *test)
{
	struct host_flash_manager_dual_testing manager;
	const struct spi_flash *inactive;
	int status;
...
static void host_flash_manager_dual_test_get_read_write_flash_static_init (CuTest *test)
{
	struct host_flash_manager_dual_testing manager = {
		.test = host_flash_manager_dual_static_init (&manager.flash0, &manager.flash1,
			&manager.host_state, &manager.filter.base, &manager.handler.base)
...
static void host_flash_manager_dual_test_swap_flash_devices_override_cs1 (CuTest *test)
{
	struct host_flash_manager_dual_testing manager;
	int status;
	struct flash_region rw_region;
...
static void host_flash_manager_dual_test_swap_flash_devices_override_cs0 (CuTest *test)
{
	struct host_flash_manager_dual_testing manager;
	int status;
	struct flash_region rw_region;
...
static void host_flash_manager_dual_test_swap_flash_devices_override_same_as_nv (CuTest *test)
{
	struct host_flash_manager_dual_testing manager;
	int status;
	struct flash_region rw_region;
...
static void host_flash_manager_dual_test_swap_flash_devices_static_init (CuTest *test)
{
	struct host_flash_manager_dual_testing manager = {
		.test = host_flash_manager_dual_static_init (&manager.flash0, &manager.flash1,
			&manager.host_state, &manager.filter.base, &manager.handler.base)
...
static void host_flash_manager_dual_test_swap_flash_devices_static_init_with_flash_initialization (
	CuTest *test)
{
	struct host_flash_manager_dual_testing manager = {
		.test =
...
static void host_flash_manager_dual_test_config_spi_filter_flash_devices_override_cs0 (CuTest *test)
{
	struct host_flash_manager_dual_testing manager;
	int status;
	spi_filter_cs active;
...
static void host_flash_manager_dual_test_config_spi_filter_flash_devices_override_cs1 (CuTest *test)
{
	struct host_flash_manager_dual_testing manager;
	int status;
	spi_filter_cs active;
...
static void host_flash_manager_dual_test_config_spi_filter_flash_devices_static_init (CuTest *test)
{
	struct host_flash_manager_dual_testing manager = {
		.test = host_flash_manager_dual_static_init (&manager.flash0, &manager.flash1,
			&manager.host_state, &manager.filter.base, &manager.handler.base)
...
static void host_flash_manager_dual_test_validate_read_only_flash_override_cs0 (CuTest *test)
{
	struct host_flash_manager_dual_testing manager;
	struct pfm_firmware fw_list;
	const char *fw_exp = NULL;
...
static void host_flash_manager_dual_test_validate_read_only_flash_override_cs1 (CuTest *test)
{
	struct host_flash_manager_dual_testing manager;
	struct pfm_firmware fw_list;
	const char *fw_exp = NULL;
...
static void host_flash_manager_dual_test_validate_read_only_flash_static_init (CuTest *test)
{
	struct host_flash_manager_dual_testing manager = {
		.test = host_flash_manager_dual_static_init (&manager.flash0, &manager.flash1,
			&manager.host_state, &manager.filter.base, &manager.handler.base)
...
static void host_flash_manager_dual_test_validate_read_only_flash_null (CuTest *test)
{
	...
	status = manager.test.base.validate_read_only_flash (NULL, &manager.pfm.base, NULL,
		&manager.hash.base, &manager.rsa.base, false, &rw_output);
	CuAssertIntEquals (test, HOST_FLASH_MGR_INVALID_ARGUMENT, status);

	status = manager.test.base.validate_read_only_flash (&manager.test.base, NULL, NULL,
		&manager.hash.base, &manager.rsa.base, false, &rw_output);
	CuAssertIntEquals (test, HOST_FLASH_MGR_INVALID_ARGUMENT, status);
...
static void host_flash_manager_dual_test_validate_read_write_flash_override_cs1 (CuTest *test)
{
	struct host_flash_manager_dual_testing manager;
	struct pfm_firmware fw_list;
	const char *fw_exp = NULL;
...
static void host_flash_manager_dual_test_validate_read_write_flash_override_cs0 (CuTest *test)
{
	struct host_flash_manager_dual_testing manager;
	struct pfm_firmware fw_list;
	const char *fw_exp = NULL;
...
static void host_flash_manager_dual_test_validate_read_write_flash_not_blank_byte (CuTest *test)
{
	...
	status |= flash_master_mock_expect_value_check (&manager.flash_mock1, 0 + strlen (img_data),
		0x200 - strlen (img_data), 0xaa);
	status |= flash_master_mock_expect_value_check (&manager.flash_mock1, 0x300, 0x1000 - 0x300,
		0xaa);
...
static void host_flash_manager_dual_test_validate_read_write_flash_multiple_fw (CuTest *test)
{
	...
	status |= flash_master_mock_expect_rx_xfer (&manager.flash_mock1, 0, &WIP_STATUS, 1,
		FLASH_EXP_READ_STATUS_REG);
	status |= flash_master_mock_expect_rx_xfer (&manager.flash_mock1, 0, (uint8_t*) version_exp1,
		strlen (version_exp1), FLASH_EXP_READ_CMD (0x03, 0x123, 0, -1, strlen (version_exp1)));
	...
	status |= flash_master_mock_expect_rx_xfer (&manager.flash_mock1, 0, &WIP_STATUS, 1,
		FLASH_EXP_READ_STATUS_REG);
	status |= flash_master_mock_expect_rx_xfer (&manager.flash_mock1, 0, (uint8_t*) version_exp2,
		strlen (version_exp2), FLASH_EXP_READ_CMD (0x03, 0x456, 0, -1, strlen (version_exp2)));
	...
	status |= flash_master_mock_expect_rx_xfer (&manager.flash_mock1, 0, &WIP_STATUS, 1,
		FLASH_EXP_READ_STATUS_REG);
	status |= flash_master_mock_expect_rx_xfer (&manager.flash_mock1, 0, (uint8_t*) version_exp3,
		strlen (version_exp3), FLASH_EXP_READ_CMD (0x03, 0x789, 0, -1, strlen (version_exp3)));
	...
	status |= flash_master_mock_expect_rx_xfer (&manager.flash_mock1, 0, &WIP_STATUS, 1,
		FLASH_EXP_READ_STATUS_REG);
	status |= flash_master_mock_expect_rx_xfer (&manager.flash_mock1, 0, (uint8_t*) img_data1,
		strlen (img_data1), FLASH_EXP_READ_CMD (0x03, 0x000, 0, -1, strlen (img_data1)));

	status |= flash_master_mock_expect_rx_xfer (&manager.flash_mock1, 0, &WIP_STATUS, 1,
		FLASH_EXP_READ_STATUS_REG);
	status |= flash_master_mock_expect_rx_xfer (&manager.flash_mock1, 0, (uint8_t*) img_data2,
		strlen (img_data2), FLASH_EXP_READ_CMD (0x03, 0x300, 0, -1, strlen (img_data2)));

	status |= flash_master_mock_expect_rx_xfer (&manager.flash_mock1, 0, &WIP_STATUS, 1,
		FLASH_EXP_READ_STATUS_REG);
	status |= flash_master_mock_expect_rx_xfer (&manager.flash_mock1, 0, (uint8_t*) img_data3,
		strlen (img_data3), FLASH_EXP_READ_CMD (0x03, 0x600, 0, -1, strlen (img_data3)));

	status |= flash_master_mock_expect_blank_check (&manager.flash_mock1,
		0x000 + strlen (img_data1), 0x200 - strlen (img_data1));
	status |= flash_master_mock_expect_blank_check (&manager.flash_mock1,
		0x300 + strlen (img_data2), 0x200 - strlen (img_data2));
	status |= flash_master_mock_expect_blank_check (&manager.flash_mock1,
		0x600 + strlen (img_data3), 0x200 - strlen (img_data3));
	status |= flash_master_mock_expect_blank_check (&manager.flash_mock1, 0x900, 0x1000 - 0x900);
...
static void host_flash_manager_dual_test_validate_read_write_flash_static_init (CuTest *test)
{
	struct host_flash_manager_dual_testing manager = {
		.test = host_flash_manager_dual_static_init (&manager.flash0, &manager.flash1,
			&manager.host_state, &manager.filter.base, &manager.handler.base)
...
static void host_flash_manager_dual_test_set_flash_for_rot_access_static_init (CuTest *test)
{
	struct host_flash_manager_dual_testing manager = {
		.test = host_flash_manager_dual_static_init (&manager.flash0, &manager.flash1,
			&manager.host_state, &manager.filter.base, &manager.handler.base)
...
static void
host_flash_manager_dual_test_set_flash_for_rot_access_static_init_with_flash_initialization (
	CuTest *test)
{
	struct host_flash_manager_dual_testing manager = {
		.test =
...
static void host_flash_manager_dual_test_set_flash_for_host_access_static_init (CuTest *test)
{
	struct host_flash_manager_dual_testing manager = {
		.test = host_flash_manager_dual_static_init (&manager.flash0, &manager.flash1,
			&manager.host_state, &manager.filter.base, &manager.handler.base)
...
static void host_flash_manager_dual_test_set_flash_for_host_access_null (CuTest *test)
{
	...
	status = manager.test.base.set_flash_for_host_access (NULL, &manager.control.base);
	CuAssertIntEquals (test, HOST_FLASH_MGR_INVALID_ARGUMENT, status);

	status = manager.test.base.set_flash_for_host_access (&manager.test.base, NULL);
	CuAssertIntEquals (test, HOST_FLASH_MGR_INVALID_ARGUMENT, status);
...
static void host_flash_manager_dual_test_config_spi_filter_flash_type_static_init (CuTest *test)
{
	struct host_flash_manager_dual_testing manager = {
		.test = host_flash_manager_dual_static_init (&manager.flash0, &manager.flash1,
			&manager.host_state, &manager.filter.base, &manager.handler.base)
...
static void
host_flash_manager_dual_test_config_spi_filter_flash_type_static_init_with_flash_initialization (
	CuTest *test)
{
	struct host_flash_manager_dual_testing manager = {
		.test =
...
static void host_flash_manager_dual_test_initialize_flash_protection_override_cs0 (CuTest *test)
{
	struct host_flash_manager_dual_testing manager;
	int status;
	struct flash_region rw_region;
...
static void host_flash_manager_dual_test_initialize_flash_protection_override_cs1 (CuTest *test)
{
	struct host_flash_manager_dual_testing manager;
	int status;
	struct flash_region rw_region;
...
static void host_flash_manager_dual_test_initialize_flash_protection_static_init (CuTest *test)
{
	struct host_flash_manager_dual_testing manager = {
		.test = host_flash_manager_dual_static_init (&manager.flash0, &manager.flash1,
			&manager.host_state, &manager.filter.base, &manager.handler.base)
...
static void host_flash_manager_dual_test_get_flash_read_write_regions_ro_flash_override_cs0 (
	CuTest *test)
{
	struct host_flash_manager_dual_testing manager;
	struct pfm_firmware fw_list;
...
static void host_flash_manager_dual_test_get_flash_read_write_regions_ro_flash_override_cs1 (
	CuTest *test)
{
	struct host_flash_manager_dual_testing manager;
	struct pfm_firmware fw_list;
...
static void host_flash_manager_dual_test_get_flash_read_write_regions_rw_flash_override_cs1 (
	CuTest *test)
{
	struct host_flash_manager_dual_testing manager;
	struct pfm_firmware fw_list;
...
static void host_flash_manager_dual_test_get_flash_read_write_regions_rw_flash_override_cs0 (
	CuTest *test)
{
	struct host_flash_manager_dual_testing manager;
	struct pfm_firmware fw_list;
...
static void host_flash_manager_dual_test_get_flash_read_write_regions_static_init (CuTest *test)
{
	struct host_flash_manager_dual_testing manager = {
		.test = host_flash_manager_dual_static_init (&manager.flash0, &manager.flash1,
			&manager.host_state, &manager.filter.base, &manager.handler.base)
...
static void host_flash_manager_dual_test_get_flash_read_write_regions_null (CuTest *test)
{
	...
	status = manager.test.base.get_flash_read_write_regions (NULL, &manager.pfm.base, false,
		&rw_output);
	CuAssertIntEquals (test, HOST_FLASH_MGR_INVALID_ARGUMENT, status);

	status = manager.test.base.get_flash_read_write_regions (&manager.test.base, NULL, false,
		&rw_output);
	CuAssertIntEquals (test, HOST_FLASH_MGR_INVALID_ARGUMENT, status);
...
static void host_flash_manager_dual_test_host_has_flash_access_static_init (CuTest *test)
{
	struct host_flash_manager_dual_testing manager = {
		.test = host_flash_manager_dual_static_init (&manager.flash0, &manager.flash1,
			&manager.host_state, &manager.filter.base, &manager.handler.base)
...
static void host_flash_manager_dual_test_restore_flash_read_write_regions_cs0 (CuTest *test)
{
	...
	status = flash_master_mock_expect_erase_flash_verify (&manager.flash_mock0, 0x20000, 0x10000);
	status |= flash_master_mock_expect_copy_flash_verify (&manager.flash_mock0,
		&manager.flash_mock1, 0x20000, 0x20000, data, sizeof (data));
...
static void host_flash_manager_dual_test_restore_flash_read_write_regions_override_cs1 (
	CuTest *test)
{
	struct host_flash_manager_dual_testing manager;
	struct flash_region rw_region;
...
static void host_flash_manager_dual_test_restore_flash_read_write_regions_override_cs0 (
	CuTest *test)
{
	struct host_flash_manager_dual_testing manager;
	struct flash_region rw_region;
	...
	CuTest *test)
{
	...
	status = flash_master_mock_expect_erase_flash_verify (&manager.flash_mock1, 0x00000, 0x10000);
	status |= flash_master_mock_expect_erase_flash_verify (&manager.flash_mock1, 0x40000, 0x10000);
	status |= flash_master_mock_expect_erase_flash_verify (&manager.flash_mock1, 0x100000, 0x10000);
	...
	CuTest *test)
{
	...
	status = flash_master_mock_expect_erase_flash_verify (&manager.flash_mock0, 0x00000, 0x10000);
	status |= flash_master_mock_expect_erase_flash_verify (&manager.flash_mock0, 0x40000, 0x10000);
	status |= flash_master_mock_expect_erase_flash_verify (&manager.flash_mock0, 0x100000, 0x10000);
...
static void host_flash_manager_dual_test_restore_flash_read_write_regions_static_init (CuTest *test)
{
	struct host_flash_manager_dual_testing manager = {
		.test = host_flash_manager_dual_static_init (&manager.flash0, &manager.flash1,
			&manager.host_state, &manager.filter.base, &manager.handler.base)
...
static void host_flash_manager_dual_test_reset_flash_static_init (CuTest *test)
{
	struct host_flash_manager_dual_testing manager = {
		.test = host_flash_manager_dual_static_init (&manager.flash0, &manager.flash1,
			&manager.host_state, &manager.filter.base, &manager.handler.base)
...
TEST (host_flash_manager_dual_test_init);
TEST (host_flash_manager_dual_test_init_null);
TEST (host_flash_manager_dual_test_init_with_managed_flash_initialization);
TEST (host_flash_manager_dual_test_init_with_managed_flash_initialization_null);
...
TEST (host_flash_manager_dual_test_get_read_only_flash_override_cs0);
TEST (host_flash_manager_dual_test_get_read_only_flash_override_cs1);
TEST (host_flash_manager_dual_test_get_read_only_flash_static_init);
TEST (host_flash_manager_dual_test_get_read_only_flash_null);
TEST (host_flash_manager_dual_test_get_read_write_flash_cs1);
TEST (host_flash_manager_dual_test_get_read_write_flash_cs0);
TEST (host_flash_manager_dual_test_get_read_write_flash_override_cs1);
TEST (host_flash_manager_dual_test_get_read_write_flash_override_cs0);
TEST (host_flash_manager_dual_test_get_read_write_flash_static_init);
TEST (host_flash_manager_dual_test_get_read_write_flash_null);
TEST (host_flash_manager_dual_test_swap_flash_devices_cs1);
TEST (host_flash_manager_dual_test_swap_flash_devices_cs0);
TEST (host_flash_manager_dual_test_swap_flash_devices_override_cs1);
TEST (host_flash_manager_dual_test_swap_flash_devices_override_cs0);
TEST (host_flash_manager_dual_test_swap_flash_devices_override_same_as_nv);
TEST (host_flash_manager_dual_test_swap_flash_devices_activate_pending_pfm);
TEST (host_flash_manager_dual_test_swap_flash_devices_no_data_migration);
TEST (host_flash_manager_dual_test_swap_flash_devices_cs1_multiple_fw);
TEST (host_flash_manager_dual_test_swap_flash_devices_cs0_multiple_fw);
TEST (host_flash_manager_dual_test_swap_flash_devices_static_init);
TEST (host_flash_manager_dual_test_swap_flash_devices_static_init_with_flash_initialization);
TEST (host_flash_manager_dual_test_swap_flash_devices_null);
TEST (host_flash_manager_dual_test_swap_flash_devices_dirty_clear_error);
TEST (host_flash_manager_dual_test_swap_flash_devices_spi_filter_error);
TEST (host_flash_manager_dual_test_swap_flash_devices_cs1_data_copy_error);
TEST (host_flash_manager_dual_test_swap_flash_devices_cs0_data_copy_error);
TEST (host_flash_manager_dual_test_swap_flash_devices_activate_pending_pfm_error);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_devices_cs0);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_devices_cs1);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_devices_override_cs0);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_devices_override_cs1);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_devices_static_init);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_devices_null);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_devices_error);
TEST (host_flash_manager_dual_test_validate_read_only_flash_cs0);
TEST (host_flash_manager_dual_test_validate_read_only_flash_cs1);
TEST (host_flash_manager_dual_test_validate_read_only_flash_override_cs0);
TEST (host_flash_manager_dual_test_validate_read_only_flash_override_cs1);
TEST (host_flash_manager_dual_test_validate_read_only_flash_single_fw);
TEST (host_flash_manager_dual_test_validate_read_only_flash_multiple_fw);
TEST (host_flash_manager_dual_test_validate_read_only_flash_cs0_full_validation);
TEST (host_flash_manager_dual_test_validate_read_only_flash_cs1_full_validation);
TEST (host_flash_manager_dual_test_validate_read_only_flash_full_validation_not_blank_byte);
TEST (host_flash_manager_dual_test_validate_read_only_flash_full_validation_single_fw);
TEST (host_flash_manager_dual_test_validate_read_only_flash_full_validation_multiple_fw);
TEST (host_flash_manager_dual_test_validate_read_only_flash_cs0_good_pfm);
TEST (host_flash_manager_dual_test_validate_read_only_flash_cs1_good_pfm);
TEST (host_flash_manager_dual_test_validate_read_only_flash_good_pfm_single_fw);
TEST (host_flash_manager_dual_test_validate_read_only_flash_good_pfm_multiple_fw);
TEST (host_flash_manager_dual_test_validate_read_only_flash_cs0_good_pfm_no_match_image);
TEST (host_flash_manager_dual_test_validate_read_only_flash_cs1_good_pfm_no_match_image);
TEST (host_flash_manager_dual_test_validate_read_only_flash_good_pfm_no_match_image_multiple_fw);
TEST (host_flash_manager_dual_test_validate_read_only_flash_good_pfm_full_validation);
TEST (host_flash_manager_dual_test_validate_read_only_flash_static_init);
TEST (host_flash_manager_dual_test_validate_read_only_flash_null);
TEST (host_flash_manager_dual_test_validate_read_only_flash_pfm_firmware_error);
TEST (host_flash_manager_dual_test_validate_read_only_flash_pfm_version_error);
TEST (host_flash_manager_dual_test_validate_read_only_flash_pfm_version_error_multiple_fw);
TEST (host_flash_manager_dual_test_validate_read_only_flash_pfm_images_error);
TEST (host_flash_manager_dual_test_validate_read_only_flash_pfm_rw_error);
TEST (host_flash_manager_dual_test_validate_read_only_flash_flash_version_error);
TEST (host_flash_manager_dual_test_validate_read_only_flash_flash_image_error);
TEST (host_flash_manager_dual_test_validate_read_only_flash_full_flash_image_error);
TEST (host_flash_manager_dual_test_validate_read_only_flash_good_pfm_pfm_firmware_error);
TEST (host_flash_manager_dual_test_validate_read_only_flash_good_pfm_pfm_version_error);
TEST (host_flash_manager_dual_test_validate_read_only_flash_good_pfm_pfm_version_error_multiple_fw);
TEST (host_flash_manager_dual_test_validate_read_only_flash_good_pfm_flash_version_error);
TEST (host_flash_manager_dual_test_validate_read_only_flash_good_pfm_pfm_images_error);
TEST (host_flash_manager_dual_test_validate_read_only_flash_good_pfm_pfm_rw_error);
TEST (host_flash_manager_dual_test_validate_read_only_flash_good_pfm_good_images_error);
TEST (host_flash_manager_dual_test_validate_read_only_flash_good_pfm_flash_image_error);
TEST (host_flash_manager_dual_test_validate_read_write_flash_cs1);
TEST (host_flash_manager_dual_test_validate_read_write_flash_cs0);
TEST (host_flash_manager_dual_test_validate_read_write_flash_override_cs1);
TEST (host_flash_manager_dual_test_validate_read_write_flash_override_cs0);
TEST (host_flash_manager_dual_test_validate_read_write_flash_not_blank_byte);
TEST (host_flash_manager_dual_test_validate_read_write_flash_single_fw);
TEST (host_flash_manager_dual_test_validate_read_write_flash_multiple_fw);
TEST (host_flash_manager_dual_test_validate_read_write_flash_static_init);
TEST (host_flash_manager_dual_test_validate_read_write_flash_null);
TEST (host_flash_manager_dual_test_validate_read_write_flash_pfm_firmware_error);
TEST (host_flash_manager_dual_test_validate_read_write_flash_pfm_version_error);
TEST (host_flash_manager_dual_test_validate_read_write_flash_pfm_version_error_multiple_fw);
TEST (host_flash_manager_dual_test_validate_read_write_flash_pfm_images_error);
TEST (host_flash_manager_dual_test_validate_read_write_flash_pfm_rw_error);
TEST (host_flash_manager_dual_test_validate_read_write_flash_version_error);
TEST (host_flash_manager_dual_test_validate_read_write_flash_verify_error);
TEST (host_flash_manager_dual_test_free_read_write_regions_null);
TEST (host_flash_manager_dual_test_free_read_write_regions_null_list);
TEST (host_flash_manager_dual_test_free_read_write_regions_null_pfm);
TEST (host_flash_manager_dual_test_set_flash_for_rot_access);
TEST (host_flash_manager_dual_test_set_flash_for_rot_access_not_initilized_device);
TEST (host_flash_manager_dual_test_set_flash_for_rot_access_check_qspi_error);
TEST (host_flash_manager_dual_test_set_flash_for_rot_access_wip_set);
TEST (host_flash_manager_dual_test_set_flash_for_rot_access_with_flash_initialization);
TEST (host_flash_manager_dual_test_set_flash_for_rot_access_static_init);
TEST (host_flash_manager_dual_test_set_flash_for_rot_access_static_init_with_flash_initialization);
TEST (host_flash_manager_dual_test_set_flash_for_rot_access_null);
TEST (host_flash_manager_dual_test_set_flash_for_rot_access_filter_error);
TEST (host_flash_manager_dual_test_set_flash_for_rot_access_mux_error);
TEST (host_flash_manager_dual_test_set_flash_for_rot_access_wip_error);
TEST (host_flash_manager_dual_test_set_flash_for_rot_access_block_protect_error);
TEST (host_flash_manager_dual_test_set_flash_for_rot_access_qspi_error);
TEST (host_flash_manager_dual_test_set_flash_for_rot_access_4byte_error);
TEST (host_flash_manager_dual_test_set_flash_for_rot_access_id_error);
TEST (host_flash_manager_dual_test_set_flash_for_rot_access_unknown_id_ff);
TEST (host_flash_manager_dual_test_set_flash_for_rot_access_unknown_id_00);
TEST (host_flash_manager_dual_test_set_flash_for_rot_access_with_flash_initialization_error);
TEST (host_flash_manager_dual_test_set_flash_for_host_access);
TEST (host_flash_manager_dual_test_set_flash_for_host_access_static_init);
TEST (host_flash_manager_dual_test_set_flash_for_host_access_null);
TEST (host_flash_manager_dual_test_set_flash_for_host_access_mux_error);
TEST (host_flash_manager_dual_test_set_flash_for_host_access_enable_error);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_4byte);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_diff_addr_mode_3byte);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_diff_addr_mode_4byte);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_require_write_enable);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_fixed_addr_mode_3byte);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_fixed_addr_mode_4byte);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_reset_addr_mode_4byte);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_set_size_unsupported);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_addr_mode_write_en_unsupported);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_reset_addr_mode_unsupported);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_static_init);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_static_init_with_flash_initialization);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_null);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_diff_vendors);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_diff_devices);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_diff_sizes);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_diff_require_write_enable);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_diff_addr_mode_control);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_diff_fixed_addr_mode);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_diff_reset_addr_mode);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_id0_error);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_id1_error);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_diff_addr_mode_error);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_get_reset_addr_mode0_error);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_get_reset_addr_mode1_error);
TEST (host_flash_manager_dual_test_config_spi_filter_flash_type_filter_error);
...
TEST (host_flash_manager_dual_test_initialize_flash_protection_cs0_4byte_cs1_4byte);
TEST (host_flash_manager_dual_test_initialize_flash_protection_cs1_4byte_cs0_4byte);
TEST (host_flash_manager_dual_test_initialize_flash_protection_cs0_4byte_cs1_3byte);
TEST (host_flash_manager_dual_test_initialize_flash_protection_cs1_4byte_cs0_3byte);
TEST (host_flash_manager_dual_test_initialize_flash_protection_cs0_3byte_cs1_4byte);
TEST (host_flash_manager_dual_test_initialize_flash_protection_cs1_3byte_cs0_4byte);
TEST (host_flash_manager_dual_test_initialize_flash_protection_fixed_3byte);
TEST (host_flash_manager_dual_test_initialize_flash_protection_fixed_4byte);
TEST (host_flash_manager_dual_test_initialize_flash_protection_override_cs0);
TEST (host_flash_manager_dual_test_initialize_flash_protection_override_cs1);
TEST (host_flash_manager_dual_test_initialize_flash_protection_cs0_multiple_fw);
TEST (host_flash_manager_dual_test_initialize_flash_protection_cs1_multiple_fw);
TEST (host_flash_manager_dual_test_initialize_flash_protection_static_init);
TEST (host_flash_manager_dual_test_initialize_flash_protection_null);
TEST (host_flash_manager_dual_test_initialize_flash_protection_flash_mode_error);
TEST (host_flash_manager_dual_test_initialize_flash_protection_data_copy_error);
TEST (host_flash_manager_dual_test_initialize_flash_protection_dirty_clear_error);
TEST (host_flash_manager_dual_test_initialize_flash_protection_filter_addr_mode_error);
TEST (host_flash_manager_dual_test_initialize_flash_protection_filter_flash_mode_error);
TEST (host_flash_manager_dual_test_initialize_flash_protection_filter_error);
TEST (host_flash_manager_dual_test_get_flash_read_write_regions_ro_flash_cs0);
TEST (host_flash_manager_dual_test_get_flash_read_write_regions_ro_flash_cs1);
TEST (host_flash_manager_dual_test_get_flash_read_write_regions_ro_flash_override_cs0);
TEST (host_flash_manager_dual_test_get_flash_read_write_regions_ro_flash_override_cs1);
TEST (host_flash_manager_dual_test_get_flash_read_write_regions_ro_flash_single_fw);
TEST (host_flash_manager_dual_test_get_flash_read_write_regions_ro_flash_multiple_fw);
TEST (host_flash_manager_dual_test_get_flash_read_write_regions_rw_flash_cs1);
TEST (host_flash_manager_dual_test_get_flash_read_write_regions_rw_flash_cs0);
TEST (host_flash_manager_dual_test_get_flash_read_write_regions_rw_flash_override_cs1);
TEST (host_flash_manager_dual_test_get_flash_read_write_regions_rw_flash_override_cs0);
TEST (host_flash_manager_dual_test_get_flash_read_write_regions_rw_flash_single_fw);
TEST (host_flash_manager_dual_test_get_flash_read_write_regions_rw_flash_multiple_fw);
TEST (host_flash_manager_dual_test_get_flash_read_write_regions_static_init);
TEST (host_flash_manager_dual_test_get_flash_read_write_regions_null);
TEST (host_flash_manager_dual_test_get_flash_read_write_regions_pfm_firmware_error);
TEST (host_flash_manager_dual_test_get_flash_read_write_regions_pfm_version_error);
TEST (host_flash_manager_dual_test_get_flash_read_write_regions_pfm_version_error_multiple_fw);
TEST (host_flash_manager_dual_test_get_flash_read_write_regions_ro_flash_version_error);
TEST (host_flash_manager_dual_test_get_flash_read_write_regions_rw_flash_version_error);
TEST (host_flash_manager_dual_test_get_flash_read_write_regions_pfm_rw_error);
TEST (host_flash_manager_dual_test_get_flash_read_write_regions_pfm_rw_error_multiple_fw);
TEST (host_flash_manager_dual_test_host_has_flash_access);
TEST (host_flash_manager_dual_test_host_has_flash_access_rot_access);
TEST (host_flash_manager_dual_test_host_has_flash_access_filter_disabled);
TEST (host_flash_manager_dual_test_host_has_flash_access_static_init);
TEST (host_flash_manager_dual_test_host_has_flash_access_null);
TEST (host_flash_manager_dual_test_host_has_flash_access_access_check_error);
TEST (host_flash_manager_dual_test_host_has_flash_access_filter_check_error);
TEST (host_flash_manager_dual_test_restore_flash_read_write_regions_cs1);
TEST (host_flash_manager_dual_test_restore_flash_read_write_regions_cs0);
TEST (host_flash_manager_dual_test_restore_flash_read_write_regions_override_cs1);
TEST (host_flash_manager_dual_test_restore_flash_read_write_regions_override_cs0);
TEST (host_flash_manager_dual_test_restore_flash_read_write_regions_cs1_multiple_fw);
TEST (host_flash_manager_dual_test_restore_flash_read_write_regions_cs0_multiple_fw);
TEST (host_flash_manager_dual_test_restore_flash_read_write_regions_static_init);
...
TEST (host_flash_manager_dual_test_reset_flash_static_init);
