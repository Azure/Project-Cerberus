...
#include "mock/authorization_mock.h"


static const char *SUITE = "cmd_authorization";
...
CuSuite* get_cmd_authorization_suite ()
{
	...
	SUITE_ADD_TEST (suite, authorization_allowed_test_authorize_revert_bypass);
	SUITE_ADD_TEST (suite, authorization_allowed_test_authorize_revert_bypass_no_authorization);
	SUITE_ADD_TEST (suite, authorization_allowed_test_authorize_revert_bypass_challenge);
	SUITE_ADD_TEST (suite, authorization_allowed_test_authorize_revert_bypass_null);
	SUITE_ADD_TEST (suite, authorization_allowed_test_authorize_reset_defaults);
	...
	SUITE_ADD_TEST (suite, authorization_allowed_test_authorize_reset_intrusion);
	SUITE_ADD_TEST (suite, authorization_allowed_test_authorize_reset_intrusion_no_authorization);
	SUITE_ADD_TEST (suite, authorization_allowed_test_authorize_reset_intrusion_challenge);
	SUITE_ADD_TEST (suite, authorization_allowed_test_authorize_reset_intrusion_null);
