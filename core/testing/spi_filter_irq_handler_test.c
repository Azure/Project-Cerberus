...
static const char *SUITE = "spi_filter_irq_handler";
...
static void spi_filter_irq_handler_test_init (CuTest *test)
{
	...
	spi_filter_irq_handler_testing_init_host_state (test, &host_state, &flash_mock, &flash);
...
CuSuite* get_spi_filter_irq_handler_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, spi_filter_irq_handler_test_init);
	SUITE_ADD_TEST (suite, spi_filter_irq_handler_test_init_null);
	SUITE_ADD_TEST (suite, spi_filter_irq_handler_test_release_null);
	SUITE_ADD_TEST (suite, spi_filter_irq_handler_test_ro_flash_dirty);
	SUITE_ADD_TEST (suite, spi_filter_irq_handler_test_ro_flash_dirty_null);
