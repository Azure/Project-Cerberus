...
CuSuite* get_spi_flash_sfdp_suite ()
{
	...
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_init_id_error);
	...
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_device_capabilities_mx25l1606e);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_device_capabilities_mx25l25635f);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_device_capabilities_mx25l25645g);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_device_capabilities_w25q16jv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_device_capabilities_w25q256jv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_device_capabilities_mt25q256aba);
	...
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_device_size_mx25l1606e);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_device_size_mx25l25635f);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_device_size_mx25l25645g);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_device_size_w25q16jv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_device_size_w25q256jv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_device_size_mt25q256aba);
	...
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_read_commands_mx25l1606e);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_read_commands_mx25l25635f);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_read_commands_mx25l25645g);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_read_commands_w25q16jv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_read_commands_w25q256jv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_read_commands_mt25q256aba);
	...
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_use_busy_flag_status_mx25l1606e);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_use_busy_flag_status_mx25l25635f);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_use_busy_flag_status_mx25l25645g);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_use_busy_flag_status_w25q16jv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_use_busy_flag_status_w25q256jv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_use_busy_flag_status_mt25q256aba);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_use_busy_flag_status_null);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_use_volatile_write_enable_mx25l1606e);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_use_volatile_write_enable_mx25l25635f);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_use_volatile_write_enable_mx25l25645g);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_use_volatile_write_enable_w25q16jv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_use_volatile_write_enable_w25q256jv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_use_volatile_write_enable_mt25q256aba);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_use_volatile_write_enable_volatile_only);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_use_volatile_write_enable_both_volatile_and_nv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_use_volatile_write_enable_null);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_supports_4byte_commands_mx25l1606e);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_supports_4byte_commands_mx25l25635f);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_supports_4byte_commands_mx25l25645g);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_supports_4byte_commands_w25q16jv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_supports_4byte_commands_w25q256jv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_supports_4byte_commands_mt25q256aba);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_supports_4byte_commands_null);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_4byte_mode_switch_mx25l1606e);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_4byte_mode_switch_mx25l25635f);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_4byte_mode_switch_mx25l25645g);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_4byte_mode_switch_w25q16jv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_4byte_mode_switch_w25q256jv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_4byte_mode_switch_mt25q256aba);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_4byte_mode_switch_only_extended_addr_reg);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_4byte_mode_switch_only_bank_reg);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_4byte_mode_switch_only_nv_config_reg);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_4byte_mode_switch_null);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_4byte_mode_switch_no_exit_command);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_4byte_mode_switch_no_exit_command_write_enable);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_quad_enable_mx25l1606e);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_quad_enable_mx25l25635f);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_quad_enable_mx25l25645g);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_quad_enable_w25q16jv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_quad_enable_w25q256jv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_quad_enable_mt25q256aba);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_quad_enable_no_qe_bit_no_hold_disable);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_quad_enable_bit1_sr2_with_clear);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_quad_enable_bit7_sr2);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_quad_enable_bit1_sr2_with_35_read);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_quad_enable_old_table_version_no_qspi);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_quad_enable_null);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_quad_enable_reserved_value_6);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_quad_enable_reserved_value_7);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_quad_enable_old_table_version_with_qspi);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_exit_4byte_mode_on_reset_mx25l1606e);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_exit_4byte_mode_on_reset_mx25l25635f);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_exit_4byte_mode_on_reset_mx25l25645g);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_exit_4byte_mode_on_reset_w25q16jv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_exit_4byte_mode_on_reset_w25q256jv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_exit_4byte_mode_on_reset_mt25q256aba);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_exit_4byte_mode_on_reset_no_revert);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_exit_4byte_mode_on_reset_null);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_reset_command_mx25l1606e);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_reset_command_mx25l25635f);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_reset_command_mx25l25645g);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_reset_command_w25q16jv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_reset_command_w25q256jv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_reset_command_mt25q256aba);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_reset_command_f0);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_reset_command_both_f0_and_66);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_reset_command_no_soft_reset);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_reset_command_8clocks_f);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_reset_command_10clocks_f);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_reset_command_16clocks_f);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_reset_command_null);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_page_size_mx25l1606e);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_page_size_mx25l25635f);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_page_size_mx25l25645g);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_page_size_w25q16jv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_page_size_w25q256jv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_page_size_mt25q256aba);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_page_size_128_byte_page);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_page_size_max_page_size);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_page_size_null);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_deep_powerdown_commands_mx25l1606e);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_deep_powerdown_commands_mx25l25635f);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_deep_powerdown_commands_mx25l25645g);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_deep_powerdown_commands_w25q16jv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_deep_powerdown_commands_w25q256jv);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_deep_powerdown_commands_mt25q256aba);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_deep_powerdown_commands_non_standard);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_deep_powerdown_commands_not_supported);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_deep_powerdown_commands_old_table_version);
	SUITE_ADD_TEST (suite, spi_flash_sfdp_test_get_deep_powerdown_commands_null);
