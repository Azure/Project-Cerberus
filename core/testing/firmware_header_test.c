...
static const char *SUITE = "firmware_header";
...
CuSuite* get_firmware_header_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, firmware_header_test_init_format0);
	SUITE_ADD_TEST (suite, firmware_header_test_init_format1);
	SUITE_ADD_TEST (suite, firmware_header_test_init_format2);
	SUITE_ADD_TEST (suite, firmware_header_test_init_format3);
	SUITE_ADD_TEST (suite, firmware_header_test_init_unknown_format_max_length);
	SUITE_ADD_TEST (suite, firmware_header_test_init_null);
	SUITE_ADD_TEST (suite, firmware_header_test_init_bad_marker);
	SUITE_ADD_TEST (suite, firmware_header_test_init_read_base_error);
	SUITE_ADD_TEST (suite, firmware_header_test_init_read_data_error);
	SUITE_ADD_TEST (suite, firmware_header_test_init_less_than_min_length);
	SUITE_ADD_TEST (suite, firmware_header_test_init_format0_too_short);
	SUITE_ADD_TEST (suite, firmware_header_test_init_format0_too_long);
	SUITE_ADD_TEST (suite, firmware_header_test_init_format1_too_short);
	SUITE_ADD_TEST (suite, firmware_header_test_init_format1_too_long);
	SUITE_ADD_TEST (suite, firmware_header_test_init_format2_too_short);
	SUITE_ADD_TEST (suite, firmware_header_test_init_format2_too_long);
	SUITE_ADD_TEST (suite, firmware_header_test_init_format3_too_short);
	SUITE_ADD_TEST (suite, firmware_header_test_init_format3_too_long);
	SUITE_ADD_TEST (suite, firmware_header_test_init_unknown_format_too_short);
	SUITE_ADD_TEST (suite, firmware_header_test_init_unknown_format_too_long);
	SUITE_ADD_TEST (suite, firmware_header_test_release_null);
	SUITE_ADD_TEST (suite, firmware_header_test_get_recovery_revision_format0);
	SUITE_ADD_TEST (suite, firmware_header_test_get_recovery_revision_format1);
	SUITE_ADD_TEST (suite, firmware_header_test_get_recovery_revision_format2);
	SUITE_ADD_TEST (suite, firmware_header_test_get_recovery_revision_format3);
	SUITE_ADD_TEST (suite, firmware_header_test_get_recovery_revision_unknown_format);
	SUITE_ADD_TEST (suite, firmware_header_test_get_recovery_revision_null);
	SUITE_ADD_TEST (suite, firmware_header_test_get_extra_images_format1);
	SUITE_ADD_TEST (suite, firmware_header_test_get_extra_images_format2);
	SUITE_ADD_TEST (suite, firmware_header_test_get_extra_images_format3);
	SUITE_ADD_TEST (suite, firmware_header_test_get_extra_images_unknown_format);
	SUITE_ADD_TEST (suite, firmware_header_test_get_extra_images_null);
	SUITE_ADD_TEST (suite, firmware_header_test_get_extra_images_format0);
	SUITE_ADD_TEST (suite, firmware_header_test_get_earliest_allowed_revision_format2);
	SUITE_ADD_TEST (suite, firmware_header_test_get_earliest_allowed_revision_format3);
	SUITE_ADD_TEST (suite, firmware_header_test_get_earliest_allowed_revision_unknown_format);
	SUITE_ADD_TEST (suite, firmware_header_test_get_earliest_allowed_revision_null);
	SUITE_ADD_TEST (suite, firmware_header_test_get_earliest_allowed_revision_format0);
	SUITE_ADD_TEST (suite, firmware_header_test_get_earliest_allowed_revision_format1);
	SUITE_ADD_TEST (suite, firmware_header_test_get_signature_info_format3);
	SUITE_ADD_TEST (suite, firmware_header_test_get_signature_info_unknown_format);
	SUITE_ADD_TEST (suite, firmware_header_test_get_signature_info_null);
	SUITE_ADD_TEST (suite, firmware_header_test_get_signature_info_format0);
	SUITE_ADD_TEST (suite, firmware_header_test_get_signature_info_format1);
	SUITE_ADD_TEST (suite, firmware_header_test_get_signature_info_format2);
