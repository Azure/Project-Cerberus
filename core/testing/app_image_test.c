...
static const char *SUITE = "app_image";
...
CuSuite* get_app_image_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, app_image_test_get_length);
	SUITE_ADD_TEST (suite, app_image_test_get_length_null);
	SUITE_ADD_TEST (suite, app_image_test_get_length_error);
	SUITE_ADD_TEST (suite, app_image_test_get_signature);
	SUITE_ADD_TEST (suite, app_image_test_get_signature_null);
	SUITE_ADD_TEST (suite, app_image_test_get_signature_small_sig_buffer);
	SUITE_ADD_TEST (suite, app_image_test_get_signature_read_length_error);
	SUITE_ADD_TEST (suite, app_image_test_get_signature_read_signature_error);
	SUITE_ADD_TEST (suite, app_image_test_get_hash);
	SUITE_ADD_TEST (suite, app_image_test_get_hash_null);
	SUITE_ADD_TEST (suite, app_image_test_get_hash_small_buffer);
	SUITE_ADD_TEST (suite, app_image_test_get_hash_read_length_error);
	SUITE_ADD_TEST (suite, app_image_test_get_hash_read_data_error);
	SUITE_ADD_TEST (suite, app_image_test_verification);
	SUITE_ADD_TEST (suite, app_image_test_verification_with_hash_out);
	SUITE_ADD_TEST (suite, app_image_test_verification_no_match_signature);
	SUITE_ADD_TEST (suite, app_image_test_verification_null);
	SUITE_ADD_TEST (suite, app_image_test_verification_small_hash_buffer);
	SUITE_ADD_TEST (suite, app_image_test_verification_read_length_error);
	SUITE_ADD_TEST (suite, app_image_test_verification_read_signature_error);
	SUITE_ADD_TEST (suite, app_image_test_load);
	SUITE_ADD_TEST (suite, app_image_test_load_no_length_out);
	SUITE_ADD_TEST (suite, app_image_test_load_null);
	SUITE_ADD_TEST (suite, app_image_test_load_image_too_large);
	SUITE_ADD_TEST (suite, app_image_test_load_length_error);
	SUITE_ADD_TEST (suite, app_image_test_load_image_error);
	SUITE_ADD_TEST (suite, app_image_test_get_image_end);
	SUITE_ADD_TEST (suite, app_image_test_get_image_end_null);
	SUITE_ADD_TEST (suite, app_image_test_get_image_end_error);
	SUITE_ADD_TEST (suite, app_image_test_get_data_addr);
	SUITE_ADD_TEST (suite, app_image_test_get_data_addr_null);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_bad_data);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_no_hash_out);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_no_length_out);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_null);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_small_hash_buffer);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_image_too_large);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_read_length_error);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_read_image_error);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_read_signature_error);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_start_hash_error);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_update_hash_length_error);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_update_hash_image_error);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_update_finish_hash_error);
	SUITE_ADD_TEST (suite, app_image_test_verification_with_header);
	SUITE_ADD_TEST (suite, app_image_test_verification_with_header_with_hash_out);
	SUITE_ADD_TEST (suite, app_image_test_verification_with_header_no_match_signature);
	SUITE_ADD_TEST (suite, app_image_test_verification_with_header_zero_length);
	SUITE_ADD_TEST (suite, app_image_test_verification_with_header_null);
	SUITE_ADD_TEST (suite, app_image_test_verification_with_header_small_hash_buffer);
	SUITE_ADD_TEST (suite, app_image_test_verification_with_header_read_length_error);
	SUITE_ADD_TEST (suite, app_image_test_verification_with_header_read_signature_error);
	SUITE_ADD_TEST (suite, app_image_test_get_hash_with_header);
	SUITE_ADD_TEST (suite, app_image_test_get_hash_with_header_zero_length);
	SUITE_ADD_TEST (suite, app_image_test_get_hash_with_header_null);
	SUITE_ADD_TEST (suite, app_image_test_get_hash_with_header_small_buffer);
	SUITE_ADD_TEST (suite, app_image_test_get_hash_with_header_read_length_error);
	SUITE_ADD_TEST (suite, app_image_test_get_hash_with_header_read_data_error);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_with_header);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_with_header_bad_data);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_with_header_no_hash_out);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_with_header_no_length_out);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_with_header_zero_length);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_with_header_null);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_with_header_small_hash_buffer);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_with_header_image_too_large);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_with_header_read_length_error);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_with_header_read_image_error);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_with_header_read_signature_error);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_with_header_read_header_error);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_with_header_start_hash_error);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_with_header_hash_header_error);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_with_header_hash_length_error);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_with_header_hash_image_error);
	SUITE_ADD_TEST (suite, app_image_test_load_and_verify_with_header_finish_hash_error);
