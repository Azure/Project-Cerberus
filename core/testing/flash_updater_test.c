...
static const char *SUITE = "flash_updater";
...
CuSuite* get_flash_updater_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, flash_updater_test_init);
	SUITE_ADD_TEST (suite, flash_updater_test_init_not_block_aligned);
	SUITE_ADD_TEST (suite, flash_updater_test_init_null);
	SUITE_ADD_TEST (suite, flash_updater_test_init_sector);
	SUITE_ADD_TEST (suite, flash_updater_test_init_sector_not_sector_aligned);
	SUITE_ADD_TEST (suite, flash_updater_test_init_sector_null);
	SUITE_ADD_TEST (suite, flash_updater_test_release_null);
	SUITE_ADD_TEST (suite, flash_updater_test_prepare_for_update);
	SUITE_ADD_TEST (suite, flash_updater_test_prepare_for_update_sector);
	SUITE_ADD_TEST (suite, flash_updater_test_prepare_for_update_not_aligned);
	SUITE_ADD_TEST (suite, flash_updater_test_prepare_for_update_with_offset);
	SUITE_ADD_TEST (suite, flash_updater_test_prepare_for_update_zero_length);
	SUITE_ADD_TEST (suite, flash_updater_test_prepare_for_update_null);
	SUITE_ADD_TEST (suite, flash_updater_test_prepare_for_update_too_large);
	SUITE_ADD_TEST (suite, flash_updater_test_prepare_for_update_erase_error);
	SUITE_ADD_TEST (suite, flash_updater_test_prepare_for_update_erase_all);
	SUITE_ADD_TEST (suite, flash_updater_test_prepare_for_update_erase_all_sector);
	SUITE_ADD_TEST (suite, flash_updater_test_prepare_for_update_erase_all_not_aligned);
	SUITE_ADD_TEST (suite, flash_updater_test_prepare_for_update_erase_all_with_offset);
	SUITE_ADD_TEST (suite, flash_updater_test_prepare_for_update_erase_all_zero_length);
	SUITE_ADD_TEST (suite, flash_updater_test_prepare_for_update_erase_all_null);
	SUITE_ADD_TEST (suite, flash_updater_test_prepare_for_update_erase_all_too_large);
	SUITE_ADD_TEST (suite, flash_updater_test_prepare_for_update_erase_all_erase_error);
	SUITE_ADD_TEST (suite, flash_updater_test_write_update_data);
	SUITE_ADD_TEST (suite, flash_updater_test_write_update_data_multiple);
	SUITE_ADD_TEST (suite, flash_updater_test_write_update_data_region_end);
	SUITE_ADD_TEST (suite, flash_updater_test_write_update_data_with_offset);
	SUITE_ADD_TEST (suite, flash_updater_test_write_update_data_null);
	SUITE_ADD_TEST (suite, flash_updater_test_write_update_data_write_error);
	SUITE_ADD_TEST (suite, flash_updater_test_write_update_data_write_after_error);
	SUITE_ADD_TEST (suite, flash_updater_test_write_update_data_partial_write);
	SUITE_ADD_TEST (suite, flash_updater_test_write_update_data_write_after_partial_write);
	SUITE_ADD_TEST (suite, flash_updater_test_write_update_data_region_full);
	SUITE_ADD_TEST (suite, flash_updater_test_write_update_data_region_full_with_offset);
	SUITE_ADD_TEST (suite, flash_updater_test_write_update_data_too_long);
	SUITE_ADD_TEST (suite, flash_updater_test_write_update_data_too_long_with_offset);
	SUITE_ADD_TEST (suite, flash_updater_test_write_update_data_restart_write);
	SUITE_ADD_TEST (suite, flash_updater_test_write_update_data_restart_write_erase_all);
	SUITE_ADD_TEST (suite, flash_updater_test_write_update_data_restart_write_with_offset);
	SUITE_ADD_TEST (suite, flash_updater_test_write_update_data_restart_write_erase_error);
	SUITE_ADD_TEST (suite, flash_updater_test_get_remaining_bytes_null);
	SUITE_ADD_TEST (suite, flash_updater_test_get_bytes_written_null);
	SUITE_ADD_TEST (suite, flash_updater_test_apply_update_offset_null);
	SUITE_ADD_TEST (suite, flash_updater_test_check_update_size);
	SUITE_ADD_TEST (suite, flash_updater_test_check_update_size_with_offset);
	SUITE_ADD_TEST (suite, flash_updater_test_check_update_size_max_size);
	SUITE_ADD_TEST (suite, flash_updater_test_check_update_size_max_size_with_offset);
	SUITE_ADD_TEST (suite, flash_updater_test_check_update_size_null);
	SUITE_ADD_TEST (suite, flash_updater_test_check_update_size_too_large);
	SUITE_ADD_TEST (suite, flash_updater_test_check_update_size_too_large_with_offset);
