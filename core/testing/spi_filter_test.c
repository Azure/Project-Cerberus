...
static void spi_filter_test_log_filter_config_port0 (CuTest *test)
{
	...
	debug_log = &log.base;
	spi_filter_log_filter_config (port, mfg, flag, ro, addr, dirty, bypass, region_start,
...
CuSuite* get_spi_filter_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, spi_filter_test_log_configuration_port0);
	SUITE_ADD_TEST (suite, spi_filter_test_log_configuration_port1);
	SUITE_ADD_TEST (suite, spi_filter_test_log_configuration_bypass_cs1);
