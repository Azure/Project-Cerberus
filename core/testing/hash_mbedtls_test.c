...
static const char *SUITE = "hash_mbedtls";
...
static void hash_mbedtls_test_release_no_init (CuTest *test)
{
	struct hash_engine_mbedtls engine;
...
static void hash_mbedtls_test_incremental_cancel (CuTest *test)
{
	struct hash_engine_mbedtls engine;
	int status;
	char *message = "Test";
...
CuSuite* get_hash_mbedtls_suite ()
{
	CuSuite *suite = CuSuiteNew ();

	SUITE_ADD_TEST (suite, hash_mbedtls_test_init);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_init_null);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_release_null);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_release_no_init);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha1_incremental);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha1_incremental_multi);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha1_incremental_empty_hash_buffer);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_incremental_cancel);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha1_start_incremental_null);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_incremental_update_null);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_incremental_update_no_start);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha1_update_after_finish);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_incremental_finish_null);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_incremental_finish_no_start);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha1_finish_after_finish);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha1_finish_small_hash_buffer);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_incremental_cancel_null);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_incremental_cancel_no_start);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha256_incremental);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha256_incremental_multi);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha256_incremental_empty_hash_buffer);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha256_start_incremental_null);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha256_update_after_finish);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha256_finish_after_finish);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha256_finish_small_hash_buffer);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha384_incremental);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha384_incremental_multi);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha384_incremental_empty_hash_buffer);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha384_start_incremental_null);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha384_update_after_finish);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha384_finish_after_finish);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha384_finish_small_hash_buffer);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha512_incremental);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha512_incremental_multi);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha512_incremental_empty_hash_buffer);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha512_start_incremental_null);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha512_update_after_finish);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha512_finish_after_finish);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_sha512_finish_small_hash_buffer);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_calculate_sha1);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_calculate_sha1_empty_hash_buffer);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_calculate_sha1_null);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_calculate_sha1_small_hash_buffer);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_calculate_sha256);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_calculate_sha256_empty_hash_buffer);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_calculate_sha256_null);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_calculate_sha256_small_hash_buffer);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_calculate_sha384);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_calculate_sha384_empty_hash_buffer);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_calculate_sha384_null);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_calculate_sha384_small_hash_buffer);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_calculate_sha512);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_calculate_sha512_empty_hash_buffer);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_calculate_sha512_null);
	SUITE_ADD_TEST (suite, hash_mbedtls_test_calculate_sha512_small_hash_buffer);
