...
CuSuite* get_recovery_image_manager_suite ()
{
	...
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_null);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_bad_signature);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_bad_signature_ecc);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_malformed);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_bad_platform_id);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_flash_error);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_image_header_too_small);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_image_header_bad_marker);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_image_header_too_long);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_image_header_bad_format_length);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_image_header_bad_platform_id);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_image_header_bad_version_id);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_image_header_bad_image_length);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_section_header_bad_length);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_invalid_section_address);

	SUITE_ADD_TEST (suite, recovery_image_manager_test_release_null);

	SUITE_ADD_TEST (suite, recovery_image_manager_test_add_observer_null);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_remove_observer_null);

	SUITE_ADD_TEST (suite, recovery_image_manager_test_get_active_recovery_image);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_get_active_recovery_image_null);

	SUITE_ADD_TEST (suite, recovery_image_manager_test_clear_recovery_image_region_null);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_clear_recovery_image_region_image_too_large);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_clear_recovery_image_region);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_clear_recovery_image_region_erase_error);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_clear_recovery_image_region_image_in_use);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_region_image_in_use_multiple);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_region_image_not_in_use);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_region_extra_free_call);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_region_free_null_region);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_region_free_null_manager);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_region_in_use_after_activate);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_region_with_valid_image_notify_observers);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_region_with_invalid_image_notify_observers);

	SUITE_ADD_TEST (suite, recovery_image_manager_test_write_recovery_image_data_null);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_write_recovery_image_data_without_clear);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_write_recovery_image_data_too_long);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_write_recovery_image_data_write_error);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_write_recovery_image_data_partial_write);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_write_recovery_image_data);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_write_recovery_image_data_multiple);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_write_recovery_image_data_block_end);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_write_recovery_image_data_write_after_error);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_write_recovery_image_data_write_after_partial_write);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_write_recovery_image_data_restart_write);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_write_recovery_image_data_image_in_use);

	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_write_after_incomplete_image);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_activate_recovery_image_incomplete_image);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_activate_recovery_image);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_activate_recovery_image_notify_observers);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_activate_recovery_image_no_pending_image);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_no_pending_notify_observers);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_activate_recovery_image_null);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_already_valid_notify_observers);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_activate_recovery_image_already_valid);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_recovery_image_malformed);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_activate_recovery_image_extra_data_written);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_activate_recovery_image_verify_error);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_verify_error_notify_observers);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_activate_recovery_image_verify_fail);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_activate_recovery_image_verify_fail_ecc);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_activate_after_verify_error);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_activate_after_verify_fail);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_write_after_activate);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_write_after_activate_fail);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_activate_recovery_image_with_active);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_activate_recovery_image_no_event_handler);

	SUITE_ADD_TEST (suite, recovery_image_manager_test_erase_all_recovery_regions);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_erase_all_recovery_regions_null);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_erase_all_recovery_regions_image_in_use);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_erase_all_recovery_regions_during_update);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_erase_all_recovery_regions_erase_error);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_erase_all_recovery_regions_valid_image_notify_observers);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_erase_all_recovery_regions_invalid_image_notify_observers);

	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_two_region);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_two_region_active_region1);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_two_region_active_region2);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_two_region_null);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_two_region_region1_bad_platform_id);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_two_region_region2_bad_platform_id);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_two_region_region1_flash_error);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_two_region_region2_flash_error);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_two_region_region1_bad_signature);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_two_region_region2_bad_signature);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_init_two_region_region1_bad_signature_ecc);
	...
	SUITE_ADD_TEST (suite, recovery_image_manager_test_clear_recovery_image_two_region_null);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_clear_recovery_image_two_region_region1);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_clear_recovery_image_two_region_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_two_region_region1_image_too_large);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_two_region_region2_image_too_large);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_two_region_erase_error_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_two_region_erase_error_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_two_region_in_use_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_two_region_in_use_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_two_region_in_use_multiple_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_two_region_in_use_multiple_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_two_region_extra_free_call_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_two_region_extra_free_call_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_two_region_free_null_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_two_region_free_null_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_two_region_free_null_manager_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_two_region_free_null_manager_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_two_region_in_use_after_activate_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_two_region_in_use_after_activate_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_two_region_not_in_use_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_two_region_not_in_use_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_two_region_notify_observers_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_clear_recovery_image_two_region_notify_observers_region2);

	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_write_recovery_image_data_two_region_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_write_recovery_image_data_two_region_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_write_recovery_image_data_two_region_without_clear);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_write_recovery_image_data_two_region_too_long);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_write_recovery_image_data_two_region_write_error);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_write_recovery_image_data_two_region_partial_write);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_write_recovery_image_data_two_region_multiple);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_write_recovery_image_data_two_region_block_end);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_write_recovery_image_data_two_region_write_after_error);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_write_recovery_image_data_two_region_write_after_partial_write);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_write_recovery_image_data_two_region_restart_write);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_write_recovery_image_data_two_region_in_use);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_write_recovery_image_data_two_region_write_after_incomplete_image);

	SUITE_ADD_TEST (suite, recovery_image_manager_test_activate_recovery_image_two_region_region1);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_activate_recovery_image_two_region_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_region1_notify_observers);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_region2_notify_observers);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_no_pending_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_no_pending_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_no_pending_notify_observers_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_no_pending_notify_observers_region2);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_activate_recovery_image_two_region_null);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_write_after_incomplete_image_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_write_after_incomplete_image_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_after_incomplete_image_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_after_incomplete_image_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_verify_and_notify_observers_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_verify_and_notify_observers_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_verify_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_verify_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_malformed_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_malformed_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_extra_data_written_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_extra_data_written_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_verify_error_notify_observers_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_verify_error_notify_observers_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_write_after_activate_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_write_after_activate_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_write_after_activate_fail_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_write_after_activate_fail_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_with_active_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_with_active_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_no_event_handler_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_activate_recovery_image_two_region_no_event_handler_region2);

	SUITE_ADD_TEST (suite, recovery_image_manager_test_erase_all_recovery_regions_region1);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_erase_all_recovery_regions_region2);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_erase_all_recovery_regions_null_region1);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_erase_all_recovery_regions_null_region2);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_erase_all_recovery_regions_in_use_region1);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_erase_all_recovery_regions_in_use_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_erase_all_recovery_regions_erase_error_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_erase_all_recovery_regions_erase_error_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_erase_all_recovery_regions_valid_image_notify_observers_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_erase_all_recovery_regions_invalid_image_notify_observers_region1);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_erase_all_recovery_regions_valid_image_notify_observers_region2);
	SUITE_ADD_TEST (suite,
		recovery_image_manager_test_erase_all_recovery_regions_invalid_image_notify_observers_region2);

	SUITE_ADD_TEST (suite, recovery_image_manager_test_set_port);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_set_port_null);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_get_port_null);

	SUITE_ADD_TEST (suite, recovery_image_manager_test_get_flash_update_manager);
	SUITE_ADD_TEST (suite, recovery_image_manager_test_get_flash_update_manager_after_write);
