...
CuSuite* get_hash_suite ()
{
	...
	SUITE_ADD_TEST (suite, hash_test_hmac_sha384_incremental);
	SUITE_ADD_TEST (suite, hash_test_hmac_sha384_incremental_large_key);
	SUITE_ADD_TEST (suite, hash_test_hmac_sha512_incremental);
	SUITE_ADD_TEST (suite, hash_test_hmac_sha512_incremental_large_key);
	...
	SUITE_ADD_TEST (suite, hash_test_hmac_init_sha384_large_key_error);
	SUITE_ADD_TEST (suite, hash_test_hmac_init_sha512_large_key_error);
	SUITE_ADD_TEST (suite, hash_test_hmac_update_null);
	SUITE_ADD_TEST (suite, hash_test_hmac_finish_null);
	SUITE_ADD_TEST (suite, hash_test_hmac_finish_sha1_small_buffer);
	SUITE_ADD_TEST (suite, hash_test_hmac_finish_sha256_small_buffer);
	SUITE_ADD_TEST (suite, hash_test_hmac_finish_sha384_small_buffer);
	SUITE_ADD_TEST (suite, hash_test_hmac_finish_sha512_small_buffer);
	...
	SUITE_ADD_TEST (suite, hash_test_hmac_sha384);
	SUITE_ADD_TEST (suite, hash_test_hmac_sha384_large_key);
	SUITE_ADD_TEST (suite, hash_test_hmac_sha512);
	SUITE_ADD_TEST (suite, hash_test_hmac_sha512_large_key);
	...
	SUITE_ADD_TEST (suite, hash_test_hash_generate_hmac_sha384_small_buffer);
	SUITE_ADD_TEST (suite, hash_test_hash_generate_hmac_sha512_small_buffer);
	SUITE_ADD_TEST (suite, hash_test_start_new_hash_sha1);
	SUITE_ADD_TEST (suite, hash_test_start_new_hash_sha256);
	SUITE_ADD_TEST (suite, hash_test_start_new_hash_sha384);
	SUITE_ADD_TEST (suite, hash_test_start_new_hash_sha512);
	SUITE_ADD_TEST (suite, hash_test_start_new_hash_unknown);
	SUITE_ADD_TEST (suite, hash_test_start_new_hash_null);
	SUITE_ADD_TEST (suite, hash_test_start_new_hash_sha1_error);
	SUITE_ADD_TEST (suite, hash_test_start_new_hash_sha256_error);
	SUITE_ADD_TEST (suite, hash_test_start_new_hash_sha384_error);
	SUITE_ADD_TEST (suite, hash_test_start_new_hash_sha512_error);
	SUITE_ADD_TEST (suite, hash_test_calculate_sha1);
	SUITE_ADD_TEST (suite, hash_test_calculate_sha256);
	SUITE_ADD_TEST (suite, hash_test_calculate_sha384);
	SUITE_ADD_TEST (suite, hash_test_calculate_sha512);
	SUITE_ADD_TEST (suite, hash_test_calculate_unknown);
	SUITE_ADD_TEST (suite, hash_test_calculate_null);
	SUITE_ADD_TEST (suite, hash_test_calculate_sha1_small_buffer);
	SUITE_ADD_TEST (suite, hash_test_calculate_sha256_small_buffer);
	SUITE_ADD_TEST (suite, hash_test_calculate_sha384_small_buffer);
	SUITE_ADD_TEST (suite, hash_test_calculate_sha512_small_buffer);
