...
static void
x509_cert_build_test_create_ca_signed_certificate_intermediate_ca_ecc384_ca_private_key_sha256_digest
(
	CuTest *test)
{
	HASH_TESTING_ENGINE (hash);
...
static void x509_cert_build_test_create_ca_signed_certificate_null (CuTest *test)
{
	...
	status = engine.base.create_ca_signed_certificate (&engine.base, &cert, RSA_PUBKEY_DER,	0,
	...
	status = engine.base.create_ca_signed_certificate (&engine.base, &cert, RSA_PUBKEY_DER,
		RSA_PUBKEY_DER_LEN, NULL, X509_CA2_SERIAL_NUM_LEN, X509_CA2_SUBJECT_NAME, X509_CERT_CA,
		ECC_PRIVKEY_DER, ECC_PRIVKEY_DER_LEN, HASH_TYPE_SHA256, &ca_cert, NULL, 0);
	CuAssertIntEquals (test, X509_ENGINE_INVALID_ARGUMENT, status);

	status = engine.base.create_ca_signed_certificate (&engine.base, &cert, RSA_PUBKEY_DER,
		RSA_PUBKEY_DER_LEN, X509_CA2_SERIAL_NUM, 0, X509_CA2_SUBJECT_NAME, X509_CERT_CA,
		ECC_PRIVKEY_DER, ECC_PRIVKEY_DER_LEN, HASH_TYPE_SHA256, &ca_cert, NULL, 0);
	CuAssertIntEquals (test, X509_ENGINE_INVALID_ARGUMENT, status);

	status = engine.base.create_ca_signed_certificate (&engine.base, &cert, RSA_PUBKEY_DER,
		RSA_PUBKEY_DER_LEN, X509_CA2_SERIAL_NUM, X509_CA2_SERIAL_NUM_LEN, NULL,	X509_CERT_CA,
		ECC_PRIVKEY_DER, ECC_PRIVKEY_DER_LEN, HASH_TYPE_SHA256, &ca_cert, NULL, 0);
	CuAssertIntEquals (test, X509_ENGINE_INVALID_ARGUMENT, status);
...
#endif
TEST (x509_cert_build_test_create_csr_ecc384_ca_sha256_digest);
TEST (x509_cert_build_test_create_csr_ecc384_end_entity_sha256_digest);
#endif
#if (ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_521) && defined HASH_ENABLE_SHA512
...
#endif
TEST (x509_cert_build_test_create_self_signed_certificate_ecc384_ca_sha256_digest);
TEST (x509_cert_build_test_create_self_signed_certificate_ecc384_end_entity_sha256_digest);
#endif
#if (ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_521) && defined HASH_ENABLE_SHA512
...
#endif
TEST (x509_cert_build_test_create_ca_signed_certificate_intermediate_ca_ecc384_ca_private_key_sha256_digest);
TEST (x509_cert_build_test_create_ca_signed_certificate_ecc384_end_entity_private_key_sha256_digest);
#endif
#if (ECC_MAX_KEY_LENGTH >= ECC_KEY_LENGTH_521) && defined HASH_ENABLE_SHA512
