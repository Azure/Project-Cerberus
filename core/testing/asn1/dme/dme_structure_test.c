...
static void dme_structure_test_init_le_ecc384_with_sha512_nonce_and_challenge_null (CuTest *test)
{
	...
	status = dme_structure_init_le_ecc384_with_sha512_nonce_and_challenge (&dme,
		NULL, DME_STRUCTURE_TESTING_TYPE7_DATA_LEN, ECC_PUBKEY2_DER,
		ECC_PUBKEY2_DER_LEN, DME_STRUCTURE_TESTING_TYPE7_SIG_ECC256_SHA256,
		DME_STRUCTURE_TESTING_TYPE7_SIG_ECC256_SHA256_LEN, HASH_TYPE_SHA256);
	CuAssertIntEquals (test, DME_STRUCTURE_INVALID_ARGUMENT, status);
	...
	status = dme_structure_init_le_ecc384_with_sha512_nonce_and_challenge (&dme,
		DME_STRUCTURE_TESTING_TYPE7_DATA, DME_STRUCTURE_TESTING_TYPE7_DATA_LEN, ECC_PUBKEY2_DER,
		0, DME_STRUCTURE_TESTING_TYPE7_SIG_ECC256_SHA256,
		DME_STRUCTURE_TESTING_TYPE7_SIG_ECC256_SHA256_LEN, HASH_TYPE_SHA256);
	CuAssertIntEquals (test, DME_STRUCTURE_INVALID_ARGUMENT, status);

	status = dme_structure_init_le_ecc384_with_sha512_nonce_and_challenge (&dme,
		DME_STRUCTURE_TESTING_TYPE7_DATA, DME_STRUCTURE_TESTING_TYPE7_DATA_LEN, ECC_PUBKEY2_DER,
		ECC_PUBKEY2_DER_LEN, NULL,
		DME_STRUCTURE_TESTING_TYPE7_SIG_ECC256_SHA256_LEN, HASH_TYPE_SHA256);
	CuAssertIntEquals (test, DME_STRUCTURE_INVALID_ARGUMENT, status);
...
static void dme_structure_test_init_le_ecc384_with_sha512_nonce_and_challenge_unsupported_signature_hash (
	CuTest *test)
{
	struct dme_structure dme;
	int status;
