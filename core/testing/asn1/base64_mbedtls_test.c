...
#include "asn1/base64_mbedtls_static.h"
...
static void base64_mbedtls_test_static_init (CuTest *test)
{
	struct base64_engine_mbedtls engine = base64_mbedtls_static_init;
...
static void base64_mbedtls_test_encode_static_init (CuTest *test)
{
	struct base64_engine_mbedtls engine = base64_mbedtls_static_init;
	int status;
	uint8_t out[BASE64_ENCODED_BLOCK_LEN * 2];
...
TEST (base64_mbedtls_test_init_null);
TEST (base64_mbedtls_test_static_init);
TEST (base64_mbedtls_test_release_null);
TEST (base64_mbedtls_test_encode);
TEST (base64_mbedtls_test_encode_pad_one_byte);
TEST (base64_mbedtls_test_encode_pad_two_bytes);
TEST (base64_mbedtls_test_encode_not_multiple_of_4);
TEST (base64_mbedtls_test_encode_static_init);
TEST (base64_mbedtls_test_encode_null);
