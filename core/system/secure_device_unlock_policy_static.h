...
#ifndef SECURE_DEVICE_UNLOCK_POLICY_STATIC_H_
#define SECURE_DEVICE_UNLOCK_POLICY_STATIC_H_
 ...
 */
#define	SECURE_DEVICE_UNLOCK_POLICY_API_INIT	{ \
		.get_unlock_token = secure_device_unlock_policy_get_unlock_token, \
		.apply_unlock_policy = secure_device_unlock_policy_apply_unlock_policy, \
		.clear_unlock_policy = secure_device_unlock_policy_clear_unlock_policy, \
	}
 ...
 */
#define	secure_device_unlock_policy_static_init(token_ptr, manager_ptr)	{ \
		.base = SECURE_DEVICE_UNLOCK_POLICY_API_INIT, \
		.token = token_ptr, \
		.manager = manager_ptr, \
	}
