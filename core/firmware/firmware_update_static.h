 ...
 * @param hash_ptr The hash engine to use during updates.
 */
#define	firmware_update_static_init_authorized(state_ptr, flash_ptr, context_ptr, fw_ptr, \
	security_ptr, hash_ptr)	{ \
		.internal = FIRMWARE_UPDATE_INTERNAL_API_INIT, \
		.state = state_ptr, \
		.flash = flash_ptr, \
 ...
 * @param hash_ptr The hash engine to use during updates.
 */
#define	firmware_update_static_init_authorized_no_firmware_header(state_ptr, flash_ptr, \
	context_ptr, fw_ptr, security_ptr, hash_ptr)	{ \
		.internal = FIRMWARE_UPDATE_INTERNAL_API_INIT, \
		.state = state_ptr, \
		.flash = flash_ptr, \
		.fw = fw_ptr, \
