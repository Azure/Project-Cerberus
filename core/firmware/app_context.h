 ...
 */
enum {
	APP_CONTEXT_INVALID_ARGUMENT = APP_CONTEXT_ERROR (0),	/**< Input parameter is null or not valid. */
	APP_CONTEXT_NO_MEMORY = APP_CONTEXT_ERROR (1),			/**< Memory allocation failed. */
	APP_CONTEXT_SAVE_FAILED = APP_CONTEXT_ERROR (2),		/**< The running context has not been saved. */
	APP_CONTEXT_NO_CONTEXT = APP_CONTEXT_ERROR (3),			/**< No context is available. */
};
