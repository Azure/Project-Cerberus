...
#ifndef HOST_PROCESSOR_DUAL_FULL_BYPASS_STATIC_H_
#define HOST_PROCESSOR_DUAL_FULL_BYPASS_STATIC_H_

#include "host_processor_dual_full_bypass.h"
#include "host_processor_dual_static.h"


/* Internal functions declared to allow for static initialization. */
int host_processor_dual_full_bypass_enable_bypass_mode (const struct host_processor_filtered *host);
 ...
 * flash devices.  Unprotected flash will be accessible in full bypass mode.
 *
 ...
 */
#define	host_processor_dual_full_bypass_static_init(state_ptr, control_ptr, flash_ptr, \
	host_state_ptr, filter_ptr, pfm_ptr, recovery_ptr)  \
		host_processor_dual_static_init_internal (state_ptr, control_ptr, flash_ptr, \
			...
			HOST_PROCESSOR_DUAL_FULL_BYPASS_INTERNAL_API_INIT)
 ...
 */
#define	host_processor_dual_full_bypass_static_init_pulse_reset(state_ptr, control_ptr, flash_ptr, \
 ...
 * @param recovery_ptr The manager for recovery of the host processor.
 */
#define	host_processor_dual_full_bypass_static_init_reset_flash(state_ptr, control_ptr, flash_ptr, \
	host_state_ptr, filter_ptr, pfm_ptr, recovery_ptr)  \
		host_processor_dual_static_init_internal (state_ptr, control_ptr, flash_ptr, \
 ...
 * will be held instead of being pulsed.
 */
#define	host_processor_dual_full_bypass_static_init_reset_flash_pulse_reset(state_ptr, \
...
#endif	/* HOST_PROCESSOR_DUAL_FULL_BYPASS_STATIC_H_ */
