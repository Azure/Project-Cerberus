...
#ifndef HOST_PROCESSOR_SINGLE_STATIC_H_
#define HOST_PROCESSOR_SINGLE_STATIC_H_
 ...
 */
#define	HOST_PROCESSOR_SINGLE_API_INIT  \
	.power_on_reset = host_processor_single_power_on_reset, \
	.soft_reset = host_processor_single_soft_reset, \
	.run_time_verification = host_processor_single_run_time_verification, \
	.flash_rollback = host_processor_single_flash_rollback, \
	.recover_active_read_write_data = host_processor_single_recover_active_read_write_data, \
	...
	.bypass_mode = host_processor_single_bypass_mode, \
	.get_flash_config = host_processor_single_get_flash_config, \
	.config_read_only_flash = host_processor_single_config_read_only_flash,

/**
 * Constant initializer for internal APIs.
 */
#define	HOST_PROCESSOR_SINGLE_INTERNAL_API_INIT	{ \
		.enable_bypass_mode = host_processor_single_full_read_write_flash, \
...
/**
 * Internal initializer for a static instance for executing host processor actions using a single
 * flash device.
 *
 ...
 */
#define	host_processor_single_static_init_internal(state_ptr, control_ptr, flash_ptr, \
	host_state_ptr, filter_ptr, pfm_ptr, recovery_ptr, pulse_width_arg, reset_flash_arg, \
	internal_api)	{ \
		.base = { \
			HOST_PROCESSOR_SINGLE_API_INIT \
 ...
 * @param recovery_ptr The manager for recovery of the host processor.
 */
#define	host_processor_single_static_init(state_ptr, control_ptr, flash_ptr, host_state_ptr, \
	filter_ptr, pfm_ptr, recovery_ptr)  \
		host_processor_single_static_init_internal (state_ptr, control_ptr, flash_ptr, \
			...
			HOST_PROCESSOR_SINGLE_INTERNAL_API_INIT)
 ...
 * will be held instead of being pulsed.
 */
#define	host_processor_single_static_init_pulse_reset(state_ptr, control_ptr, flash_ptr, \
 ...
 * @param recovery_ptr The manager for recovery of the host processor.
 */
#define	host_processor_single_static_init_reset_flash(state_ptr, control_ptr, flash_ptr, \
 ...
 * will be held instead of being pulsed.
 */
#define	host_processor_single_static_init_reset_flash_pulse_reset(state_ptr, control_ptr, \
...
#endif	/* HOST_PROCESSOR_SINGLE_STATIC_H_ */
