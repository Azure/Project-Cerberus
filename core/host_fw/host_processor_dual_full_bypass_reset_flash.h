...
#ifndef HOST_PROCESSOR_DUAL_FULL_BYPASS_RESET_FLASH_H_
#define HOST_PROCESSOR_DUAL_FULL_BYPASS_RESET_FLASH_H_
...
#endif /* HOST_PROCESSOR_DUAL_FULL_BYPASS_RESET_FLASH_H_ */
