 ...
 */
enum {
	HOST_FLASH_INIT_INVALID_ARGUMENT = HOST_FLASH_INIT_ERROR (0),	/**< Input parameter is null or not valid. */
	HOST_FLASH_INIT_NO_MEMORY = HOST_FLASH_INIT_ERROR (1),			/**< Memory allocation failed. */
};
