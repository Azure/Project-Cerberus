 ...
 */
enum {
	HOST_CONTROL_INVALID_ARGUMENT = HOST_CONTROL_ERROR (0),			/**< Input parameter is null or not valid. */
	HOST_CONTROL_NO_MEMORY = HOST_CONTROL_ERROR (1),				/**< Memory allocation failed. */
	HOST_CONTROL_HOLD_RESET_FAILED = HOST_CONTROL_ERROR (2),		/**< The host reset has not been enabled/disabled. */
	HOST_CONTROL_HOLD_CHECK_FAILED = HOST_CONTROL_ERROR (3),		/**< Could not determine if the host is being held in reset. */
	HOST_CONTROL_RESET_CHECK_FAILED = HOST_CONTROL_ERROR (4),		/**< Could not determine if the host is in reset. */
	HOST_CONTROL_FLASH_ACCESS_FAILED = HOST_CONTROL_ERROR (5),		/**< Host flash access has not been enabled/disabled. */
	HOST_CONTROL_FLASH_CHECK_FAILED = HOST_CONTROL_ERROR (6),		/**< Could not determine if the hosh has flash access. */
};
