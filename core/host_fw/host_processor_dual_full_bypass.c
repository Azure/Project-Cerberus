...
{
	int status = host_processor_dual_init_internal (host, state, control, flash, host_state, filter,
	...
	struct recovery_image_manager *recovery, int pulse_width)
{
	...
	status = host_processor_dual_init_internal (host, state, control, flash, host_state, filter,
 ...
 */
void host_processor_dual_full_bypass_release (const struct host_processor_filtered *host)
{
