 ...
 */
enum {
	HOST_IRQ_CTRL_INVALID_ARGUMENT = HOST_IRQ_CTRL_ERROR (0),		/**< Input parameter is null or not valid. */
	HOST_IRQ_CTRL_NO_MEMORY = HOST_IRQ_CTRL_ERROR (1),				/**< Memory allocation failed. */
	HOST_IRQ_CTRL_EXIT_RESET_FAILED = HOST_IRQ_CTRL_ERROR (2),		/**< Exit reset IRQ has not been enabled/disabled. */
	HOST_IRQ_CTRL_CHIP_SEL_FAILED = HOST_IRQ_CTRL_ERROR (3),		/**< Chip select IRQs have not been enabled/disabled. */
	HOST_IRQ_CTRL_IRQ_NOT_SUPPORTED = HOST_IRQ_CTRL_ERROR (4),		/**< The type of IRQ is not supported by the driver. */
};
