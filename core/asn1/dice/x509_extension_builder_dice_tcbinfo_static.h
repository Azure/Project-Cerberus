...
#ifndef X509_EXTENSION_BUILDER_DICE_TCBINFO_STATIC_H_
#define X509_EXTENSION_BUILDER_DICE_TCBINFO_STATIC_H_
 ...
 */
#define	X509_EXTENSION_BUILDER_DICE_TCBINFO_DYNAMIC_API_INIT  { \
		.build = x509_extension_builder_dice_tcbinfo_build_dynamic, \
		.free = x509_extension_builder_dice_tcbinfo_free_dynamic \
	}

/**
 * Constant initializer for extension builder API using static buffers.
 */
#define	X509_EXTENSION_BUILDER_DICE_TCBINFO_STATIC_API_INIT  { \
		.build = x509_extension_builder_dice_tcbinfo_build_static, \
		.free = x509_extension_builder_dice_tcbinfo_free_static \
	}
 ...
 */
#define	x509_extension_builder_dice_tcbinfo_static_init_with_buffer(tcb_ptr, ext_buffer_ptr, \
	buffer_length)	{ \
		.base = X509_EXTENSION_BUILDER_DICE_TCBINFO_STATIC_API_INIT, \
		.tcb = tcb_ptr, \
