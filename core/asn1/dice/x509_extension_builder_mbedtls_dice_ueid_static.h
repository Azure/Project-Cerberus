...
#ifndef X509_EXTENSION_BUILDER_MBEDTLS_DICE_UEID_STATIC_H_
#define X509_EXTENSION_BUILDER_MBEDTLS_DICE_UEID_STATIC_H_
 ...
 */
#define	X509_EXTENSION_BUILDER_MBEDTLS_DICE_UEID_DYNAMIC_API_INIT  { \
		.build = x509_extension_builder_mbedtls_dice_ueid_build_dynamic, \
		.free = x509_extension_builder_mbedtls_dice_ueid_free_dynamic \
	}

/**
 * Constant initializer for extension builder API using static buffers.
 */
#define	X509_EXTENSION_BUILDER_MBEDTLS_DICE_UEID_STATIC_API_INIT  { \
		.build = x509_extension_builder_mbedtls_dice_ueid_build_static, \
		.free = x509_extension_builder_mbedtls_dice_ueid_free_static \
	}
 ...
 */
#define	x509_extension_builder_mbedtls_dice_ueid_static_init(ueid_ptr, length)	{ \
		.base = X509_EXTENSION_BUILDER_MBEDTLS_DICE_UEID_DYNAMIC_API_INIT, \
		.ueid = ueid_ptr, \
		.ueid_length = length, \
		.ext_buffer = NULL, \
		.ext_length = 0, \
 ...
 */
#define	x509_extension_builder_mbedtls_dice_ueid_static_init_with_buffer(ueid_ptr, length, \
	ext_buffer_ptr, buffer_length)	{ \
		.base = X509_EXTENSION_BUILDER_MBEDTLS_DICE_UEID_STATIC_API_INIT, \
		.ueid = ueid_ptr, \
		.ueid_length = length, \
