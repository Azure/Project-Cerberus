...
#ifndef X509_EXTENSION_BUILDER_EKU_STATIC_H_
#define X509_EXTENSION_BUILDER_EKU_STATIC_H_
 ...
 */
#define	X509_EXTENSION_BUILDER_EKU_DYNAMIC_API_INIT  { \
		.build = x509_extension_builder_eku_build_dynamic, \
		.free = x509_extension_builder_eku_free_dynamic \
	}

/**
 * Constant initializer for the extension builder API using static buffers.
 */
#define	X509_EXTENSION_BUILDER_EKU_STATIC_API_INIT  { \
		.build = x509_extension_builder_eku_build_static, \
		.free = x509_extension_builder_eku_free_static \
	}
 ...
 */
#define	x509_extension_builder_eku_static_init(eku_ptr, eku_count_arg, critical_arg)	{ \
		.base = X509_EXTENSION_BUILDER_EKU_DYNAMIC_API_INIT, \
		.eku = eku_ptr, \
 ...
 */
#define	x509_extension_builder_eku_static_init_with_buffer(eku_ptr, eku_count_arg, critical_arg, \
	ext_buffer_ptr, buffer_length)	{ \
		.base = X509_EXTENSION_BUILDER_EKU_STATIC_API_INIT, \
		.eku = eku_ptr, \
		.eku_count = eku_count_arg, \
		.critical = critical_arg, \
...
#endif	/* X509_EXTENSION_BUILDER_EKU_STATIC_H_ */
