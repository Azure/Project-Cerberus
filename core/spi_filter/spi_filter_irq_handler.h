 ...
 */
enum {
	SPI_FILTER_IRQ_INVALID_ARGUMENT = SPI_FILTER_IRQ_ERROR (0),		/**< Input parameter is null or not valid. */
	SPI_FILTER_IRQ_NO_MEMORY = SPI_FILTER_IRQ_ERROR (1),			/**< Memory allocation failed. */
	SPI_FILTER_IRQ_STATUS_FAIL = SPI_FILTER_IRQ_ERROR (2),			/**< Error determining IRQ status. */
};
