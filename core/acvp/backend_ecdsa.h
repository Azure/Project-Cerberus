...
enum {
	...
	BACKEND_ECDSA_INVALID_ECC_IMPLEMENTATION = BACKEND_ECDSA_ERROR (0x0B),	/**< Invalid ECC implementation. */
	BACKEND_ECDSA_API_TYPE_UNSUPPORTED = BACKEND_ECDSA_ERROR (0x0C),		/**< ECDSA API type is not supported. */
};
