...
struct cmd_authorization {
	 ...
	 * @param nonce Input or output authorization nonce, depending on the initial value.  See
	 * {@link struct authorization.authorize}.
	 * @param length Input or output length of the authorization nonce, depending on the initial
	 * value of the authorization nonce.  See {@link struct authorization.authorize}.
	 *
	 ...
	 */
	int (*authorize_revert_bypass) (struct cmd_authorization *auth, uint8_t **nonce,
		size_t *length);
	 ...
	 * CMD_AUTHORIZATION_CHALLENGE will be returned.
	 */
	int (*authorize_reset_defaults) (struct cmd_authorization *auth, uint8_t **nonce,
		size_t *length);
