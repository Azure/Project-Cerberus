 ...
 */
enum {
	RECOVERY_IMAGE_HEADER_INVALID_ARGUMENT = RECOVERY_IMAGE_HEADER_ERROR (0),			/**< Input parameter is null or not valid. */
	RECOVERY_IMAGE_HEADER_NO_MEMORY = RECOVERY_IMAGE_HEADER_ERROR (1),					/**< Memory allocation failed. */
	RECOVERY_IMAGE_HEADER_BAD_FORMAT_LENGTH = RECOVERY_IMAGE_HEADER_ERROR (2),			/**< The header length doesn't match the expected length for the format. */
	RECOVERY_IMAGE_HEADER_BAD_PLATFORM_ID = RECOVERY_IMAGE_HEADER_ERROR (3),			/**< An error related to the platform identifier string. */
	RECOVERY_IMAGE_HEADER_BAD_VERSION_ID = RECOVERY_IMAGE_HEADER_ERROR (4),				/**< An error related to the version identifier string. */
	RECOVERY_IMAGE_HEADER_BAD_IMAGE_LENGTH = RECOVERY_IMAGE_HEADER_ERROR (5),			/**< The recovery image length is invalid. */
};
