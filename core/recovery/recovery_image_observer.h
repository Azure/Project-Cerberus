 ...
 */
enum {
	RECOVERY_IMAGE_OBSERVER_INVALID_ARGUMENT = RECOVERY_IMAGE_OBSERVER_ERROR (0),	/**< Input parameter is null or not valid. */
	RECOVERY_IMAGE_OBSERVER_NO_MEMORY = RECOVERY_IMAGE_OBSERVER_ERROR (1),			/**< Memory allocation failed. */
};
