 ...
 */
enum {
	RECOVERY_IMAGE_SECTION_HEADER_INVALID_ARGUMENT = RECOVERY_IMAGE_SECTION_HEADER_ERROR (0),		/**< Input parameter is null or not valid. */
	RECOVERY_IMAGE_SECTION_HEADER_NO_MEMORY = RECOVERY_IMAGE_SECTION_HEADER_ERROR (1),				/**< Memory allocation failed. */
	RECOVERY_IMAGE_SECTION_HEADER_BAD_FORMAT_LENGTH = RECOVERY_IMAGE_SECTION_HEADER_ERROR (2),		/**< The header length doesn't match the expected length for the format. */
};
