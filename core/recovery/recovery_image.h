 ...
 */
enum {
	RECOVERY_IMAGE_INVALID_ARGUMENT = RECOVERY_IMAGE_ERROR (0),				/**< Input parameter is null or not valid. */
	RECOVERY_IMAGE_NO_MEMORY = RECOVERY_IMAGE_ERROR (1),					/**< Memory allocation failed. */
	RECOVERY_IMAGE_HASH_BUFFER_TOO_SMALL = RECOVERY_IMAGE_ERROR (2),		/**< A buffer for hash output was too small. */
	RECOVERY_IMAGE_VERIFY_FAILED = RECOVERY_IMAGE_ERROR (3),				/**< A verify failure unrelated to authentication. */
	RECOVERY_IMAGE_MALFORMED = RECOVERY_IMAGE_ERROR (4),					/**< The recovery image is not formated correctly. */
	RECOVERY_IMAGE_GET_HASH_FAILED = RECOVERY_IMAGE_ERROR (5),				/**< The hash could not be calculated. */
	RECOVERY_IMAGE_INCOMPATIBLE = RECOVERY_IMAGE_ERROR (6),					/**< The recovery image is incompatible with the system. */
	RECOVERY_IMAGE_INVALID_SECTION_ADDRESS = RECOVERY_IMAGE_ERROR (7),		/**< The section address is an invalid value. */
	RECOVERY_IMAGE_ID_BUFFER_TOO_SMALL = RECOVERY_IMAGE_ERROR (8),			/**< A buffer for version output was too small. */
};
