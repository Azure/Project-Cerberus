...
enum {
	...
	STATE_MANAGER_SAVE_ACTIVE_FAILED = STATE_MANAGER_ERROR (0x06),		/**< Failed to save the active manifest region. */
	STATE_MANAGER_DEFAULTS_FAILED = STATE_MANAGER_ERROR (0x07),			/**< Failed to restore default state. */
	STATE_MANAGER_MANIFEST_VALID_FAILED = STATE_MANAGER_ERROR (0x08),	/**< Failed to determine validity of a manifest index.  */
};
