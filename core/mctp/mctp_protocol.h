...
#define MCTP_PROTOCOL_MIN_PACKET_LEN				(sizeof (struct mctp_protocol_transport_header) + 1)
#ifndef MCTP_PROTOCOL_MAX_PACKET_LEN
#define MCTP_PROTOCOL_MAX_PACKET_LEN				255
#endif
#ifndef	MCTP_PROTOCOL_MAX_MESSAGE_LEN
#define MCTP_PROTOCOL_MAX_MESSAGE_LEN				4224
#endif
#ifndef MCTP_PROTOCOL_MAX_NUM_PACKETS_PER_MSG
#define MCTP_PROTOCOL_MAX_NUM_PACKETS_PER_MSG		17
#endif
#define MCTP_PROTOCOL_MAX_PAYLOAD_PER_PKT			(MCTP_PROTOCOL_MAX_PACKET_LEN - MCTP_PROTOCOL_MIN_PACKET_LEN)
#define MCTP_PROTOCOL_MAX_PAYLOAD_PER_MSG			(MCTP_PROTOCOL_MAX_MESSAGE_LEN - MCTP_PROTOCOL_MAX_NUM_PACKETS_PER_MSG * MCTP_PROTOCOL_MIN_PACKET_LEN)
